...
public final class QRCodeOpFragment extends Fragment {
    ...
    private final Lazy dataSource = LazyKt.lazy(new Function0() { // from class: com.ask.printersdk.ui.QRCodeOpFragment$$ExternalSyntheticLambda0
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return QRCodeOpFragment.dataSource_delegate$lambda$0();
        }
    });
    ...
    public static final List dataSource_delegate$lambda$0() {
        ...
        arrayList.add(new QRCodeStyleFragment());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.tabs = CollectionsKt.listOf((Object[]) new String[]{getString(R.string.qrcode), getString(R.string.align_mirror)});
