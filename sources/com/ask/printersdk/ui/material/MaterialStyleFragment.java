...
/* JADX INFO: compiled from: MaterialStyleFragment.kt */
...
public final class MaterialStyleFragment extends Fragment {
    ...
    public final void initView(View rootView) {
        ...
        if (printEditViewModel != null && (drawingSurfaceView = printEditViewModel.drawingSurfaceView) != null && (graphManger = drawingSurfaceView.getGraphManger()) != null && (curSelectGraph = graphManger.getCurSelectGraph()) != null) {
            ...
            fragmentMaterialStyleBinding.reverseSwitch.setChecked(materialStyle.getIsReverse());
            fragmentMaterialStyleBinding.colorBlack.setChecked(!materialStyle.getIsRedTintColor());
            fragmentMaterialStyleBinding.colorRed.setChecked(materialStyle.getIsRedTintColor());
        }
        fragmentMaterialStyleBinding.scaleSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.ask.printersdk.ui.material.MaterialStyleFragment$$ExternalSyntheticLambda0
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                MaterialStyleFragment.initView$lambda$2(this.f$0, compoundButton, z);
            }
        });
        fragmentMaterialStyleBinding.reverseSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.ask.printersdk.ui.material.MaterialStyleFragment$$ExternalSyntheticLambda1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                MaterialStyleFragment.initView$lambda$3(this.f$0, compoundButton, z);
            }
        });
        fragmentMaterialStyleBinding.colorRed.setOnClickListener(new View.OnClickListener() { // from class: com.ask.printersdk.ui.material.MaterialStyleFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.onCheckColor(true);
            }
        });
        fragmentMaterialStyleBinding.colorBlack.setOnClickListener(new View.OnClickListener() { // from class: com.ask.printersdk.ui.material.MaterialStyleFragment$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public final void onCheckColor(boolean isRed) {
        ...
        PrintEditViewModel printEditViewModel = this.viewModel;
        if (printEditViewModel != null && (graphManger = printEditViewModel.getGraphManger()) != null) {
            graphManger.updateMaterialRedTintColor(isRed);
        }
