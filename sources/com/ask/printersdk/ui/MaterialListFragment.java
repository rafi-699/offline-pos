...
public final class MaterialListFragment extends Fragment {
    ...
    public final void initView(View rootView) {
        ...
        new KBaseAdapter.Builder(recyclerView).setData(this.datas).setLayoutId(R.layout.item_material_picker).addBindView(new Function3() { // from class: com.ask.printersdk.ui.MaterialListFragment$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function3
            public final Object invoke(Object obj, Object obj2, Object obj3) {
                return MaterialListFragment.initView$lambda$1(this.f$0, (View) obj, (String) obj2, ((Integer) obj3).intValue());
            }
        }).build();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit initView$lambda$1(final MaterialListFragment materialListFragment, View itemView, String itemData, int i) {
        ...
        final String str = materialListFragment.datas.get(i);
        Resources resources = materialListFragment.getResources();
        Context context = materialListFragment.getContext();
        ...
        if (identifier != 0) {
            ...
            BaseExtendsKt.click(root, (Function1<? super View, Unit>) new Function1() { // from class: com.ask.printersdk.ui.MaterialListFragment$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return MaterialListFragment.initView$lambda$1$lambda$0(this.f$0, str, (View) obj);
                }
            });
        }
        return Unit.INSTANCE;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit initView$lambda$1$lambda$0(MaterialListFragment materialListFragment, String str, View it) {
        DrawingSurfaceView drawingSurfaceView;
        GraphManger graphManger;
        Graph graph;
        GraphManger graphManger2;
        Intrinsics.checkNotNullParameter(it, "it");
        PrintEditViewModel printEditViewModel = materialListFragment.viewModel;
        if (printEditViewModel != null && (graph = printEditViewModel.curGraph) != null && graph.getId() == 0) {
            PrintEditViewModel printEditViewModel2 = materialListFragment.viewModel;
            if (printEditViewModel2 != null && (graphManger2 = printEditViewModel2.getGraphManger()) != null) {
                graphManger2.addMaterialGraph(str);
            }
        } else {
            PrintEditViewModel printEditViewModel3 = materialListFragment.viewModel;
            if (printEditViewModel3 != null && (drawingSurfaceView = printEditViewModel3.drawingSurfaceView) != null && (graphManger = drawingSurfaceView.getGraphManger()) != null) {
                graphManger.updateMaterialResId(str);
            }
        }
        return Unit.INSTANCE;
    }
