...
public final class MaterialOpListFragment extends Fragment {
    ...
    private final Lazy dataSource = LazyKt.lazy(new Function0() { // from class: com.ask.printersdk.ui.MaterialOpListFragment$$ExternalSyntheticLambda0
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return MaterialOpListFragment.dataSource_delegate$lambda$0();
        }
    });
    ...
    /* JADX INFO: compiled from: MaterialOpListFragment.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\f"}, d2 = {"Lcom/ask/printersdk/ui/MaterialOpListFragment$MaterialMenuData;", "", "prefixText", "", "count", "", "<init>", "(Ljava/lang/String;I)V", "getPrefixText", "()Ljava/lang/String;", "getCount", "()I", "printersdk_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public static final ArrayList dataSource_delegate$lambda$0() {
        List listListOf = CollectionsKt.listOf((Object[]) new MaterialMenuData[]{new MaterialMenuData("avatar", 8), new MaterialMenuData("animal", 33), new MaterialMenuData("food", 27), new MaterialMenuData("fruit", 22), new MaterialMenuData("consume", 14), new MaterialMenuData("home", 12), new MaterialMenuData("kitchenware", 30), new MaterialMenuData("office", 27), new MaterialMenuData("study", 8), new MaterialMenuData("work", 14), new MaterialMenuData("vegetable", 11), new MaterialMenuData("other", 7)});
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.tabs = CollectionsKt.listOf((Object[]) new String[]{getString(R.string.character), getString(R.string.animal), getString(R.string.food), getString(R.string.fruit), getString(R.string.consume), getString(R.string.home), getString(R.string.kitchen), getString(R.string.office), getString(R.string.study), getString(R.string.work), getString(R.string.vegetable), getString(R.string.others)});
    ...
    public final class Adapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            materialListFragment.setDatas(list);
    ...
    /* JADX INFO: compiled from: MaterialOpListFragment.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/ask/printersdk/ui/MaterialOpListFragment$Data;", "Landroidx/databinding/BaseObservable;", "<init>", "(Lcom/ask/printersdk/ui/MaterialOpListFragment;)V", "printersdk_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
