...
import com.ask.printersdk.ui.material.MaterialStyleFragment;
...
public final class MaterialOpFragment extends Fragment {
    ...
    private final Lazy dataSource = LazyKt.lazy(new Function0() { // from class: com.ask.printersdk.ui.MaterialOpFragment$$ExternalSyntheticLambda0
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return MaterialOpFragment.dataSource_delegate$lambda$0();
        }
    });
    ...
    public static final List dataSource_delegate$lambda$0() {
        ...
        arrayList.add(new MaterialOpListFragment());
        arrayList.add(new MaterialStyleFragment());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.tabs = CollectionsKt.listOf(getString(R.string.material));
    ...
    public final void initView(View rootView) {
        ...
        if ((printEditViewModel != null ? printEditViewModel.curGraph : null) != null) {
            ...
            if (graph.getId() != 0) {
                this.tabs = CollectionsKt.listOf((Object[]) new String[]{getString(R.string.material), getString(R.string.style), getString(R.string.align_mirror)});
            }
        }
    ...
    /* JADX INFO: compiled from: MaterialOpFragment.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/ask/printersdk/ui/MaterialOpFragment$Data;", "Landroidx/databinding/BaseObservable;", "<init>", "(Lcom/ask/printersdk/ui/MaterialOpFragment;)V", "printersdk_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
