...
public final class FragmentMaterialListBinding implements ViewBinding {
    ...
    private FragmentMaterialListBinding(LinearLayout linearLayout, RecyclerView recyclerView) {
    ...
    public static FragmentMaterialListBinding bind(View view) {
        ...
        if (recyclerView != null) {
            return new FragmentMaterialListBinding((LinearLayout) view, recyclerView);
        }
