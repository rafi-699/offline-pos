...
public final class MaterialGraph extends ImageGraph {
    ...
    public final void updateResName(String resName) {
        ...
        ((MaterialStyle) style).setResName(resName);
    ...
    public void restoreState(String json) {
        ...
        Object object = JSON.parseObject(json, (Class<Object>) MaterialStyle.class);
    ...
    public void onDraw(Context context, Canvas canvas, Paint paint) {
        ...
        if (materialStyle.getIsRedTintColor()) {
            bitmap = drawRedBitmap(getBitmap());
        }
        if (materialStyle.getIsReverse()) {
