...
class FontData {
    ...
    static class AbsoluteFontWeight {
        ...
        private static final int[] absoluteFontWeights = {400, 700, 100, 200, 300, 400, 500, 600, 700, Videoio.CAP_PVAPI, 900};
    ...
    private FontData() {
        ...
        this.kerning = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        this.fontSize = DEFAULT_FONT_SIZE;
        this.wordSpacing = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        this.letterSpacing = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    }
    ...
    FontData(ReadableMap readableMap, FontData fontData, double d) {
        ...
        this.kerning = zHasKey ? toAbsolute(readableMap, KERNING, d, this.fontSize, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) : fontData.kerning;
        if (readableMap.hasKey(WORD_SPACING)) {
            absolute = toAbsolute(readableMap, WORD_SPACING, d, this.fontSize, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        } else {
            absolute = fontData.wordSpacing;
        }
        this.wordSpacing = absolute;
        if (readableMap.hasKey("letterSpacing")) {
            absolute2 = toAbsolute(readableMap, "letterSpacing", d, this.fontSize, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        } else {
