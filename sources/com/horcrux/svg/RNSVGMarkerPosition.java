...
class RNSVGMarkerPosition {
    ...
    static ArrayList<RNSVGMarkerPosition> fromPath(ArrayList<PathElement> arrayList) {
        ...
        element_index_ = 0;
        origin_ = new Point(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        subpath_start_ = new Point(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
    ...
    private static double CurrentAngle(RNSVGMarkerType rNSVGMarkerType) {
        ...
        if (i != 2) {
            return i != 3 ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : dRad2deg;
        }
    ...
    private static boolean isZero(Point point) {
        return point.x == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE && point.y == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    }
