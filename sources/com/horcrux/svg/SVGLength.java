...
class SVGLength {
    ...
    private SVGLength() {
        this.value = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    ...
    static ArrayList<SVGLength> arrayFrom(Dynamic dynamic) {
        ...
        int i2 = 0;
        if (i == 2) {
            String[] strArrSplit = dynamic.asString().trim().replaceAll(",", StringUtils.SPACE).split(StringUtils.SPACE);
