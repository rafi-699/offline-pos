...
class FeBlendView extends FilterPrimitiveView {
    ...
    public FeBlendView(ReactContext reactContext) {
        super(reactContext);
        this.mFilterSubregion.mX = new SVGLength(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        this.mFilterSubregion.mY = new SVGLength(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
