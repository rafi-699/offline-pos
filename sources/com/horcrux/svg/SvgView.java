...
public class SvgView extends ReactViewGroup implements ReactCompoundView, ReactCompoundViewGroup {
    ...
    synchronized void drawChildren(Canvas canvas) {
        ...
        if (this.mAlign != null) {
            ...
            if (z) {
                width = (float) PropHelper.fromRelative(this.mbbWidth, width, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, this.mScale, 12.0d);
                height = (float) PropHelper.fromRelative(this.mbbHeight, height, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, this.mScale, 12.0d);
            }
