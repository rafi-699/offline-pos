...
public final class Source {
    ...
    /* JADX INFO: renamed from: isLocalAssetFile, reason: from getter */
    ...
    /* JADX INFO: renamed from: isAsset, reason: from getter */
    ...
    public static final class Companion {
        ...
        public final Source parse(ReadableMap src, Context context) {
            ...
            if (src != null) {
                String strSafeGetString = ReactBridgeUtils.safeGetString(src, "uri", null);
                if (strSafeGetString == null || TextUtils.isEmpty(strSafeGetString)) {
                    DebugLog.d(Source.TAG, "isEmpty uri:" + strSafeGetString);
                } else {
                    Uri uriFromAssetId = Uri.parse(strSafeGetString);
                    if (uriFromAssetId == null) {
                        DebugLog.d(Source.TAG, "Invalid uri:" + strSafeGetString);
                        return source;
                    }
                    if (isValidScheme(uriFromAssetId.getScheme()) || (uriFromAssetId = getUriFromAssetId(context, strSafeGetString)) != null) {
                        ...
                        ReadableArray readableArraySafeGetArray = ReactBridgeUtils.safeGetArray(src, Source.PROP_SRC_HEADERS);
