...
public final class VideoPlaybackService extends MediaSessionService {
    ...
    public final void unregisterPlayer(ExoPlayer player) {
        ...
        MediaSession mediaSessionRemove = this.mediaSessionsList.remove(player);
        if (mediaSessionRemove != null) {
            mediaSessionRemove.release();
        }
    ...
    private final Notification buildNotification(MediaSession session) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            Notification notificationBuild = new NotificationCompat.Builder(videoPlaybackService, NOTIFICATION_CHANEL_ID).setSmallIcon(androidx.media3.session.R.drawable.media3_icon_circular_play).setStyle(new MediaStyleNotificationHelper.MediaStyle(session)).setContentIntent(PendingIntent.getActivity(videoPlaybackService, 0, intent, 201326592)).build();
        ...
        NotificationCompat.Builder builderAddAction = new NotificationCompat.Builder(videoPlaybackService, NOTIFICATION_CHANEL_ID).setVisibility(1).setSmallIcon(androidx.media3.session.R.drawable.media3_icon_circular_play).addAction(androidx.media3.session.R.drawable.media3_icon_rewind, "Seek Backward", service);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            do {
                ...
                next = it.next();
            } while (((MediaSession) next).getPlayer().hashCode() != intExtra);
    ...
    public static final class Companion {
        ...
        public final COMMAND commandFromString(String value) {
            ...
            if (Intrinsics.areEqual(value, COMMAND.SEEK_FORWARD.getStringValue())) {
                return COMMAND.SEEK_FORWARD;
            }
            if (Intrinsics.areEqual(value, COMMAND.SEEK_BACKWARD.getStringValue())) {
                return COMMAND.SEEK_BACKWARD;
            }
            if (Intrinsics.areEqual(value, COMMAND.TOGGLE_PLAY.getStringValue())) {
                return COMMAND.TOGGLE_PLAY;
            }
            if (Intrinsics.areEqual(value, COMMAND.PLAY.getStringValue())) {
                return COMMAND.PLAY;
            }
            return Intrinsics.areEqual(value, COMMAND.PAUSE.getStringValue()) ? COMMAND.PAUSE : COMMAND.NONE;
        }
