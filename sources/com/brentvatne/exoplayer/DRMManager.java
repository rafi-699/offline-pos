...
public final class DRMManager implements DRMManagerSpec {
    ...
    public DrmSessionManager buildDrmSessionManager(UUID uuid, DRMProps drmProps) throws UnsupportedDrmException {
        Intrinsics.checkNotNullParameter(uuid, "uuid");
        Intrinsics.checkNotNullParameter(drmProps, "drmProps");
        return buildDrmSessionManager(uuid, drmProps, 0);
    }

    static /* synthetic */ DrmSessionManager buildDrmSessionManager$default(DRMManager dRMManager, UUID uuid, DRMProps dRMProps, int i, int i2, Object obj) throws UnsupportedDrmException {
        if ((i2 & 4) != 0) {
            i = 0;
        }
        return dRMManager.buildDrmSessionManager(uuid, dRMProps, i);
    }
