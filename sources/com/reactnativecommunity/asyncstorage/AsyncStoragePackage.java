        ...
        try {
            ...
            return new ReactModuleInfoProvider() { // from class: com.reactnativecommunity.asyncstorage.AsyncStoragePackage.1
                ...
                public Map<String, ReactModuleInfo> getReactModuleInfos() {
                    ...
                    map.put(reactModule.name(), new ReactModuleInfo(reactModule.name(), AsyncStorageModule.class.getName(), reactModule.canOverrideExistingModule(), reactModule.needsEagerInit(), reactModule.hasConstants(), reactModule.isCxxModule(), true));
                    return map;
                }
            };
