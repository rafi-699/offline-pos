...
public final class URLUtil {
    ...
    public static final String guessFileName(String str, String str2, String str3) {
        ...
        if (strSubstring == null && (strDecode = Uri.decode(str)) != null) {
            ...
            if (!strDecode.endsWith(DomExceptionUtils.SEPARATOR) && (iLastIndexOf = strDecode.lastIndexOf(47) + 1) > 0) {
    ...
    static String parseContentDisposition(String str) {
        try {
            ...
            if (matcher.group(3) != null && matcher.group(4) != null) {
                try {
                    return URLDecoder.decode(matcher.group(4), matcher.group(3).isEmpty() ? Key.STRING_CHARSET_NAME : matcher.group(3));
