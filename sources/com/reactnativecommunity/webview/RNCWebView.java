    ...
    protected void createRNCWebViewBridge(RNCWebView rNCWebView) {
        if (WebViewFeature.isFeatureSupported("WEB_MESSAGE_LISTENER")) {
            if (this.bridgeListener == null) {
                ...
                WebViewCompat.addWebMessageListener(rNCWebView, JAVASCRIPT_INTERFACE, Utils$$ExternalSyntheticBackport0.m(new Object[]{ProxyConfig.MATCH_ALL_SCHEMES}), this.bridgeListener);
            }
        ...
        if (this.mRNCWebViewClient != null) {
            post(new Runnable() { // from class: com.reactnativecommunity.webview.RNCWebView.3
                ...
                public void run() {
                    ...
                    WritableMap writableMapCreateWebViewEvent = RNCWebView.this.mRNCWebViewClient.createWebViewEvent(this, str2);
