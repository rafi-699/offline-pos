...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo1266clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo1266clone();
        ...
        for (Node node : this.mNodes) {
            Node nodeM1267clone = node.m1267clone();
            map.put(node, nodeM1267clone);
            animatorSet.mNodes.add(nodeM1267clone);
            animatorSet.mNodeMap.put(nodeM1267clone.animation, nodeM1267clone);
            ArrayList arrayList = null;
            nodeM1267clone.dependencies = null;
            nodeM1267clone.tmpDependencies = null;
            nodeM1267clone.nodeDependents = null;
            nodeM1267clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM1267clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m1267clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo1266clone();
                return node;
