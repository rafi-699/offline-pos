...
public final class ObjectAnimator extends ValueAnimator {
    ...
    static {
        ...
        map.put(ViewProps.ROTATION, PreHoneycombCompat.ROTATION);
        map.put("rotationX", PreHoneycombCompat.ROTATION_X);
        map.put("rotationY", PreHoneycombCompat.ROTATION_Y);
        map.put(ViewProps.SCALE_X, PreHoneycombCompat.SCALE_X);
        map.put(ViewProps.SCALE_Y, PreHoneycombCompat.SCALE_Y);
    ...
    public ObjectAnimator mo1266clone() {
        return (ObjectAnimator) super.mo1266clone();
    }
