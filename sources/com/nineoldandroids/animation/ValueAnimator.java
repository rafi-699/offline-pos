...
public class ValueAnimator extends Animator {
    ...
    public ValueAnimator mo1266clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo1266clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo1270clone = propertyValuesHolderArr[i2].mo1270clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo1270clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo1270clone.getPropertyName(), propertyValuesHolderMo1270clone);
            }
        }
        return valueAnimator;
    }
