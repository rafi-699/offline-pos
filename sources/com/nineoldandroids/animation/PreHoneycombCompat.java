...
final class PreHoneycombCompat {
    ...
    static Property<View, Float> ROTATION = new FloatProperty<View>(ViewProps.ROTATION) { // from class: com.nineoldandroids.animation.PreHoneycombCompat.6
        @Override // com.nineoldandroids.util.FloatProperty
        public void setValue(View view, float f) {
    ...
    static Property<View, Float> SCALE_X = new FloatProperty<View>(ViewProps.SCALE_X) { // from class: com.nineoldandroids.animation.PreHoneycombCompat.9
        @Override // com.nineoldandroids.util.FloatProperty
        public void setValue(View view, float f) {
    ...
    static Property<View, Float> SCALE_Y = new FloatProperty<View>(ViewProps.SCALE_Y) { // from class: com.nineoldandroids.animation.PreHoneycombCompat.10
        @Override // com.nineoldandroids.util.FloatProperty
        public void setValue(View view, float f) {
