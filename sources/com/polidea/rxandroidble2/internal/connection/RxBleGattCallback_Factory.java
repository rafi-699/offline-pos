...
public final class RxBleGattCallback_Factory implements Factory<RxBleGattCallback> {
    ...
    public RxBleGattCallback get() {
        return newInstance(this.callbackSchedulerProvider.get(), this.bluetoothGattProvider.get(), this.disconnectionRouterProvider.get(), this.nativeCallbackDispatcherProvider.get());
    }
