...
public class LoggerUtilBluetoothServices {
    ...
    private static void appendCharacteristicNameHeader(StringBuilder sb, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        sb.append('\n').append('\t').append("* ").append(createCharacteristicName(bluetoothGattCharacteristic)).append(" (").append(LoggerUtil.getUuidToLog(bluetoothGattCharacteristic.getUuid())).append(")");
    }

    private static void appendDescriptorNameHeader(StringBuilder sb, BluetoothGattDescriptor bluetoothGattDescriptor) {
        sb.append('\n').append('\t').append('\t').append("* ").append(createDescriptorName(bluetoothGattDescriptor)).append(" (").append(LoggerUtil.getUuidToLog(bluetoothGattDescriptor.getUuid())).append(")");
    }
    ...
    private void appendCharacteristicProperties(StringBuilder sb, BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        sb.append('\n').append('\t').append("  ").append("Properties: ").append(this.characteristicPropertiesParser.propertiesIntToString(bluetoothGattCharacteristic.getProperties()));
    }
    ...
    private static void appendDeviceHeader(BluetoothDevice bluetoothDevice, StringBuilder sb) {
        sb.append("--------------- ====== Printing peripheral content ====== ---------------\n").append(LoggerUtil.commonMacMessage(bluetoothDevice.getAddress())).append('\n').append("PERIPHERAL NAME: ").append(bluetoothDevice.getName()).append('\n').append("-------------------------------------------------------------------------");
    }
