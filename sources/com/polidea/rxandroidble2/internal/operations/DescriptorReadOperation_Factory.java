...
public final class DescriptorReadOperation_Factory implements Factory<DescriptorReadOperation> {
    ...
    public DescriptorReadOperation get() {
        return newInstance(this.rxBleGattCallbackProvider.get(), this.bluetoothGattProvider.get(), this.timeoutConfigurationProvider.get(), this.descriptorProvider.get());
    }
