...
public class DisconnectOperation extends QueueOperation<Void> {
    ...
    @Inject
    DisconnectOperation(RxBleGattCallback rxBleGattCallback, BluetoothGattProvider bluetoothGattProvider, @Named(DeviceModule.MAC_ADDRESS) String str, BluetoothManager bluetoothManager, @Named(ClientComponent.NamedSchedulers.BLUETOOTH_INTERACTION) Scheduler scheduler, @Named(DeviceModule.DISCONNECT_TIMEOUT) TimeoutConfiguration timeoutConfiguration, ConnectionStateChangeListener connectionStateChangeListener) {
