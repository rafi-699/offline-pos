...
public interface ClientComponent {
    ...
    public static abstract class ClientModule {
        ...
        @Binds
        abstract Scheduler bindTimeoutScheduler(@Named(NamedSchedulers.COMPUTATION) Scheduler scheduler);
        ...
        @Provides
        static String[][] provideRecommendedScanRuntimePermissionNames(@Named(PlatformConstants.INT_DEVICE_SDK) int i, @Named(PlatformConstants.INT_TARGET_SDK) int i2, @Named(PlatformConstants.BOOL_IS_NEARBY_PERMISSION_NEVER_FOR_LOCATION) boolean z) {
        ...
        @Provides
        static String[][] provideRecommendedConnectRuntimePermissionNames(@Named(PlatformConstants.INT_DEVICE_SDK) int i, @Named(PlatformConstants.INT_TARGET_SDK) int i2) {
            if (Math.min(i, i2) < 31) {
                return new String[0][];
            }
        ...
        @Provides
        static LocationServicesStatus provideLocationServicesStatus(@Named(PlatformConstants.INT_DEVICE_SDK) int i, Provider<LocationServicesStatusApi18> provider, Provider<LocationServicesStatusApi23> provider2, Provider<LocationServicesStatusApi31> provider3) {
            if (i < 23) {
                return provider.get();
            }
            if (i < 31) {
        ...
        @Provides
        static Observable<Boolean> provideLocationServicesOkObservable(@Named(PlatformConstants.INT_DEVICE_SDK) int i, LocationServicesOkObservableApi23Factory locationServicesOkObservableApi23Factory) {
            if (i < 23) {
        ...
        @ClientScope
        @Provides
        static Scheduler provideBluetoothInteractionScheduler(@Named(NamedExecutors.BLUETOOTH_INTERACTION) ExecutorService executorService) {
        ...
        @Provides
        static ClientComponentFinalizer provideFinalizationCloseable(@Named(NamedExecutors.BLUETOOTH_INTERACTION) final ExecutorService executorService, @Named(NamedSchedulers.BLUETOOTH_CALLBACKS) final Scheduler scheduler, @Named(NamedExecutors.CONNECTION_QUEUE) final ExecutorService executorService2) {
        ...
        @Provides
        static boolean provideIsAndroidWear(Context context, @Named(PlatformConstants.INT_DEVICE_SDK) int i) {
        ...
        @ClientScope
        @Provides
        static ScanSetupBuilder provideScanSetupProvider(@Named(PlatformConstants.INT_DEVICE_SDK) int i, Provider<ScanSetupBuilderImplApi18> provider, Provider<ScanSetupBuilderImplApi21> provider2, Provider<ScanSetupBuilderImplApi23> provider3) {
            if (i < 21) {
                return provider.get();
            }
            if (i < 23) {
        ...
        @ClientScope
        @Provides
        static IsConnectableChecker provideIsConnectableChecker(@Named(PlatformConstants.INT_DEVICE_SDK) int i, Provider<IsConnectableCheckerApi18> provider, Provider<IsConnectableCheckerApi26> provider2) {
            if (i < 26) {
                return provider.get();
            }
            return provider2.get();
        ...
        @Provides
        static ScanPreconditionsVerifier provideScanPreconditionVerifier(@Named(PlatformConstants.INT_DEVICE_SDK) int i, Provider<ScanPreconditionsVerifierApi18> provider, Provider<ScanPreconditionsVerifierApi24> provider2) {
            if (i < 24) {
                return provider.get();
            }
            return provider2.get();
