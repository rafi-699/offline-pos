...
public class StandardUUIDsParser {
    ...
    static {
        ...
        SERVICE_UUIDS = Collections.unmodifiableMap(map);
        ...
        CHARACTERISTIC_UUIDS = Collections.unmodifiableMap(map2);
        ...
        DESCRIPTOR_UUIDS = Collections.unmodifiableMap(map3);
    }
