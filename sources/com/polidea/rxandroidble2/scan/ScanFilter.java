...
public class ScanFilter implements Parcelable, ScanFilterInterface {
    ...
    /* JADX INFO: renamed from: com.polidea.rxandroidble2.scan.ScanFilter$1 */
    class AnonymousClass1 implements Parcelable.Creator<ScanFilter> {
        AnonymousClass1() {
        }
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder("BluetoothLeScanFilter [mDeviceName=").append(this.mDeviceName).append(", ").append(LoggerUtil.commonMacMessage(this.mDeviceAddress)).append(", mUuid=");
        ParcelUuid parcelUuid = this.mServiceUuid;
        StringBuilder sbAppend2 = sbAppend.append(parcelUuid == null ? null : LoggerUtil.getUuidToLog(parcelUuid.getUuid())).append(", mUuidMask=");
        ParcelUuid parcelUuid2 = this.mServiceUuidMask;
        StringBuilder sbAppend3 = sbAppend2.append(parcelUuid2 == null ? null : LoggerUtil.getUuidToLog(parcelUuid2.getUuid())).append(", mSolicitedUuid=");
        ParcelUuid parcelUuid3 = this.mServiceSolicitationUuid;
        StringBuilder sbAppend4 = sbAppend3.append(parcelUuid3 == null ? null : LoggerUtil.getUuidToLog(parcelUuid3.getUuid())).append(", mSolicitedUuidMask=");
        ParcelUuid parcelUuid4 = this.mServiceSolicitationUuidMask;
        StringBuilder sbAppend5 = sbAppend4.append(parcelUuid4 == null ? null : LoggerUtil.getUuidToLog(parcelUuid4.getUuid())).append(", mServiceDataUuid=");
        ParcelUuid parcelUuid5 = this.mServiceDataUuid;
        return sbAppend5.append(parcelUuid5 != null ? LoggerUtil.getUuidToLog(parcelUuid5.getUuid()) : null).append(", mServiceData=").append(Arrays.toString(this.mServiceData)).append(", mServiceDataMask=").append(Arrays.toString(this.mServiceDataMask)).append(", mManufacturerId=").append(this.mManufacturerId).append(", mManufacturerData=").append(Arrays.toString(this.mManufacturerData)).append(", mManufacturerDataMask=").append(Arrays.toString(this.mManufacturerDataMask)).append("]").toString();
    }
