...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        this.mResolvedStyle = (IPlatformNumberFormatter.Style) OptionHelpers.searchEnum(IPlatformNumberFormatter.Style.class, JSObjects.getJavaString(OptionHelpers.GetOption(map, "style", OptionHelpers.OptionType.STRING, new String[]{"decimal", "percent", FirebaseAnalytics.Param.CURRENCY, "unit"}, "decimal")));
        ...
        Object objGetOption2 = OptionHelpers.GetOption(map, "currencyDisplay", OptionHelpers.OptionType.STRING, new String[]{"symbol", "narrowSymbol", "code", "name"}, "symbol");
    ...
    private void setNumberFormatDigitOptions(Map<String, Object> map, Object obj, Object obj2) throws JSRangeErrorException {
        ...
        if (!JSObjects.isUndefined(objGet) || !JSObjects.isUndefined(objGet2)) {
            ...
            Object objDefaultNumberOption3 = OptionHelpers.DefaultNumberOption("minimumFractionDigits", objGet, JSObjects.newNumber(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE), JSObjects.newNumber(20.0d), JSObjects.Undefined());
            Object objDefaultNumberOption4 = OptionHelpers.DefaultNumberOption("maximumFractionDigits", objGet2, JSObjects.newNumber(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE), JSObjects.newNumber(20.0d), JSObjects.Undefined());
    ...
    private void initializeNumberFormat(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        ...
        if (this.mResolvedStyle == IPlatformNumberFormatter.Style.CURRENCY) {
            ...
            objNewNumber = JSObjects.newNumber(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
            objNewNumber2 = this.mResolvedStyle == IPlatformNumberFormatter.Style.PERCENT ? JSObjects.newNumber(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) : JSObjects.newNumber(3.0d);
        }
