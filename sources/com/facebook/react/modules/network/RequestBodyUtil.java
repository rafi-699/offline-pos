...
/* JADX INFO: compiled from: RequestBodyUtil.kt */
...
public final class RequestBodyUtil {
    ...
    private final InputStream getDownloadFileInputStream(Context context, Uri uri) throws IOException {
        ...
        try {
            ...
            try {
                ...
                try {
                    fileOutputStream2.getChannel().transferFrom(readableByteChannelNewChannel, 0L, Long.MAX_VALUE);
                    ...
                    try {
                        ...
                        CloseableKt.closeFinally(readableByteChannelNewChannel, th);
                        throw th2;
                    }
                }
            } catch (Throwable th3) {
                try {
                    ...
                    CloseableKt.closeFinally(inputStreamOpenStream, th3);
                    throw th4;
                }
            }
        } catch (Throwable th5) {
    ...
    public static final RequestBody getEmptyBody(String method) {
        ...
        if (iHashCode == 79599 ? method.equals("PUT") : iHashCode == 2461856 ? method.equals(ShareTarget.METHOD_POST) : iHashCode == 75900968 && method.equals("PATCH")) {
