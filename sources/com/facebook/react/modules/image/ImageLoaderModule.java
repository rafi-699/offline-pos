...
/* JADX INFO: compiled from: ImageLoaderModule.kt */
...
public final class ImageLoaderModule extends NativeImageLoaderAndroidSpec implements LifecycleEventListener {
    ...
    public void getSize(String uriString, final Promise promise) {
        ...
        ImageRequest imageRequestBuild = ImageRequestBuilder.newBuilderWithSource(new ImageSource(reactApplicationContext, uriString, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, null, 28, null).getUri()).build();
    ...
    public void getSizeWithHeaders(String uriString, ReadableMap headers, final Promise promise) {
        ...
        ReactApplicationContext reactApplicationContext = getReactApplicationContext();
        Intrinsics.checkNotNullExpressionValue(reactApplicationContext, "getReactApplicationContext(...)");
        ImageRequestBuilder imageRequestBuilderNewBuilderWithSource = ImageRequestBuilder.newBuilderWithSource(new ImageSource(reactApplicationContext, uriString, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, null, 28, null).getUri());
