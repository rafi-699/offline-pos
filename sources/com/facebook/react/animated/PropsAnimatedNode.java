...
/* JADX INFO: compiled from: PropsAnimatedNode.kt */
...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            objM1405constructorimpl = Result.m1405constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m1411isFailureimpl(objM1405constructorimpl) ? null : objM1405constructorimpl);
    }
