...
/* JADX INFO: compiled from: FrameBasedAnimationDriver.kt */
...
public final class FrameBasedAnimationDriver extends AnimationDriver {
    ...
    public void resetConfig(ReadableMap config) {
        ...
        this.toValue = (config.hasKey("toValue") && config.getType("toValue") == ReadableType.Number) ? config.getDouble("toValue") : ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
