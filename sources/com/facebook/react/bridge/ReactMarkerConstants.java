...
/* JADX INFO: compiled from: ReactMarkerConstants.kt */
...
public final class ReactMarkerConstants extends Enum<ReactMarkerConstants> {
    ...
    public static final ReactMarkerConstants REACT_BRIDGE_LOADING_START = new ReactMarkerConstants("REACT_BRIDGE_LOADING_START", Videoio.CAP_PROP_OPENNI2_SYNC, false, 1, null);
    ...
    static {
        ...
        $ENTRIES = EnumEntriesKt.enumEntries(reactMarkerConstantsArr$values);
    }
