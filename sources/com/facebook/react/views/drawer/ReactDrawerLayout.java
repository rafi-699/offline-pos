...
/* JADX INFO: compiled from: ReactDrawerLayout.kt */
    ...
    public ReactDrawerLayout(ReactContext reactContext) {
        ...
        ViewCompat.setAccessibilityDelegate(this, new AccessibilityDelegateCompat() { // from class: com.facebook.react.views.drawer.ReactDrawerLayout.1
            ...
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                ReactAccessibilityDelegate.AccessibilityRole accessibilityRoleFromViewTag = ReactAccessibilityDelegate.AccessibilityRole.INSTANCE.fromViewTag(host);
                if (accessibilityRoleFromViewTag != null) {
                    info.setClassName(ReactAccessibilityDelegate.AccessibilityRole.INSTANCE.getValue(accessibilityRoleFromViewTag));
                }
            }
