...
public final class ReactImageView extends GenericDraweeView {
        ...
        if (!shouldNotify) {
            ...
            this.downloadListener = new ReactImageDownloadListener<ImageInfo>() { // from class: com.facebook.react.views.image.ReactImageView.setShouldNotifyLoadEvents.1
                ...
                public void onFinalImageSet(String id, ImageInfo imageInfo, Animatable animatable) {
                    ...
                    eventDispatcher.dispatchEvent(ImageLoadEvent.INSTANCE.createLoadEndEvent(UIManagerHelper.getSurfaceId(this), this.getId()));
                }
    ...
    public final void setSource(ReadableArray sources) {
        ...
        if (sources == null || sources.size() == 0) {
            ...
            if (sources.size() == 1) {
                ...
                ImageSource imageSource = new ImageSource(context2, map.getString("uri"), ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, imageCacheControlComputeCacheControl, 12, null);
    ...
    */
    ...
    @Override // android.widget.ImageView, android.view.View
    public void onDraw(final Canvas canvas) throws Throwable {
        ...
        BackgroundStyleApplicator.clipToPaddingBoxWithAntiAliasing(this, canvas, new Function0() { // from class: com.facebook.react.views.image.ReactImageView$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return ReactImageView.onDraw$lambda$1(this.f$0, canvas);
            }
        });
    }
    ...
    private final class TilePostprocessor extends BasePostprocessor {
        ...
        public CloseableReference<Bitmap> process(Bitmap source, PlatformBitmapFactory bitmapFactory) {
            ...
            try {
                ...
                CloseableReference<Bitmap> closeableReferenceMo724clone = closeableReferenceCreateBitmap.mo724clone();
                Intrinsics.checkNotNullExpressionValue(closeableReferenceMo724clone, "clone(...)");
                return closeableReferenceMo724clone;
            } finally {
