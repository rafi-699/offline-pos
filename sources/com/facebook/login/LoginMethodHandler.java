...
public abstract class LoginMethodHandler implements Parcelable {
    ...
    public static final class Companion {
        ...
        public final AccessToken createAccessTokenFromWebBundle(Collection<String> requestedPermissions, Bundle bundle, AccessTokenSource source, String applicationId) throws FacebookException {
            ...
            ArrayList arrayListArrayListOf3;
            Intrinsics.checkNotNullParameter(bundle, "bundle");
            Intrinsics.checkNotNullParameter(applicationId, "applicationId");
            ...
            if (string2 != null) {
                ...
                if (str.length() > 0) {
                    ...
                    arrayListArrayListOf = CollectionsKt.arrayListOf(Arrays.copyOf(strArr, strArr.length));
                } else {
                    arrayListArrayListOf = requestedPermissions;
                }
            } else {
                arrayListArrayListOf = requestedPermissions;
            }
            ...
            if (string3 != null) {
                ...
                if (str2.length() > 0) {
                    ...
                    arrayListArrayListOf2 = CollectionsKt.arrayListOf(Arrays.copyOf(strArr2, strArr2.length));
                } else {
            ...
            if (string4 != null) {
                ...
                if (str3.length() > 0) {
                    ...
                    arrayListArrayListOf3 = CollectionsKt.arrayListOf(Arrays.copyOf(strArr3, strArr3.length));
                } else {
                    arrayListArrayListOf3 = null;
                }
            } else {
                arrayListArrayListOf3 = null;
            }
            ...
            return new AccessToken(string, applicationId, getUserIDFromSignedRequest(bundle.getString("signed_request")), arrayListArrayListOf, arrayListArrayListOf2, arrayListArrayListOf3, source, bundleLongAsDate, new Date(), bundleLongAsDate2, bundle.getString("graph_domain"));
        }
