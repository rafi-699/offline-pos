...
public class WebViewLoginMethodHandler extends WebLoginMethodHandler {
    ...
    public int tryAuthorize(final LoginClient.Request request) {
        ...
        AuthDialogBuilder authDialogBuilder = new AuthDialogBuilder(this, fragmentActivity, request.getApplicationId(), bundleAddExtraParameters, request);
        String str = this.e2e;
    ...
    public final class AuthDialogBuilder extends WebDialog.Builder {
        ...
        public final void m904setAuthType(String str) {
            Intrinsics.checkNotNullParameter(str, "<set-?>");
            this.authType = str;
        }
