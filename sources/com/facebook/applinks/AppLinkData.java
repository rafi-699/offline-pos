...
public class AppLinkData {
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x009d A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:30:0x00a5 A[Catch: JSONException -> 0x00b0, Exception -> 0x00d2, TRY_ENTER, TryCatch #4 {JSONException -> 0x00b0, blocks: (B:27:0x009f, B:30:0x00a5, B:31:0x00a8, B:33:0x00ac), top: B:61:0x009f, outer: #3 }] */
    /* JADX WARN: Code duplicated, block: B:33:0x00ac A[Catch: JSONException -> 0x00b0, Exception -> 0x00d2, TRY_LEAVE, TryCatch #4 {JSONException -> 0x00b0, blocks: (B:27:0x009f, B:30:0x00a5, B:31:0x00a8, B:33:0x00ac), top: B:61:0x009f, outer: #3 }] */
    /* JADX WARN: Code duplicated, block: B:36:0x00b7 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:40:0x00bf A[Catch: JSONException -> 0x00ca, Exception -> 0x00d2, TRY_ENTER, TryCatch #1 {JSONException -> 0x00ca, blocks: (B:37:0x00b9, B:40:0x00bf, B:41:0x00c2, B:43:0x00c6), top: B:55:0x00b9, outer: #3 }] */
    /* JADX WARN: Code duplicated, block: B:43:0x00c6 A[Catch: JSONException -> 0x00ca, Exception -> 0x00d2, TRY_LEAVE, TryCatch #1 {JSONException -> 0x00ca, blocks: (B:37:0x00b9, B:40:0x00bf, B:41:0x00c2, B:43:0x00c6), top: B:55:0x00b9, outer: #3 }] */
    /* JADX WARN: Code duplicated, block: B:55:0x00b9 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:61:0x009f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    public static void fetchDeferredAppLinkFromServer(Context context, String str, CompletionHandler completionHandler) {
        ...
        try {
            jSONObject3.put(NotificationCompat.CATEGORY_EVENT, DEFERRED_APP_LINK_EVENT);
            Utility.setAppEventAttributionParameters(jSONObject3, AttributionIdentifiers.getAttributionIdentifiers(context), AppEventsLogger.getAnonymousAppDeviceGUID(context), FacebookSdk.getLimitEventAndDataUsage(context), context);
            Utility.setAppEventExtendedDeviceInfoParameters(jSONObject3, FacebookSdk.getApplicationContext());
            ...
            if (FeatureManager.isEnabled(FeatureManager.Feature.ReferrerForDeepLink) && (installReferrerBlocking = AppEventsLoggerImpl.getInstallReferrerBlocking()) != null) {
                jSONObject3.put("install_referrer", installReferrerBlocking);
            }
            String str2 = String.format(DEFERRED_APP_LINK_PATH, str);
            AppLinkData appLinkDataCreateFromJson = null;
            try {
                JSONObject graphObject = GraphRequest.newPostRequest(null, str2, jSONObject3, null).executeAndWait().getGraphObject();
                if (graphObject != null) {
                    ...
                    if (!TextUtils.isEmpty(strOptString) && (appLinkDataCreateFromJson = createFromJson(strOptString)) != null) {
                        if (jOptLong != -1) {
                            try {
                                ...
                                if (jSONObject4 != null) {
                                    jSONObject4.put(ARGUMENTS_TAPTIME_KEY, jOptLong);
                                }
                                Bundle bundle3 = appLinkDataCreateFromJson.argumentBundle;
                                if (bundle3 != null) {
                                    bundle3.putString(ARGUMENTS_TAPTIME_KEY, Long.toString(jOptLong));
                                    if (strOptString2 != null) {
                                        try {
                                            jSONObject = appLinkDataCreateFromJson.arguments;
                                            if (jSONObject != null) {
                                                jSONObject.put(ARGUMENTS_NATIVE_CLASS_KEY, strOptString2);
                                            }
                                            bundle = appLinkDataCreateFromJson.argumentBundle;
                                            if (bundle != null) {
                                                bundle.putString(ARGUMENTS_NATIVE_CLASS_KEY, strOptString2);
                                                if (strOptString3 != null) {
                                                    try {
                                                        jSONObject2 = appLinkDataCreateFromJson.arguments;
                                                        if (jSONObject2 != null) {
                                                            jSONObject2.put(ARGUMENTS_NATIVE_URL, strOptString3);
                                                        }
                                                        bundle2 = appLinkDataCreateFromJson.argumentBundle;
                                                        if (bundle2 != null) {
                                                            bundle2.putString(ARGUMENTS_NATIVE_URL, strOptString3);
                                                        }
