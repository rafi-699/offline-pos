        ...
        try {
            ...
            if (inAppBillingObj != null && isBillingSupported(context, inAppBillingObj, type)) {
                ...
                while (true) {
                    ...
                    try {
                        Object objInvokeMethod = invokeMethod(context2, IN_APP_BILLING_SERVICE, GET_PURCHASES, obj, new Object[]{3, PACKAGE_NAME, type, string});
                        if (objInvokeMethod == null) {
                            string = null;
                            if (size >= 30) {
                                break;
                    ...
                    if (objInvokeMethod != null) {
                        ...
                        if (bundle.getInt(RESPONSE_CODE) != 0 || (stringArrayList = bundle.getStringArrayList(INAPP_PURCHASE_DATA_LIST)) == null) {
                            ...
                            for (String str : stringArrayList) {
                                try {
                                    if (jCurrentTimeMillis - (new JSONObject(str).getLong(Constants.GP_IAP_PURCHASE_TIME) / 1000) > 1200) {
                                        z = true;
                                        break;
                                    }
                                    arrayList.add(str);
