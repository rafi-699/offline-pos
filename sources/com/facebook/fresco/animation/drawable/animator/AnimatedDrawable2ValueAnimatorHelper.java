...
/* JADX INFO: compiled from: AnimatedDrawable2ValueAnimatorHelper.kt */
...
public final class AnimatedDrawable2ValueAnimatorHelper {
    ...
    public static final ValueAnimator createValueAnimator(AnimatedDrawable2 animatedDrawable, int maxDurationMs) {
        ...
        valueAnimatorCreateValueAnimator.setRepeatCount((int) Math.max(((long) maxDurationMs) / animatedDrawable.getLoopDurationMs(), 1L));
