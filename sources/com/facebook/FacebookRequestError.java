            ...
            try {
                if (singleResult.has("code")) {
                    ...
                    if (stringPropertyAsJSON == null || !(stringPropertyAsJSON instanceof JSONObject)) {
                        ...
                        if (z2) {
                            return new FacebookRequestError(i, iOptInt2, iOptInt, str, strOptString, str2, strOptString2, (JSONObject) stringPropertyAsJSON, singleResult, batchResult, connection, null, z, null);
                        }
                    }
                    if (!getHTTP_RANGE_SUCCESS$facebook_core_release().contains(i)) {
                        return new FacebookRequestError(i, -1, -1, null, null, null, null, singleResult.has(str3) ? (JSONObject) Utility.getStringPropertyAsJSON(singleResult, str3, GraphResponse.NON_JSON_RESPONSE_PROPERTY) : null, singleResult, batchResult, connection, null, false, null);
                    }
                }
