    ...
    public void init() {
        ...
        registerCallback(this.mCallbackManager, new FacebookCallback<LoginResult>() { // from class: com.facebook.reactnative.androidsdk.RCTLoginButton.2
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                writableMapCreateMap2.putArray("grantedPermissions", Arguments.fromJavaArgs((Object[]) RCTLoginButton.this.setToStringArray(loginResult.getRecentlyGrantedPermissions())));
                writableMapCreateMap2.putArray(SDKConstants.PARAM_DECLINED_PERMISSIONS, Arguments.fromJavaArgs((Object[]) RCTLoginButton.this.setToStringArray(loginResult.getRecentlyDeniedPermissions())));
