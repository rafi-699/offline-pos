...
public final class Utility {
    ...
    public static WritableMap accessTokenToReactMap(AccessToken accessToken) {
        ...
        writableMapCreateMap.putArray("permissions", Arguments.fromJavaArgs((Object[]) setToStringArray(accessToken.getPermissions())));
        writableMapCreateMap.putArray(SDKConstants.PARAM_DECLINED_PERMISSIONS, Arguments.fromJavaArgs((Object[]) setToStringArray(accessToken.getDeclinedPermissions())));
        writableMapCreateMap.putArray(SDKConstants.PARAM_EXPIRED_PERMISSIONS, Arguments.fromJavaArgs((Object[]) setToStringArray(accessToken.getExpiredPermissions())));
