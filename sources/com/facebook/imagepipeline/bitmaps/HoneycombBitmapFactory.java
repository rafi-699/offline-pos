...
/* JADX INFO: compiled from: HoneycombBitmapFactory.kt */
        ...
        try {
            ...
            try {
                ...
                if (!closeableReferenceDecodeJPEGFromEncodedImage.get().isMutable()) {
                    ...
                    CloseableReference<Bitmap> closeableReferenceCreateFallbackBitmap = createFallbackBitmap(width, height, bitmapConfig);
