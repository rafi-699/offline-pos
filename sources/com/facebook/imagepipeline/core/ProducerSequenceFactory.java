...
public final class ProducerSequenceFactory {
    ...
    public final synchronized Producer<EncodedImage> newCommonNetworkFetchToEncodedMemorySequence(NetworkFetcher<?> networkFetcher) {
        ...
        try {
            ...
            ResizeAndRotateProducer resizeAndRotateProducerNewResizeAndRotateProducer = producerFactory2.newResizeAndRotateProducer(addImageTransformMetaDataProducer2, z, this.imageTranscoderFactory);
            FrescoSystrace.endSection();
