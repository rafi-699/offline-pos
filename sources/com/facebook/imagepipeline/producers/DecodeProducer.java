                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            FLog.w(this.TAG, "%s, {uri: %s, firstEncodedBytes: %s, length: %d}", e2.getMessage(), string, encodedImage2.getFirstBytesAsHexString(10), Integer.valueOf(encodedImage2.getSize()));
                            throw e2;
                        } catch (Throwable th) {
                            th = th;
                            EncodedImage.closeSafely(encodedImage);
