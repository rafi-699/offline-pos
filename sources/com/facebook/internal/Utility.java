...
public final class Utility {
        ...
        try {
            ...
            while (true) {
                ...
                if (i != -1) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(string, "InputStreamReader(buffer…gBuilder.toString()\n    }");
                    return string;
                }
            }
        } catch (Throwable th) {
    ...
    public static final void setAppEventAttributionParameters(JSONObject params, AttributionIdentifiers attributionIdentifiers, String anonymousAppDeviceGUID, boolean limitEventUsage, Context context) throws JSONException {
        ...
        if (addToMessagingCustomerBaseForWhatsApp != null) {
            params.put("add_to_messaging_customer_base_for_whatsapp", addToMessagingCustomerBaseForWhatsApp.booleanValue() ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        }
        ...
        String info2 = companion2 != null ? companion2.getInfo(AppLinkManager.CLICK_ID_KEY) : null;
        if (info2 != null) {
            params.put(AppLinkManager.CLICK_ID_KEY, info2);
        }
    }
    ...
    public static final void getGraphMeRequestWithCacheAsync$lambda$5(GraphMeRequestWithCacheCallback callback, String accessToken, GraphResponse response) {
        Intrinsics.checkNotNullParameter(callback, "$callback");
        Intrinsics.checkNotNullParameter(accessToken, "$accessToken");
