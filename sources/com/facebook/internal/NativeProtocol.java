...
public final class NativeProtocol {
    ...
    private final Intent createNativeAppIntent(NativeAppInfo appInfo, String applicationId, Collection<String> permissions, String e2e, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, boolean ignoreAppSwitchToLoggedOut, String messengerPageId, boolean resetMessengerState, LoginTargetApp targetApp, boolean isFamilyLogin, boolean shouldSkipAccountDedupe, String nonce, String codeChallenge, String codeChallengeMethod, String redirectURI, String intentUriPackageTarget, boolean forceConfirmation, String activityNameOverride, String androidSsoContext) {
        ...
        if (forceConfirmation) {
            intentPutExtra.putExtra(ServerProtocol.DIALOG_PARAM_FORCE_CONFIRMATION, true);
        }
        String str = redirectURI;
        if (str != null && str.length() != 0) {
            intentPutExtra.putExtra(ServerProtocol.DIALOG_HTTPS_REDIRECT_URI, redirectURI);
        } else {
            String str2 = intentUriPackageTarget;
            if (str2 != null && str2.length() != 0) {
                intentPutExtra.putExtra("intent_uri_package_target", buildIntentUriFromPackage(intentUriPackageTarget));
            }
        }
        String str3 = androidSsoContext;
        if (str3 != null && str3.length() != 0) {
            intentPutExtra.putExtra(ServerProtocol.DIALOG_PARAM_ANDROID_SSO_CONTEXT, androidSsoContext);
        }
    ...
    public static final List<Intent> createProxyAuthIntents(Context context, String applicationId, Collection<String> permissions, String e2e, boolean isRerequest, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, boolean ignoreAppSwitchToLoggedOut, String messengerPageId, boolean resetMessengerState, boolean isFamilyLogin, boolean shouldSkipAccountDedupe, String nonce, String codeChallenge, String codeChallengeMethod, String redirectURI, String intentUriPackageTarget, boolean forceConfirmation, String androidSsoContext) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                list = list2;
                try {
                    Intent intentCreateNativeAppIntent$default = createNativeAppIntent$default(INSTANCE, (NativeAppInfo) it.next(), applicationId2, permissions2, e2e2, isForPublish, defaultAudience2, clientState2, authType2, ignoreAppSwitchToLoggedOut, messengerPageId, resetMessengerState, LoginTargetApp.FACEBOOK, isFamilyLogin, shouldSkipAccountDedupe, nonce, codeChallenge, codeChallengeMethod, redirectURI, intentUriPackageTarget, forceConfirmation, null, androidSsoContext, 1048576, null);
                    if (intentCreateNativeAppIntent$default != null) {
                        arrayList2.add(intentCreateNativeAppIntent$default);
                    }
    ...
    /* JADX WARN: Code duplicated, block: B:35:0x0097 A[Catch: all -> 0x009b, TryCatch #5 {all -> 0x009b, blocks: (B:5:0x000d, B:35:0x0097, B:36:0x009a, B:30:0x008e), top: B:45:0x000d }] */
    /* JADX WARN: Code duplicated, block: B:50:? A[Catch: all -> 0x009b, SYNTHETIC, TRY_LEAVE, TryCatch #5 {all -> 0x009b, blocks: (B:5:0x000d, B:35:0x0097, B:36:0x009a, B:30:0x008e), top: B:45:0x000d }] */
    ...
    private final Uri buildPlatformProviderVersionURI(NativeAppInfo appInfo) {
        ...
        try {
            Uri uri = Uri.parse("content://" + appInfo.getPackage() + PLATFORM_PROVIDER_VERSIONS);
    ...
    public static abstract class NativeAppInfo {
        ...
        /* JADX WARN: Code duplicated, block: B:10:0x0010 A[Catch: all -> 0x0029, TryCatch #0 {, blocks: (B:4:0x0003, B:7:0x0009, B:11:0x0018, B:13:0x001e, B:15:0x0024, B:10:0x0010), top: B:21:0x0003 }] */
        /* JADX WARN: Code duplicated, block: B:15:0x0024 A[Catch: all -> 0x0029, TRY_LEAVE, TryCatch #0 {, blocks: (B:4:0x0003, B:7:0x0009, B:11:0x0018, B:13:0x001e, B:15:0x0024, B:10:0x0010), top: B:21:0x0003 }] */
    ...
    private static final class MessengerAppInfo extends NativeAppInfo {
        ...
        public Void m888getLoginActivity() {
            return null;
        }

        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m888getLoginActivity();
        }
    ...
    private static final class EffectTestAppInfo extends NativeAppInfo {
        /* JADX INFO: renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m887getLoginActivity() {
            return null;
        }

        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m887getLoginActivity();
        }
