...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m891assert(boolean condition) {
            if (!condition) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m891assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
            reentrantLock.unlock();
        } catch (Throwable th) {
            reentrantLock.unlock();
    ...
    final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode list, boolean addToFront) {
            WorkQueue.INSTANCE.m891assert(this.next == null);
            WorkQueue.INSTANCE.m891assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m891assert(workNode == this);
            Companion companion2 = WorkQueue.INSTANCE;
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion2.m891assert(workNode2 == this);
            WorkQueue.INSTANCE.m891assert(getIsRunning() == shouldBeRunning);
        }
    }
}
