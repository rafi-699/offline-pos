...
public final class FacebookContentProvider extends ContentProvider {
    ...
    private final Pair<UUID, String> parseCallIdAndAttachmentName(Uri uri) {
        try {
            ...
            String[] strArr = (String[]) StringsKt.split$default((CharSequence) strSubstring, new String[]{DomExceptionUtils.SEPARATOR}, false, 0, 6, (Object) null).toArray(new String[0]);
            String str = strArr[0];
