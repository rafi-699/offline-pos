...
/* JADX INFO: compiled from: RotationGestureDetector.kt */
...
public final class RotationGestureDetector {
    ...
    private final void updateCurrent(MotionEvent event) {
        ...
        tryUnpause(d);
        double d2 = Double.isNaN(this.previousAngle) ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : this.previousAngle - d;
        this.rotation = d2;
