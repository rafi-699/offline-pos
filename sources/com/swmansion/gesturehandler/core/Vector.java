...
public final class Vector {
    ...
    private static final Vector VECTOR_LEFT = new Vector(-1.0d, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
    private static final Vector VECTOR_RIGHT = new Vector(1.0d, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
    private static final Vector VECTOR_UP = new Vector(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, -1.0d);
    private static final Vector VECTOR_DOWN = new Vector(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, 1.0d);
    ...
    private static final Vector VECTOR_ZERO = new Vector(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
