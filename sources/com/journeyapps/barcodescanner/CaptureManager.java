...
public class CaptureManager {
    ...
    /* JADX INFO: renamed from: com.journeyapps.barcodescanner.CaptureManager$1 */
        ...
        public void barcodeResult(final BarcodeResult barcodeResult) {
            ...
            CaptureManager.this.handler.post(new Runnable() { // from class: com.journeyapps.barcodescanner.CaptureManager$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m1241xddc42d84(barcodeResult);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$barcodeResult$0$com-journeyapps-barcodescanner-CaptureManager$1 */
        /* synthetic */ void m1241xddc42d84(BarcodeResult barcodeResult) {
            CaptureManager.this.returnResult(barcodeResult);
        }
    }

    /* JADX INFO: renamed from: com.journeyapps.barcodescanner.CaptureManager$2 */
    class AnonymousClass2 implements CameraPreview.StateListener {
    ...
    public CaptureManager(Activity activity, DecoratedBarcodeView decoratedBarcodeView) {
        ...
        this.inactivityTimer = new InactivityTimer(activity, new Runnable() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1240lambda$new$0$comjourneyappsbarcodescannerCaptureManager();
            }
        });
        this.beepManager = new BeepManager(activity);
    }

    /* JADX INFO: renamed from: lambda$new$0$com-journeyapps-barcodescanner-CaptureManager */
    /* synthetic */ void m1240lambda$new$0$comjourneyappsbarcodescannerCaptureManager() {
    ...
    protected void displayFrameworkBugMessageAndExit(String str) {
        ...
        builder.setPositiveButton(R.string.zxing_button_ok, new DialogInterface.OnClickListener() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda2
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m1238x170613e1(dialogInterface, i);
            }
        });
        builder.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda3
            ...
            public final void onCancel(DialogInterface dialogInterface) {
                this.f$0.m1239x8c803a22(dialogInterface);
            }
        });
        builder.show();
    }

    /* JADX INFO: renamed from: lambda$displayFrameworkBugMessageAndExit$1$com-journeyapps-barcodescanner-CaptureManager */
    /* synthetic */ void m1238x170613e1(DialogInterface dialogInterface, int i) {
        finish();
    }

    /* JADX INFO: renamed from: lambda$displayFrameworkBugMessageAndExit$2$com-journeyapps-barcodescanner-CaptureManager */
    /* synthetic */ void m1239x8c803a22(DialogInterface dialogInterface) {
        finish();
    }
