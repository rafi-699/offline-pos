...
class PdfFile {
    ...
    PdfFile(PdfiumCore pdfiumCore, PdfDocument pdfDocument, FitPolicy fitPolicy, Size size, int[] iArr, boolean z, boolean z2, int i, boolean z3, boolean z4, boolean z5) {
        this.showTwoPages = z;
    ...
    public void recalculatePageSizes(Size size) {
        ...
        while (it.hasNext()) {
            this.pageSizes.add(pageSizeCalculator.calculate(it.next(), this.showTwoPages, this.isLandscape));
        }
        if (this.autoSpacing) {
    ...
    public RectF mapRectToDevice(int i, int i2, int i3, int i4, int i5, RectF rectF) {
        return new RectF(this.pdfDocument.openPage(documentPage(i)).mapRectToDevice(i2, i3, i4, i5, 0, rectF));
    }
