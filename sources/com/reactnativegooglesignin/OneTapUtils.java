...
public final class OneTapUtils {
    ...
    public static final class C0053OneTapUtils {
        ...
        public C0053OneTapUtils(ReactApplicationContext context) {
            Intrinsics.checkNotNullParameter(context, "context");
            this.context = context;
            this.detectedWebClientId = LazyKt.lazy(new Function0() { // from class: com.reactnativegooglesignin.OneTapUtils$OneTapUtils$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return OneTapUtils.C0053OneTapUtils.detectedWebClientId_delegate$lambda$0(this.f$0);
                }
            });
        }
        ...
        public static final String detectedWebClientId_delegate$lambda$0(C0053OneTapUtils c0053OneTapUtils) {
            int identifier = c0053OneTapUtils.context.getResources().getIdentifier("default_web_client_id", "string", c0053OneTapUtils.context.getPackageName());
            if (identifier != 0) {
                return c0053OneTapUtils.context.getResources().getString(identifier);
            }
            return null;
        }
        ...
        public final Long installedGooglePlayServicesVersion() {
            ...
            try {
                ...
                C0053OneTapUtils c0053OneTapUtils = this;
        ...
        public final ReadableMap getUserProperties(GoogleIdTokenCredential acct) {
            ...
            writableMapCreateMap.putString("id", getSubjectId(acct));
            writableMapCreateMap.putString("email", zza);
        ...
        private final String getSubjectId(GoogleIdTokenCredential acct) {
            String subject = new JWT(acct.getZzb()).getSubject();
            if (subject != null) {
                return subject;
            }
            throw new IllegalArgumentException("Subject ID is not available in the provided GoogleIdTokenCredential.");
        }
    }
}
