...
import com.reactnativegooglesignin.NativeOneTapSignInSpec;
...
public final class RNOneTapSignInModule extends NativeOneTapSignInSpec {
    ...
    private final OneTapUtils.C0054OneTapUtils oneTapUtils;
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [com.reactnativegooglesignin.modern.RNOneTapSignInModule$activityEventListener$1] */
    public RNOneTapSignInModule(ReactApplicationContext reactContext) {
        super(reactContext);
        Intrinsics.checkNotNullParameter(reactContext, "reactContext");
        this.credentialManager = LazyKt.lazy(new Function0() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda4
        ...
        this.oneTapUtils = new OneTapUtils.C0054OneTapUtils(reactApplicationContext);
        ?? r0 = new BaseActivityEventListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$activityEventListener$1
    ...
    /* JADX INFO: renamed from: com.reactnativegooglesignin.modern.RNOneTapSignInModule$signInInternal$1, reason: invalid class name */
    /* JADX INFO: compiled from: RNOneTapSignInModule.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.reactnativegooglesignin.modern.RNOneTapSignInModule$signInInternal$1", f = "RNOneTapSignInModule.kt", i = {}, l = {Imgproc.COLOR_YUV2BGRA_YVYU}, m = "invokeSuspend", n = {}, s = {})
    ...
    public final void handleSignInError(GetCredentialException e, Promise promise) {
        ...
        if (e instanceof NoCredentialException) {
            if (Intrinsics.areEqual(e.getType(), "android.credentials.GetCredentialException.TYPE_NO_CREDENTIAL")) {
                ...
                if (lowerCase != null && StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "developer console is not set up correctly", false, 2, (Object) null)) {
        ...
        if (e instanceof GetCredentialProviderConfigurationException) {
            ...
            if (e instanceof GetCredentialCustomException) {
                promise.reject(((GetCredentialCustomException) e).getType(), e.getMessage() + " - are you connected to the internet?", e);
                return;
            }
            promise.reject(e.getType(), e.getMessage(), e);
        }
    ...
    public void requestAuthorization(ReadableMap params, final Promise promise) {
        ...
        final Function1 function1 = new Function1() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return RNOneTapSignInModule.requestAuthorization$lambda$1(this.f$0, promise, activity, (AuthorizationResult) obj);
            }
        };
        taskAuthorize.addOnSuccessListener(new OnSuccessListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                function1.invoke(obj);
            }
        }).addOnCanceledListener(new OnCanceledListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.OnCanceledListener
            public final void onCanceled() {
                RNOneTapSignInModule.requestAuthorization$lambda$3(promise, this);
            }
        }).addOnFailureListener(new OnFailureListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda3
            @Override // com.google.android.gms.tasks.OnFailureListener
            public final void onFailure(Exception exc) {
                RNOneTapSignInModule.requestAuthorization$lambda$4(promise, exc);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit requestAuthorization$lambda$1(RNOneTapSignInModule rNOneTapSignInModule, Promise promise, Activity activity, AuthorizationResult authorizationResult) {
        ...
        if (authorizationResult.hasResolution() && pendingIntent != null) {
            try {
                ...
                rNOneTapSignInModule.requestAuthorizationPromiseWrapper.reject("requestAuthorization", "Couldn't start Authorization UI: " + e.getLocalizedMessage());
            }
        } else {
            OneTapUtils.C0054OneTapUtils c0054OneTapUtils = rNOneTapSignInModule.oneTapUtils;
            Intrinsics.checkNotNull(authorizationResult);
            promise.resolve(c0054OneTapUtils.authorizationResultToJsMap(authorizationResult));
        }
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void requestAuthorization$lambda$3(Promise promise, RNOneTapSignInModule rNOneTapSignInModule) {
        promise.resolve(rNOneTapSignInModule.oneTapUtils.getCanceledResult());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void requestAuthorization$lambda$4(Promise promise, Exception e) {
    ...
    public void checkPlayServices(boolean showErrorResolutionDialog, Promise promise) {
        ...
        final int iIsGooglePlayServicesAvailable = googleApiAvailability.isGooglePlayServicesAvailable(getReactApplicationContext());
        ...
        final Activity activity = getActivity();
        if (showErrorResolutionDialog && zIsUserResolvableError && activity != null) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    RNOneTapSignInModule.checkPlayServices$lambda$6(googleApiAvailability, activity, iIsGooglePlayServicesAvailable);
                }
            });
        }
        ...
        writableMapCreateMap.putBoolean("activityWasNonNull", activity != null);
        promise.reject(RNGoogleSigninModule.PLAY_SERVICES_NOT_AVAILABLE, errorString, writableMapCreateMap);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void checkPlayServices$lambda$6(GoogleApiAvailability googleApiAvailability, Activity activity, int i) {
    ...
    public void clearCachedAccessToken(String tokenString, final Promise promise) {
        ...
        final Function1 function1 = new Function1() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return RNOneTapSignInModule.clearCachedAccessToken$lambda$7(promise, (Void) obj);
            }
        };
        taskClearToken.addOnSuccessListener(new OnSuccessListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda6
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                function1.invoke(obj);
            }
        }).addOnFailureListener(new OnFailureListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda7
            @Override // com.google.android.gms.tasks.OnFailureListener
            public final void onFailure(Exception exc) {
                RNOneTapSignInModule.clearCachedAccessToken$lambda$9(promise, exc);
            }
        }).addOnCanceledListener(new OnCanceledListener() { // from class: com.reactnativegooglesignin.modern.RNOneTapSignInModule$$ExternalSyntheticLambda8
            @Override // com.google.android.gms.tasks.OnCanceledListener
            public final void onCanceled() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit clearCachedAccessToken$lambda$7(Promise promise, Void r1) {
        promise.resolve(null);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void clearCachedAccessToken$lambda$9(Promise promise, Exception e) {
        Intrinsics.checkNotNullParameter(e, "e");
        promise.reject("clearCachedAccessToken", e);
    }

    /* JADX INFO: renamed from: com.reactnativegooglesignin.modern.RNOneTapSignInModule$signOut$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: RNOneTapSignInModule.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.reactnativegooglesignin.modern.RNOneTapSignInModule$signOut$1", f = "RNOneTapSignInModule.kt", i = {}, l = {284}, m = "invokeSuspend", n = {}, s = {})
    static final class C01541 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Promise $promise;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01541(Promise promise, Continuation<? super C01541> continuation) {
            super(2, continuation);
            this.$promise = promise;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RNOneTapSignInModule.this.new C01541(this.$promise, continuation);
        }
    ...
    public void signOut(Promise promise) {
        Intrinsics.checkNotNullParameter(promise, "promise");
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(Dispatchers.getIO()), null, null, new C01541(promise, null), 3, null);
    }
