...
public interface BleAdapter {
    ...
    void monitorCharacteristic(int i, String str, String str2, OnEventCallback<Characteristic> onEventCallback, OnErrorCallback onErrorCallback);

    void monitorCharacteristicForDevice(String str, String str2, String str3, String str4, String str5, OnEventCallback<Characteristic> onEventCallback, OnErrorCallback onErrorCallback);

    void monitorCharacteristicForService(int i, String str, String str2, String str3, OnEventCallback<Characteristic> onEventCallback, OnErrorCallback onErrorCallback);
    ...
    void startDeviceScan(String[] strArr, int i, int i2, boolean z, OnEventCallback<ScanResult> onEventCallback, OnErrorCallback onErrorCallback);
