...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.on(ClassUtils.PACKAGE_SEPARATOR_CHAR);
    private static final Joiner DOT_JOINER = Joiner.on(ClassUtils.PACKAGE_SEPARATOR_CHAR);
    ...
    InternetDomainName(String name) {
        String lowerCase = Ascii.toLowerCase(DOTS_MATCHER.replaceFrom(name, ClassUtils.PACKAGE_SEPARATOR_CHAR));
