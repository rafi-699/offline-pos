...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
 ...
 A[WRAPPED] (LINE:576) elemType: com.google.common.cache.LocalCache$EntryFactory
    ...
    static abstract class EntryFactory {
        ...
        private EntryFactory(String $enum$name, int $enum$ordinal) {
    ...
    static class Segment<K, V> extends ReentrantLock {
            ...
            try {
                try {
                    try {
                        ...
                        k = key;
                        V vLockedGetOrLoad = lockedGetOrLoad(k, hash, loader);
                        postReadCleanup();
        ...
        V lockedGetOrLoad(K key, int hash, CacheLoader<? super K, V> loader) throws ExecutionException {
            ...
            try {
                ...
                if (z) {
                    try {
                        return loadSync(key, i, loadingValueReference, loader);
                    } finally {
        ...
        ListenableFuture<V> loadAsync(final K key, final int hash, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            listenableFutureLoadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m1178lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(key, hash, loadingValueReference, listenableFutureLoadFuture);
                }
        ...
        /* synthetic */ void m1178lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
        ...
        V put(K key, int hash, V value, boolean onlyIfAbsent) {
            ...
            try {
                ...
                while (next != null) {
                    ...
                    if (next.getHash() == hash && key2 != null && this.map.keyEquivalence.equivalent(key, key2)) {
                        ...
                        if (v != null) {
                            ...
                            setValue(referenceEntry3, key, value, j2);
                        ...
                        if (valueReference.isActive()) {
                            ...
                            setValue(referenceEntry5, key, value, j);
                ...
                this.modCount++;
                ReferenceEntry<K, V> referenceEntryNewEntry = newEntry(key, hash, referenceEntry2);
                ...
                while (next != null) {
                    ...
                    if (referenceEntry2.getHash() != i || key2 == null || !this.map.keyEquivalence.equivalent(key, key2)) {
                        ...
                        if (v == null) {
                            ...
                            this.modCount++;
                            ReferenceEntry<K, V> referenceEntryRemoveValueFromChain = removeValueFromChain(referenceEntry, referenceEntry2, key2, i, v, valueReference, RemovalCause.COLLECTED);
                            int i2 = this.count - 1;
                        ...
                        if (this.map.valueEquivalence.equivalent(oldValue, v)) {
                            this.modCount++;
                            enqueueNotification(key, hash, v, valueReference.getWeight(), RemovalCause.REPLACED);
                            setValue(referenceEntry2, key, newValue, j3);
            ...
            try {
                ...
                while (next != null) {
                    ...
                    if (next.getHash() != hash || key2 == null || !this.map.keyEquivalence.equivalent(key, key2)) {
                        ...
                        this.modCount++;
                        enqueueNotification(key, hash, v, valueReference.getWeight(), RemovalCause.REPLACED);
                        setValue(referenceEntry3, key, newValue, j3);
                        evictEntries(referenceEntry3);
                        unlock();
                        postWriteCleanup();
                        return v;
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
            ...
            try {
                ...
                return Futures.transform(listenableFutureReload, new Function() { // from class: com.google.common.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m1177x59597480(obj);
                    }
                }, MoreExecutors.directExecutor());
            } catch (Throwable th) {
        ...
        /* synthetic */ Object m1177x59597480(Object obj) {
            set(obj);
            return obj;
        }
