...
public final class CacheStats {
    ...
    public double missRate() {
        long jRequestCount = requestCount();
        return jRequestCount == 0 ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : this.missCount / jRequestCount;
    }
    ...
    public double loadExceptionRate() {
        ...
        return jSaturatedAdd == 0 ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : this.loadExceptionCount / jSaturatedAdd;
    }
    ...
    public double averageLoadPenalty() {
        long jSaturatedAdd = LongMath.saturatedAdd(this.loadSuccessCount, this.loadExceptionCount);
        return jSaturatedAdd == 0 ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : this.totalLoadTime / jSaturatedAdd;
    }
