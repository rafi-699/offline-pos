...
public final class StatsAccumulator {
    ...
    private double mean = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    private double sumOfSquaresOfDeltas = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    ...
    public final double populationVariance() {
        ...
        return this.count == 1 ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : DoubleUtils.ensureNonNegative(this.sumOfSquaresOfDeltas) / this.count;
    }
