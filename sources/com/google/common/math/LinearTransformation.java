...
public abstract class LinearTransformation {
    ...
    public static LinearTransformation horizontal(double y) {
        ...
        return new RegularLinearTransformation(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, y);
    }
    ...
    private static final class RegularLinearTransformation extends LinearTransformation {
        ...
        public boolean isHorizontal() {
            return this.slope == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        }
    ...
    private static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, this.x, this);
        }
    }
