...
public final class JavaDataStorage {
    ...
    static final class C01481<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        final /* synthetic */ T $defaultValue;
        final /* synthetic */ Preferences.Key<T> $key;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01481(Preferences.Key<T> key, T t, Continuation<? super C01481> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C01481(this.$key, this.$defaultValue, continuation);
        }
    ...
    public final <T> T getSync(Preferences.Key<T> key, T defaultValue) {
        ...
        return (T) BuildersKt__BuildersKt.runBlocking$default(null, new C01481(key, defaultValue, null), 1, null);
    }
    ...
    static final class C01491 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Preferences>, Object> {
        final /* synthetic */ Preferences.Key<T> $key;
        final /* synthetic */ T $value;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01491(Preferences.Key<T> key, T t, Continuation<? super C01491> continuation) {
            super(2, continuation);
            this.$key = key;
            this.$value = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C01491(this.$key, this.$value, continuation);
        }
        ...
        static final class C00451 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ Preferences.Key<T> $key;
            final /* synthetic */ T $value;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00451(Preferences.Key<T> key, T t, Continuation<? super C00451> continuation) {
                super(2, continuation);
                this.$key = key;
                this.$value = t;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00451 c00451 = new C00451(this.$key, this.$value, continuation);
                c00451.L$0 = obj;
                return c00451;
            }
            ...
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C00451) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            Object objEdit = PreferencesKt.edit(JavaDataStorage.this.dataStore, new C00451(this.$key, this.$value, null), this);
    ...
    public final <T> Preferences putSync(Preferences.Key<T> key, T value) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default(null, new C01491(key, value, null), 1, null);
    }
    ...
    static final class C01471 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Map<Preferences.Key<?>, ? extends Object>>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C01471(continuation);
        }
    ...
    public final Map<Preferences.Key<?>, Object> getAllSync() {
        return (Map) BuildersKt__BuildersKt.runBlocking$default(null, new C01471(null), 1, null);
    }
    ...
    static final class C01461 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Preferences>, Object> {
        final /* synthetic */ Function1<MutablePreferences, Unit> $transform;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01461(Function1<? super MutablePreferences, Unit> function1, Continuation<? super C01461> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return JavaDataStorage.this.new C01461(this.$transform, continuation);
        }
            ...
            try {
                if (i == 0) {
                    ...
                    if (!Intrinsics.areEqual(JavaDataStorage.this.editLock.get(), Boxing.boxBoolean(true))) {
                        ...
                        this.label = 1;
                        obj = PreferencesKt.edit(JavaDataStorage.this.dataStore, new C00441(this.$transform, null), this);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
        ...
        static final class C00441 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function1<MutablePreferences, Unit> $transform;
            /* synthetic */ Object L$0;
            int label;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00441(Function1<? super MutablePreferences, Unit> function1, Continuation<? super C00441> continuation) {
                super(2, continuation);
                this.$transform = function1;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00441 c00441 = new C00441(this.$transform, continuation);
                c00441.L$0 = obj;
                return c00441;
            }
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C00441) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public final Preferences editSync(Function1<? super MutablePreferences, Unit> transform) {
        ...
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default(null, new C01461(transform, null), 1, null);
    }
}
