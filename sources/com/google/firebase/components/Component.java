...
public final class Component<T> {
    ...
    /* synthetic */ Component(String str, Set set, Set set2, int i, int i2, ComponentFactory componentFactory, Set set3) {
    ...
    public static class Builder<T> {
        ...
        /* synthetic */ Builder(Qualified qualified, Qualified[] qualifiedArr) {
