    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (z) {
            ...
            for (int i19 = 0; i19 < i17; i19++) {
                int i20 = (i19 / 15) + i19;
                iArr[(i17 - i19) - i6] = (i18 - i20) - 1;
                iArr[i17 + i19] = i20 + i18 + i6;
            }
        }
        BitMatrix bitMatrix = new BitMatrix(i5);
        int i21 = 0;
        for (int i22 = 0; i22 < iAbs; i22++) {
            int i23 = ((iAbs - i22) << i15) + (z ? 9 : 12);
            for (int i24 = 0; i24 < i23; i24++) {
                ...
                while (i26 < i15) {
                    ...
                    if (bitArrayGenerateCheckWords.get((i23 << 1) + i21 + i25 + i26)) {
                        int i29 = i22 << 1;
                        bitMatrix.set(iArr[i29 + i24], iArr[((i14 - 1) - i29) - i26]);
                    }
                    ...
                    if (bitArrayGenerateCheckWords.get((i23 * 6) + i21 + i25 + i26)) {
                        int i31 = i22 << 1;
                        bitMatrix.set(iArr[((i14 - 1) - i31) - i24], iArr[i31 + i26]);
                    }
                    i26++;
                    i6 = i27;
                    i15 = i15;
