...
public final class PDF417ScanningDecoder {
    ...
    /* JADX WARN: Code duplicated, block: B:71:0x00ef A[SYNTHETIC] */
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, ChecksumException, FormatException {
        ...
        boolean z2 = true;
        while (true) {
            DetectionResultRowIndicatorColumn rowIndicatorColumn2 = resultPoint != null ? getRowIndicatorColumn(bitMatrix, boundingBox, resultPoint, true, i, i2) : detectionResultRowIndicatorColumn2;
            if (resultPoint3 != null) {
                rowIndicatorColumn = getRowIndicatorColumn(bitMatrix, boundingBox, resultPoint3, false, i, i2);
            }
            BoundingBox boundingBox2 = boundingBox;
            DetectionResult detectionResultMerge = merge(rowIndicatorColumn2, rowIndicatorColumn);
            ...
            if (!z2 || boundingBox == null || (boundingBox.getMinY() >= boundingBox2.getMinY() && boundingBox.getMaxY() <= boundingBox2.getMaxY())) {
                detectionResultMerge.setBoundingBox(boundingBox2);
                int barcodeColumnCount = detectionResultMerge.getBarcodeColumnCount() + 1;
                detectionResultMerge.setDetectionResultColumn(0, rowIndicatorColumn2);
                detectionResultMerge.setDetectionResultColumn(barcodeColumnCount, rowIndicatorColumn);
                boolean z3 = rowIndicatorColumn2 != null;
                int i5 = i;
                int i6 = i2;
                int i7 = 1;
                while (i7 <= barcodeColumnCount) {
                    ...
                    if (detectionResultMerge.getDetectionResultColumn(i8) == null) {
                        if (i8 == 0 || i8 == barcodeColumnCount) {
                            detectionResultRowIndicatorColumn = new DetectionResultRowIndicatorColumn(boundingBox2, i8 == 0 ? z : false);
                        } else {
                        ...
                        while (minY <= boundingBox2.getMaxY()) {
                            ...
                            if (startColumn >= 0 && startColumn <= boundingBox2.getMaxX()) {
                                ...
                                i3 = i9;
                                i4 = startColumn;
                                codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox2.getMinX(), boundingBox2.getMaxX(), z3, i4, minY, iMin, iMax);
