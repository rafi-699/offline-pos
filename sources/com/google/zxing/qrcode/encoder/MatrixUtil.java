...
final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, Videoio.CAP_PROP_OPENNI2_SYNC, -1, -1}, new int[]{6, 30, 58, 86, 114, -1, -1}, new int[]{6, 34, 62, 90, Imgproc.COLOR_YUV2BGR_YVYU, -1, -1}, new int[]{6, 26, 50, 74, 98, Imgproc.COLOR_YUV2BGRA_YVYU, -1}, new int[]{6, 30, 54, 78, 102, 126, -1}, new int[]{6, 26, 52, 78, 104, 130, -1}, new int[]{6, 30, 56, 82, 108, 134, -1}, new int[]{6, 34, 60, 86, 112, 138, -1}, new int[]{6, 30, 58, 86, 114, 142, -1}, new int[]{6, 34, 62, 90, Imgproc.COLOR_YUV2BGR_YVYU, 146, -1}, new int[]{6, 30, 54, 78, 102, 126, Imgproc.COLOR_BGR2YUV_YVYU}, new int[]{6, 24, 50, 76, 102, 128, Imgproc.COLOR_BGRA2YUV_YVYU}, new int[]{6, 28, 54, 80, 106, Imgproc.COLOR_BGR2YUV_YV12, 158}, new int[]{6, 32, 58, 84, Videoio.CAP_PROP_OPENNI2_SYNC, 136, 162}, new int[]{6, 26, 54, 82, Videoio.CAP_PROP_OPENNI2_SYNC, 138, 166}, new int[]{6, 30, 58, 86, 114, 142, 170}};
