...
public final class zzic implements zzjg {
    ...
    public final boolean zzI() {
        ...
        if (zznlVarZzt.zzK()) {
            ...
            if (bundle == null) {
                ...
                zzgsVarZzj2.zzb(sb3.toString(), Integer.valueOf(this.zzD));
                return z;
            }
            ...
            int i3 = !Objects.equals(zzaz.zzi(bundle), true) ? 1 : 0;
            sb.append("&npa=");
            sb.append(i3);
        ...
        if (urlZzat != null) {
            ...
            zzll zzllVar = new zzll() { // from class: com.google.android.gms.measurement.internal.zzib
                ...
                public final /* synthetic */ void zza(String str3, int i4, Throwable th, byte[] bArr, Map map) {
                    this.zza.zzJ(str3, i4, th, bArr, map);
                }
            };
            zzloVar2.zzw();
    ...
    final /* synthetic */ void zzJ(String str, int i, Throwable th, byte[] bArr, Map map) {
        int i2;
        if (i != 200 && i != 204) {
            i2 = Videoio.CAP_PROP_PVAPI_BINNINGX;
            if (i != 304) {
                i2 = i;
            }
            zzgu zzguVar = this.zzh;
        ...
        if (th == null) {
            ...
            try {
                ...
                double dOptDouble = jSONObject.optDouble(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    ...
                    if (listQueryIntentActivities != null && !listQueryIntentActivities.isEmpty()) {
                        ...
                        try {
                            ...
                            editorEdit.putLong(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP, Double.doubleToRawLongBits(dOptDouble));
    ...
    protected final void zza(com.google.android.gms.internal.measurement.zzdd zzddVar) {
        ...
        if (zzheVar.zza() == 0) {
            ...
            zzP(zzguVar6);
            long j = this.zza;
            zzguVar6.zzk().zzb("Persisting first open", Long.valueOf(j));
            zzN(zzhhVar);
            zzheVar.zzb(j);
        }
        zzO(zzljVar4);
