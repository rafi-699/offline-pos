...
abstract class zzab {
    ...
    static Boolean zzg(long j, com.google.android.gms.internal.measurement.zzfl zzflVar) {
        try {
            return zzj(new BigDecimal(j), zzflVar, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
    ...
    static Boolean zzi(String str, com.google.android.gms.internal.measurement.zzfl zzflVar) {
        ...
        try {
            return zzj(new BigDecimal(str), zzflVar, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
