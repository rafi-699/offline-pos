...
public final class zzfy {
    ...
    static {
        ...
        zzc = zza("measurement.monitoring.sample_period_millis", lValueOf2, lValueOf2, zzcf.zza, false);
        zzd = zza("measurement.config.cache_time", lValueOf2, lValueOf, zzcq.zza, false);
        ...
        zzM = zza("measurement.upload.stale_data_deletion_interval", lValueOf2, lValueOf2, zzcy.zza, false);
        zzN = zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L, 604800000L, zzcz.zza, false);
        Long lValueOf3 = Long.valueOf(C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
        zzO = zza("measurement.upload.initial_upload_delay_time", lValueOf3, lValueOf3, zzda.zza, false);
