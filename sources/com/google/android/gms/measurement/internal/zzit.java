            ...
            if (zzhVarZzu != null) {
                if (zzhVarZzu.zzD()) {
                    ...
                    try {
                        ...
                        try {
                            zzbb zzbbVar = new zzbb(zzicVar4, str, str2, str5, zzbgVar.zzd, j, bundle);
                            ...
                            zzicVarZzaE.zzaf(zzpgVar4.zzm().zzb(zzhVarZzu.zzc(), Collections.emptyList(), zzicVarZzaE.zzk(), Long.valueOf(zzhrVarZzk.zzn()), Long.valueOf(zzhrVarZzk.zzn()), false));
                            if (zzhrVarZzk.zzm()) {
