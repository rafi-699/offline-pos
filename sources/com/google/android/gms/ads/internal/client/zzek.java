...
public final class zzek {
    ...
    private static zzr zzF(Context context, AdSize[] adSizeArr, int i) {
        for (AdSize adSize : adSizeArr) {
            if (adSize.equals(AdSize.INVALID)) {
                return new zzr(Constants.COLLATION_INVALID, 0, 0, false, 0, 0, null, false, false, false, true, false, false, false, false, false);
            }
        }
    ...
    /* JADX WARN: Code duplicated, block: B:29:0x00b7 A[Catch: RemoteException -> 0x00c1, TRY_LEAVE, TryCatch #0 {RemoteException -> 0x00c1, blocks: (B:22:0x0086, B:24:0x008c, B:26:0x009a, B:28:0x00ac, B:29:0x00b7), top: B:51:0x0086, outer: #1 }] */
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                if (viewGroup.isInEditMode()) {
                    ...
                    int i2 = this.zzn;
                    if (adSize.equals(AdSize.INVALID)) {
                        zzrVar = new zzr(Constants.COLLATION_INVALID, 0, 0, false, 0, 0, null, false, false, false, true, false, false, false, false, false);
                    } else {
