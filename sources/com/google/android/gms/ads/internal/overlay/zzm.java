...
public class zzm extends zzbza implements zzah {
    ...
    private final void zzJ(Configuration configuration) {
        ...
        if (!((Boolean) zzba.zzc().zzd(zzbiq.zzoT)).booleanValue() || Build.VERSION.SDK_INT > 34 || Build.VERSION.SDK_INT < 28 || !z3) {
            return;
        }
        ...
        if (zzckuVar != null) {
            ...
            synchronized (this.zzp) {
                if (!this.zzs && this.zzd.zzaa()) {
                    ...
                    com.google.android.gms.ads.internal.util.zzs.zza.postDelayed(this.zzr, ((Long) zzba.zzc().zzd(zzbiq.zzbJ)).longValue());
                    return;
                }
            }
        }
    ...
    public final void zzG(zzekt zzektVar) throws RemoteException, zzh {
        zzbyu zzbyuVar;
        AdOverlayInfoParcel adOverlayInfoParcel = this.zzc;
    ...
    public final void zzw(int i) {
        ...
        if (activity.getApplicationInfo().targetSdkVersion >= ((Integer) zzba.zzc().zzd(zzbiq.zzgV)).intValue()) {
            if (activity.getApplicationInfo().targetSdkVersion <= ((Integer) zzba.zzc().zzd(zzbiq.zzgW)).intValue()) {
                if (Build.VERSION.SDK_INT >= ((Integer) zzba.zzc().zzd(zzbiq.zzgX)).intValue()) {
                    if (Build.VERSION.SDK_INT <= ((Integer) zzba.zzc().zzd(zzbiq.zzgY)).intValue()) {
                        return;
                    }
                }
            }
        ...
        if (z) {
            try {
                ...
                if (str2 != null) {
                    ...
                    this.zzd.loadDataWithBaseURL(adOverlayInfoParcel3.zzf, str3, "text/html", Key.STRING_CHARSET_NAME, null);
                }
