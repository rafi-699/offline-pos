...
final class zzp {
    ...
    private final zzdky zzh;
    private final zzbyu zzi;
    private final ScheduledFuture zzj;

    zzp(com.google.android.gms.ads.internal.client.zza zzaVar, zzr zzrVar, zzcku zzckuVar, zzbog zzbogVar, zzboi zzboiVar, zzad zzadVar, zzdde zzddeVar, zzdky zzdkyVar, zzbyu zzbyuVar, ScheduledFuture scheduledFuture) {
        this.zza = zzaVar;
        this.zzb = zzrVar;
        this.zzc = zzckuVar;
        this.zzd = zzbogVar;
    ...
    final /* synthetic */ zzdde zzg() {
        return this.zzg;
    }

    final /* synthetic */ zzdky zzh() {
        return this.zzh;
    }

    final /* synthetic */ zzbyu zzi() {
        return this.zzi;
    }
