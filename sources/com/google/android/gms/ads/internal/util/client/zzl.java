...
public final class zzl {
    ...
    public zzl(String str) {
        ...
        if (zzj()) {
            ...
            listAsList = Arrays.asList("network_request_".concat(String.valueOf(string)));
        } else {
    ...
    static /* synthetic */ void zzl(int i, Map map, JsonWriter jsonWriter) throws IOException {
        jsonWriter.name(NativeProtocol.WEB_DIALOG_PARAMS).beginObject();
        jsonWriter.name("firstline").beginObject();
    ...
    private static synchronized void zzr(String str) {
        ...
        while (i < str.length()) {
            int i2 = i + 4000;
            String strSubstring = str.substring(i, Math.min(i2, str.length()));
            String.valueOf(strSubstring);
            zzo.zzh("GMA Debug CONTENT ".concat(String.valueOf(strSubstring)));
            i = i2;
        }
