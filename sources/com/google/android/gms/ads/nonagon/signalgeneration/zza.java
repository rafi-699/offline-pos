...
public final class zza {
    ...
    zza(Context context, zzbia zzbiaVar, List list, VersionInfoParcel versionInfoParcel) {
        this.zza = context;
    ...
    public final void zza(WebView webView) {
        ...
        if (((Boolean) zzbkv.zzb.zze()).booleanValue() && WebViewFeature.isFeatureSupported(WebViewFeature.DOCUMENT_START_SCRIPT) && webView != null) {
            WebViewCompat.addDocumentStartJavaScript(webView, String.format(Locale.getDefault(), (String) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzli), zzb()), zzgww.zzi(ProxyConfig.MATCH_ALL_SCHEMES));
        }
    }
