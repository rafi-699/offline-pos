...
public final class zzhz implements zzhx {
    ...
    static {
        ...
        zza = zzczVarZza.zzc("getTokenRefactor__account_data_service_sample_percentage", ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        ...
        try {
            ...
            zzm = zzczVarZza.zzc("getTokenRefactor__gms_account_authenticator_sample_percentage", ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE);
        } catch (Exception e) {
