...
class zzhd extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int iCompareTo = comparable.compareTo(((zzgz) this.zza[i2]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgz) this.zza[i4]).zza());
            if (iCompareTo2 < 0) {
                i2 = i4 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object get(Object obj) {
        ...
        return iZzl >= 0 ? ((zzgz) this.zza[iZzl]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzl = zzl(comparable);
        if (iZzl >= 0) {
            return ((zzgz) this.zza[iZzl]).setValue(obj);
        }
        zzo();
        if (this.zza == null) {
