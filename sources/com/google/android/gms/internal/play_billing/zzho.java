...
final class zzho {
    ...
    static {
        ...
        if (unsafeZzg != null) {
            if (zZzv) {
                zzhlVar = new zzhm(unsafeZzg);
            } else if (zZzv2) {
                zzhlVar = new zzhl(unsafeZzg);
            }
        }
        zzf = zzhlVar;
        if (zzhlVar == null) {
            ...
            try {
                Class<?> cls = zzhlVar.zza.getClass();
        ...
        if (zzhnVar2 == null) {
            ...
            try {
                Class<?> cls2 = zzhnVar2.zza.getClass();
        ...
        zzA(Object[].class);
        Field fieldZzB = zzB();
        if (fieldZzB != null && (zzhnVar = zzf) != null) {
            zzhnVar.zza.objectFieldOffset(fieldZzB);
        }
