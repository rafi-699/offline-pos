...
public final class zzajt extends zzajo {
    ...
    /* JADX WARN: Code duplicated, block: B:84:0x0181 A[Catch: NumberFormatException | StringIndexOutOfBoundsException -> 0x0203, TryCatch #0 {NumberFormatException | StringIndexOutOfBoundsException -> 0x0203, blocks: (B:69:0x0123, B:82:0x0178, B:84:0x0181, B:86:0x018d, B:102:0x01dc), top: B:113:0x000a }] */
        ...
        try {
            switch (str.hashCode()) {
                ...
                case 83341:
                    ...
                    strArrSplit = str3.split(DomExceptionUtils.SEPARATOR, -1);
                ...
                case 2569891:
                    ...
                    int i4 = Integer.parseInt(str5.substring(2, 4));
                    int i5 = Integer.parseInt(str5.substring(0, 2));
                ...
                case 2583398:
                    ...
                    strArrSplit = str6.split(DomExceptionUtils.SEPARATOR, -1);
                    ...
                    zzamVar.zzg(Integer.valueOf(i6));
                    zzamVar.zzh(numValueOf);
                    break;
                case 2590194:
                    if (!str.equals("TYER")) {
