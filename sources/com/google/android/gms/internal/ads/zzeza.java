...
public final class zzeza implements zzimu {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (list.contains("39")) {
            zzfawVar = new zzfaw(zzewyVar, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzny)).intValue(), scheduledExecutorService);
        } else {
            zzfawVar = new zzfaw(zzfczVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzny)).intValue(), scheduledExecutorService);
        }
        return zzfawVar;
    }
}
