...
final class zzgko {
    ...
    zzgko(zzgox zzgoxVar, zzgme zzgmeVar, zzgmv zzgmvVar, zzgqh zzgqhVar, zzgel zzgelVar, boolean z, long j, long j2) {
        this.zza = zzgoxVar;
        this.zzb = zzgmeVar;
        this.zzc = zzgmvVar;
        this.zzd = zzgqhVar;
    ...
    final /* synthetic */ zzgkn zzf(final int i, zzgjz zzgjzVar) {
