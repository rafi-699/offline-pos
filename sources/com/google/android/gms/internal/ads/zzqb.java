...
public final class zzqb implements zznp, zzqc {
    ...
    public final void zzc(zznn zznnVar, String str) {
        ...
        if (zzxkVar == null || !zzxkVar.zzb()) {
            zzC();
            this.zzj = str;
            this.zzk = new PlaybackMetrics.Builder().setPlayerName(MediaLibraryInfo.TAG).setPlayerVersion("1.10.0-rc02");
    ...
    /* JADX WARN: Code duplicated, block: B:150:0x0222  */
    /* JADX WARN: Code duplicated, block: B:152:0x0226  */
    /* JADX WARN: Code duplicated, block: B:153:0x0229  */
    /* JADX WARN: Code duplicated, block: B:155:0x022d  */
    /* JADX WARN: Code duplicated, block: B:156:0x0233  */
    /* JADX WARN: Code duplicated, block: B:158:0x0237  */
    ...
    public final void zzdi(zzbb zzbbVar, zzno zznoVar) {
                    ...
                    if (cause instanceof zzig) {
                        ...
                        if (z2 || (cause instanceof zzio)) {
                            ...
                            if (cause3 instanceof MediaDrm.MediaDrmStateException) {
                                ...
                                i3 = cause3 instanceof zzue ? 28 : 30;
                            }
        ...
        if (zzw(this.zzq)) {
            zzqa zzqaVar2 = this.zzq;
            zzv zzvVar2 = zzqaVar2.zza;
            int i17 = zzqaVar2.zzb;
            zzy(jElapsedRealtime, zzvVar2, 0);
            this.zzq = null;
        }
        if (zzw(this.zzr)) {
            zzqa zzqaVar3 = this.zzr;
            zzv zzvVar3 = zzqaVar3.zza;
            int i18 = zzqaVar3.zzb;
