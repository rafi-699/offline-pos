...
public final class zzfuc {
    ...
    zzfuc(Context context, VersionInfoParcel versionInfoParcel, ScheduledExecutorService scheduledExecutorService, zzfoo zzfooVar, zzflu zzfluVar, Clock clock, zzfsn zzfsnVar) {
        this.zza = context;
