...
final class zzidk implements zzihi {
    ...
    @Override // com.google.android.gms.internal.ads.zzihi
    public final void zzM(int i, zzifh zzifhVar, Map map) throws IOException {
    ...
    @Override // com.google.android.gms.internal.ads.zzihi
    public final void zzr(int i, Object obj, zzigh zzighVar) throws IOException {
        zzidj zzidjVar = this.zza;
    ...
    @Override // com.google.android.gms.internal.ads.zzihi
    public final void zzs(int i, Object obj, zzigh zzighVar) throws IOException {
        zzidj zzidjVar = this.zza;
        zzidjVar.zzb(i, 3);
    ...
    public final void zzv(int i, Object obj) throws IOException {
        if (obj instanceof zzida) {
            this.zza.zzn(i, (zzida) obj);
        } else {
            this.zza.zzm(i, (zzifp) obj);
        }
    }
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < zzidvVar.size()) {
                this.zza.zze(i, Float.floatToRawIntBits(zzidvVar.zzf(i2)));
                i2++;
            }
            return;
        }
        ...
        zzidjVar2.zzr(i5);
        while (i2 < zzidvVar.size()) {
            zzidjVar2.zzs(Float.floatToRawIntBits(zzidvVar.zzf(i2)));
            i2++;
        }
    }
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < zzidlVar.size()) {
                this.zza.zzg(i, Double.doubleToRawLongBits(zzidlVar.zzf(i2)));
                i2++;
            }
            return;
        }
        ...
        zzidjVar2.zzr(i5);
        while (i2 < zzidlVar.size()) {
            zzidjVar2.zzu(Double.doubleToRawLongBits(zzidlVar.zzf(i2)));
            i2++;
        }
    }
