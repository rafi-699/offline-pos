...
final class zzhle {
    ...
    private static zzhld zza(zzhld zzhldVar, zzhld zzhldVar2) {
        ...
        zzhldVar3.zzb(zzhldVar.zza().multiply(zzhldVar2.zzc()).add(zzhldVar2.zza().multiply(zzhldVar.zzc())).multiply(BigInteger.ONE.add(bigIntegerMod).modInverse(bigInteger)).mod(bigInteger));
        zzhldVar3.zzd(zzhldVar.zzc().multiply(zzhldVar2.zzc()).add(zzhldVar.zza().multiply(zzhldVar2.zza())).multiply(BigInteger.ONE.subtract(bigIntegerMod).modInverse(bigInteger)).mod(bigInteger));
        return zzhldVar3;
    }
