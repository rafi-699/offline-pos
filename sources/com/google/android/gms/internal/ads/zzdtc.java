...
public final class zzdtc {
    ...
    private final ListenableFuture zzm(JSONArray jSONArray, boolean z, boolean z2, zzdyu zzdyuVar) {
        if (jSONArray == null || jSONArray.length() <= 0) {
            return zzhbw.zza(Collections.emptyList());
        }
        ArrayList arrayList = new ArrayList();
    ...
    private final ListenableFuture zzn(JSONObject jSONObject, boolean z, zzdyu zzdyuVar) {
        ...
        if (z || map != null) {
            return zzhbw.zza(new zzblp(null, Uri.parse(strOptString), dOptDouble, iOptInt, iOptInt2, map));
        }
    ...
    private final ListenableFuture zzp(JSONObject jSONObject, zzfkf zzfkfVar, zzfki zzfkiVar, com.google.android.gms.ads.internal.zzb zzbVar, zzcdn zzcdnVar) {
        final ListenableFuture listenableFutureZzb = this.zzi.zzb(jSONObject.optString("base_url"), jSONObject.optString("html"), zzfkfVar, zzfkiVar, zzr(jSONObject.optInt("width", 0), jSONObject.optInt("height", 0)), zzbVar, zzcdnVar);
    ...
    public final ListenableFuture zzc(JSONObject jSONObject, String str, final zzfkf zzfkfVar, final zzfki zzfkiVar, final com.google.android.gms.ads.internal.zzb zzbVar, final zzcdn zzcdnVar) {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzcU)).booleanValue()) {
            this.zzr.zzf(zzdyu.NATIVE_ASSETS_LOADING_IMAGE_COMPOSITION_START.zza(), com.google.android.gms.ads.internal.zzt.zzk().currentTimeMillis());
        }
    ...
    public final ListenableFuture zze(JSONObject jSONObject, final com.google.android.gms.ads.internal.zzb zzbVar, final zzcdn zzcdnVar) {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzcU)).booleanValue()) {
            this.zzr.zzf(zzdyu.NATIVE_ASSETS_LOADING_OMID_START.zza(), com.google.android.gms.ads.internal.zzt.zzk().currentTimeMillis());
        }
    ...
    public final ListenableFuture zzf(ListenableFuture listenableFuture) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzcU)).booleanValue()) {
            this.zzr.zzf(zzdyu.NATIVE_ASSETS_LOADING_MEDIA_START.zza(), com.google.android.gms.ads.internal.zzt.zzk().currentTimeMillis());
        }
    ...
    public final ListenableFuture zzg(JSONObject jSONObject, zzfkf zzfkfVar, zzfki zzfkiVar, com.google.android.gms.ads.internal.zzb zzbVar, zzcdn zzcdnVar) {
        ...
        if (z) {
            zzdtcVar = this;
            listenableFutureZza = zzdtcVar.zzp(jSONObjectOptJSONObject, zzfkfVar, zzfkiVar, zzbVar, zzcdnVar);
        } else {
            zzdtcVar = this;
            listenableFutureZza = zzdtcVar.zzi.zza(jSONObjectOptJSONObject, zzbVar, zzcdnVar);
        }
        return zzq(true != z ? "NativeAssetsLoader.loadVideoView" : "NativeAssetsLoader.loadVideoHtml", false, zzhbw.zzi(listenableFutureZza, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzeH)).intValue(), TimeUnit.SECONDS, zzdtcVar.zzk), null);
    }

    final /* synthetic */ ListenableFuture zzh(com.google.android.gms.ads.internal.client.zzr zzrVar, zzfkf zzfkfVar, zzfki zzfkiVar, com.google.android.gms.ads.internal.zzb zzbVar, zzcdn zzcdnVar, String str, String str2, Object obj) throws zzclj {
        zzeao zzeaoVar;
        ...
        zzckuVarZza.zzP().zzG(new zzcmq() { // from class: com.google.android.gms.internal.ads.zzdta
            ...
            public final /* synthetic */ void zza(boolean z, int i, String str3, String str4) {
                ...
                sb.append(str4);
                zzcfvVar.zzd(new zzeph(1, sb.toString()));
            }
        });
    ...
    final /* synthetic */ zzblm zzi(JSONObject jSONObject, List list) {
    ...
    final /* synthetic */ ListenableFuture zzj(String str, zzcdn zzcdnVar, com.google.android.gms.ads.internal.zzb zzbVar, Object obj) throws zzclj {
