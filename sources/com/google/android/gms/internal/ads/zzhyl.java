...
public final class zzhyl {
    ...
    static /* synthetic */ zzhnn zzb(zzhwm zzhwmVar) {
        ...
        zzhssVarZze.zzb(((zzhtq) zzhtpVarZze.zzbu()).zzaM());
        zzhssVarZze.zzc((zzhtm) zzj.zzb(zzhwmVar.zze()));
        return zzhnn.zza((zzhst) zzhssVarZze.zzbu());
    }

    static /* synthetic */ zzhwm zzc(zzhnn zzhnnVar) throws GeneralSecurityException {
    ...
    static /* synthetic */ zzhwq zze(zzhnm zzhnmVar, zzhel zzhelVar) throws GeneralSecurityException {
    ...
    static /* synthetic */ zzhnm zzf(zzhwo zzhwoVar, zzhel zzhelVar) {
        ...
        return zzhnm.zza("type.googleapis.com/google.crypto.tink.RsaSsaPkcs1PrivateKey", ((zzhtu) zzhttVarZzk.zzbu()).zzaM(), zzhsp.ASYMMETRIC_PRIVATE, (zzhtm) zzj.zzb(zzhwoVar.zzd().zze()), zzhwoVar.zze().zzb());
    }

    static /* synthetic */ zzhwo zzg(zzhnm zzhnmVar, zzhel zzhelVar) throws GeneralSecurityException {
    ...
    private static zzhts zzh(zzhwm zzhwmVar) throws GeneralSecurityException {
        zzhtr zzhtrVarZzb = zzhts.zzb();
        zzhtrVarZzb.zza((zzhsh) zzk.zzb(zzhwmVar.zzf()));
        return (zzhts) zzhtrVarZzb.zzbu();
    }

    private static zzhtw zzi(zzhwq zzhwqVar) throws GeneralSecurityException {
