...
public final class zzflc {
    ...
    public zzflc(zzbap zzbapVar) {
        this.zza = zzbapVar;
    }

    public final Uri zza(Uri uri, Context context, View view, Activity activity) throws zzbaq {
        try {
    ...
    private static final Uri zzb(Uri uri, String str) throws zzbaq {
        if (uri != null) {
            try {
                try {
