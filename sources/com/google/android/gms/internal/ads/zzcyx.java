...
public final class zzcyx {
    ...
    zzcyx(zzefs zzefsVar, zzfky zzfkyVar, zzfpk zzfpkVar, zzcrr zzcrrVar, zzepk zzepkVar, zzdig zzdigVar, zzfkq zzfkqVar, zzehd zzehdVar, zzdbw zzdbwVar, Executor executor, zzego zzegoVar, zzelx zzelxVar) {
        this.zza = zzefsVar;
        this.zzb = zzfkyVar;
        this.zzc = zzfpkVar;
        this.zzd = zzcrrVar;
    ...
    final /* synthetic */ zzfkq zzi(zzfkq zzfkqVar) throws Exception {
        this.zzd.zza(zzfkqVar);
        return zzfkqVar;
    }

    final /* synthetic */ ListenableFuture zzj(zzfmu zzfmuVar, zzcbd zzcbdVar) {
        zzcbdVar.zzi = zzfmuVar;
        return this.zzh.zza(zzcbdVar);
    }

    final /* synthetic */ zzdig zzk() {
        return this.zzf;
    }
}
