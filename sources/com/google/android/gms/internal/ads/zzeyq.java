...
public final class zzeyq implements zzimu {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (list.contains("24")) {
            zzfawVar = new zzfaw(zzewyVar, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznG)).intValue(), scheduledExecutorService);
        } else {
            zzfawVar = new zzfaw(zzfadVarZzc, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznG)).intValue(), scheduledExecutorService);
        }
        return zzfawVar;
    }
}
