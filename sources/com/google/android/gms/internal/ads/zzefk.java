...
public final class zzefk implements zzegq {
    ...
    zzefk(Context context, zzfky zzfkyVar, zzeel zzeelVar, zzhcg zzhcgVar, ScheduledExecutorService scheduledExecutorService, zzejd zzejdVar, zzfqg zzfqgVar) {
        this.zzg = context;
        this.zzc = zzfkyVar;
        this.zza = zzeelVar;
        this.zzb = zzhcgVar;
