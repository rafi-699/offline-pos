...
public final class zzeye implements zzimu {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (list.contains("54")) {
            zzfawVar = new zzfaw(zzewyVar, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznO)).intValue(), scheduledExecutorService);
        } else {
            zzfawVar = new zzfaw(zzeweVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznO)).intValue(), scheduledExecutorService);
        }
        return zzfawVar;
    }
}
