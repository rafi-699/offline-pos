...
public final class zzht {
    ...
    /* synthetic */ zzht(Uri uri, long j, int i, byte[] bArr, Map map, long j2, long j3, String str, int i2, Object obj, byte[] bArr2) {
    ...
    public final String toString() {
        ...
        int i = this.zzg;
        StringBuilder sb = new StringBuilder(ShareTarget.METHOD_GET.length() + 10 + length + 2 + length2 + 2 + length3 + 8 + String.valueOf(i).length() + 1);
