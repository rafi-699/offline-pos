...
public final class zzeyo implements zzimu {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (list.contains("60")) {
            zzfawVar = new zzfaw(zzewyVar, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzoo)).intValue(), scheduledExecutorService);
        } else {
            zzfawVar = new zzfaw(zzezvVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzoo)).intValue(), scheduledExecutorService);
        }
        return zzfawVar;
    }
}
