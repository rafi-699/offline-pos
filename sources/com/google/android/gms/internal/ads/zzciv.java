...
final class zzciv implements Runnable {
    ...
    zzciv(zzcja zzcjaVar, String str, String str2, long j, long j2, long j3, long j4, long j5, boolean z, int i, int i2) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = j;
        this.zzd = j2;
    ...
    public final void run() {
        ...
        map.put("cacheReady", true != this.zzh ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1");
