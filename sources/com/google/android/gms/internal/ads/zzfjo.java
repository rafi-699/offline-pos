    ...
    public final /* bridge */ /* synthetic */ void zzb(Object obj) {
        ...
        synchronized (zzfjsVar) {
            if (zzdvmVar != null) {
                ...
                zzdvmVar.zzq().zzd(zzfjsVar.zzg());
                this.zza.zzb(zzdvmVar);
                Executor executorZzf2 = zzfjsVar.zzf();
                final zzfjj zzfjjVarZzg2 = zzfjsVar.zzg();
                Objects.requireNonNull(zzfjjVarZzg2);
                executorZzf2.execute(new Runnable() { // from class: com.google.android.gms.internal.ads.zzfjm
                    @Override // java.lang.Runnable
                    public final /* synthetic */ void run() {
                        zzfjjVarZzg2.zzg();
                    }
                ...
                if (((Boolean) zzbkj.zzc.zze()).booleanValue()) {
                    zzfqj zzfqjVarZzi2 = zzfjsVar.zzi();
                    zzfpw zzfpwVar3 = this.zzc;
                    zzfpwVar3.zzg(zzdvmVar.zzr().zzb);
                    zzfpwVar3.zzi(zzdvmVar.zzn().zze());
                    zzfpwVar3.zzd(true);
                    zzfqjVarZzi2.zzb(zzfpwVar3.zzm());
                } else {
                    zzfqj zzfqjVarZzi3 = zzfjsVar.zzi();
                    zzfpw zzfpwVar4 = this.zzc;
                    zzfpwVar4.zzg(zzdvmVar.zzr().zzb);
                    zzfpwVar4.zzi(zzdvmVar.zzn().zze());
                    zzfpwVar4.zzd(true);
                    zzfqjVarZzi3.zzb(zzfpwVar4.zzm());
                }
            }
            throw th;
        }
