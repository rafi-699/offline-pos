...
public final class zzhlg {
    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzhlfVarZze = zzg(zzhlfVarZze, zzhlfVarZze2, a2, bigIntegerZzc);
                zzhlfVarZze2 = zzf(zzhlfVarZze2, a2, bigIntegerZzc);
            } else {
                zzhlfVarZze2 = zzg(zzhlfVarZze, zzhlfVarZze2, a2, bigIntegerZzc);
                zzhlfVarZze = zzf(zzhlfVarZze, a2, bigIntegerZzc);
            }
        }
        if (zzhlfVarZze.zza()) {
    ...
    static zzhlf zze(ECPoint eCPoint, BigInteger bigInteger) {
    ...
    static zzhlf zzf(zzhlf zzhlfVar, BigInteger bigInteger, BigInteger bigInteger2) {
    ...
    static zzhlf zzg(zzhlf zzhlfVar, zzhlf zzhlfVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzhlfVar.zza()) {
            return zzhlfVar2;
        }
        if (zzhlfVar2.zza()) {
