...
final class zzgoc implements zzgmw {
    ...
    zzgoc(zzgkz zzgkzVar, ExecutorService executorService, zzgqh zzgqhVar) {
        this.zza = zzgkzVar;
    ...
    final /* synthetic */ zzgfq zzf() {
        zzgfq zzgfqVarZzc = this.zza.zzc(1);
        return zzgfqVarZzc == null ? zzgfq.zzh() : zzgfqVarZzc;
    }

    final /* synthetic */ zzfyp zzg() {
        return this.zza.zzb(1);
    }

    final /* synthetic */ Void zzh(zzgfq zzgfqVar, byte[] bArr) {
        this.zza.zza(zzgfqVar, null, bArr);
        return null;
    }

    final /* synthetic */ Void zzi(zzgfq zzgfqVar, byte[] bArr, byte[] bArr2) {
