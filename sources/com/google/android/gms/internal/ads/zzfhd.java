...
public final class zzfhd implements zzfhw {
    ...
    final /* synthetic */ ListenableFuture zze(zzfhx zzfhxVar, zzfhc zzfhcVar, zzfhv zzfhvVar, zzdbz zzdbzVar, zzfhi zzfhiVar) {
        if (zzfhiVar != null) {
    ...
    final /* synthetic */ ListenableFuture zzf(zzfnf zzfnfVar) throws zzeed {
        zzfmw zzfmwVar;
        zzfnh zzfnhVar;
        ...
        zzbhv.zzb.zza.C0024zza c0024zzaZzs = zzbhv.zzb.zza.zzs();
        c0024zzaZzs.zzc(zzbhv.zzb.zzd.IN_MEMORY);
        c0024zzaZzs.zzg(zzbhv.zzb.zze.zzs());
        zzcVarZzs.zzh(c0024zzaZzs);
        zzfmwVar.zza.zza().zzd().zzl(zzcVarZzs.zzbu());
