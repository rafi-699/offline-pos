...
public final class zzhyn implements zzhek {
    ...
    public static zzhek zzd(zzhwq zzhwqVar) throws GeneralSecurityException {
    ...
    public static zzhek zze(zzhwq zzhwqVar, Provider provider) throws GeneralSecurityException {
