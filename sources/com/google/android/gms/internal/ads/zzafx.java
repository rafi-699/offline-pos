...
public final class zzafx {
    ...
    private static final int[] zzd = {64, 112, 128, 192, 224, 256, 384, Videoio.CAP_PROP_XI_WB_KR, 512, Imgcodecs.IMWRITE_JPEGXL_QUALITY, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    public static zzafw zzd(byte[] bArr) throws zzat {
        ...
        return new zzafw(MimeTypes.AUDIO_DTS_EXPRESS, iZzj4, i8, iZzj3, jZzv, 0, null);
    }
    ...
    public static zzafw zzf(byte[] bArr, AtomicInteger atomicInteger) throws zzat {
        ...
        return new zzafw(MimeTypes.AUDIO_DTS_X, 2, i5, i3 + iZzh2, j, 0, null);
    }
