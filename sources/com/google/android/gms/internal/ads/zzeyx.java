...
public final class zzeyx implements zzimu {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (list.contains("35")) {
            zzfawVar = new zzfaw(zzewyVar, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznB)).intValue(), scheduledExecutorService);
        } else {
            zzfawVar = new zzfaw(zzfbyVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznB)).intValue(), scheduledExecutorService);
        }
        return zzfawVar;
    }
}
