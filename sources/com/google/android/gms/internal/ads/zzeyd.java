...
public final class zzeyd implements zzimu {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (list.contains("10")) {
            zzfawVar = new zzfaw(zzewyVar, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznE)).intValue(), scheduledExecutorService);
        } else {
            zzfawVar = new zzfaw(zzevrVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznE)).intValue(), scheduledExecutorService);
        }
        return zzfawVar;
    }
}
