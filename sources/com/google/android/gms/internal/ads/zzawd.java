...
public final class zzawd {
    ...
    public final void zzb(zzawm zzawmVar) throws zzawc {
    ...
    public final zzawm zzc() throws zzawb {
        ...
        int i12 = i10 ^ i9;
        ArrayList arrayList = this.zza;
        zzawm zzawmVar = (zzawm) arrayList.get(i11 + i12);
        arrayList.set(this.zzb + i12, null);
        this.zzb += i12;
        return zzawmVar;
    }

    public final zzawm zzd(long j) throws zzawb {
        return (zzawm) this.zza.get(zza(j));
    }

    public final void zze(long j, zzawm zzawmVar) throws zzawb {
