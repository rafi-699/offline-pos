...
public final class zzip extends zzhh {
    ...
    public final int zza(byte[] bArr, int i, int i2) throws zzio {
        ...
        if (this.zzh == 0) {
            try {
                ...
                throw new zzio(e, PlaybackException.ERROR_CODE_IO_NETWORK_CONNECTION_TIMEOUT);
            } catch (IOException e2) {
                throw new zzio(e2, PlaybackException.ERROR_CODE_IO_NETWORK_CONNECTION_FAILED);
            }
        }
    ...
    public final long zzb(zzht zzhtVar) throws zzio {
        ...
        try {
            ...
            throw new zzio(e, PlaybackException.ERROR_CODE_IO_NETWORK_CONNECTION_FAILED);
        } catch (SecurityException e2) {
            throw new zzio(e2, PlaybackException.ERROR_CODE_IO_NO_PERMISSION);
        }
    }
