...
public final class zzcma extends com.google.android.gms.ads.internal.client.zzdz {
    ...
    public final void zzc(com.google.android.gms.ads.internal.client.zzfw zzfwVar) {
        ...
        zzw("initialState", CollectionUtils.mapOf("muteStart", true != z3 ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1", "customControlsRequested", true != z ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1", "clickToExpandRequested", true != z2 ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1"));
    }
        ...
        synchronized (this.zzb) {
            ...
            if (z3) {
                try {
                    ...
                    if (z4 && (zzedVar4 = this.zzf) != null) {
                        zzedVar4.zzf();
                    }
                    if (z7 && (zzedVar3 = this.zzf) != null) {
                        zzedVar3.zzg();
                    }
                    if (z8) {
                        zzedVar2 = this.zzf;
