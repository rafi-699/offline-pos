...
final class zzaka {
    ...
    private final long zzd(zzafz zzafzVar, int i) throws IOException {
        byte[] bArr = this.zza;
    ...
    public final boolean zzc(zzafz zzafzVar) throws IOException {
        int i;
        zzakh zzakhVar;
        long j;
        long j2;
        ...
        while (true) {
            ...
            switch (i) {
                ...
                case 2807729:
                    ...
                    StringBuilder sb4 = new StringBuilder(String.valueOf(j).length() + 22);
                ...
                case 2274716:
                    j2 = this.zzg;
                    if (j2 <= 2147483647L) {
                        StringBuilder sb5 = new StringBuilder(String.valueOf(j2).length() + 21);
                ...
                case 524531317:
                    ...
                    arrayDeque.push(new zzajz(i, this.zzg + jZzn2, null));
