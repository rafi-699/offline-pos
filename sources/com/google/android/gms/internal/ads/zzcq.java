...
final class zzcq implements zzcr {
    ...
    private final int zzs(float[] fArr, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            int i7 = 0;
            double dAbs = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
            while (i7 < i6) {
    ...
    public final void zzb(int i, long j, long j2) {
        ...
        while (true) {
            ...
            long j3 = jZzl2 - jZzm;
            long j4 = jZzl2 - jZzl;
            fArr[(iZzj * iZzg) + i2] = ((j3 * f) + ((j4 - j3) * f2)) / j4;
            i2++;
        }
    }
    ...
    public final boolean zzc() {
        double d = this.zzf;
        return d != ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE && this.zza.zzn() != 0 && this.zzg <= d * 3.0d && d + d > this.zzh * 3.0d;
    }
    ...
    public final void zzd(int i, int i2) {
        ...
        while (true) {
            ...
            while (true) {
                iZzg = zzctVar.zzg() * i2;
                if (i4 < iZzg) {
                    d += (double) this.zzc[(zzctVar.zzg() * i) + (iZzg * i3) + i4];
                    i4++;
                }
            }
    ...
    public final void zzg() {
        this.zzh = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        this.zzf = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        this.zzg = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    }
    ...
    public final void zzo(ByteBuffer byteBuffer, int i) {
        ...
        byteBuffer.position(byteBuffer.position() + (i * 4 * zzctVar.zzg()));
    }
