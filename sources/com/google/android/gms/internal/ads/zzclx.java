...
final class zzclx extends WebView implements DownloadListener, ViewTreeObserver.OnGlobalLayoutListener, zzcku {
    ...
    private final void zzbi(boolean z) {
        ...
        map.put("isVisible", true != z ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1");
    ...
    public final void onDownloadStart(String str, String str2, String str3, String str4, long j) {
        try {
            ...
            String.valueOf(str);
            zzcfdVarZzh.zzg(e, "AdWebViewImpl.onDownloadStart: ".concat(String.valueOf(str)));
        }
    }
    ...
    protected final synchronized void onMeasure(int i, int i2) {
        ...
        if (!isInEditMode() && !this.zzw && !this.zzs.zzh()) {
            ...
            float f5 = zzcneVar4.zzb;
            float f6 = this.zzj;
            int i11 = (int) (f5 / f6);
            int i12 = (int) (zzcneVar4.zza / f6);
    ...
    public final void zzG() {
        ...
        map.put(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, this.zzf.afmaVersion);
        zze("onhide", map);
    }
    ...
    public final boolean zzaA(final boolean z, final int i) {
        ...
        zzbhpVar.zzc(Videoio.CAP_PROP_GIGA_FRAME_WIDTH_MAX);
        return true;
    }
    ...
    */
    ...
    public final synchronized void zzag(boolean z) {
        ...
        zzbc();
        if (z != z2) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzaD)).booleanValue() || !this.zzs.zzg()) {
                new zzbyg(this, "").zzk(true != z ? Constants.COLLATION_DEFAULT : "expanded");
            }
        }
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    strArr[0] = str4;
                    super.loadDataWithBaseURL(str, zzcml.zza(str2, strArr), "text/html", Key.STRING_CHARSET_NAME, null);
                    return;
                } catch (Throwable th2) {
                    th = th2;
                }
    ...
    public final void zzu(boolean z, long j) {
        HashMap map = new HashMap(2);
        map.put("success", true != z ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1");
