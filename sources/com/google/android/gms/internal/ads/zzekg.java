...
public final class zzekg extends zzfzn {
    ...
    final void zza(zzfok zzfokVar) {
        ...
        zzhbw.zzr(zzhcgVar.submit(callable), new zzejz(this, zzfokVar), zzhcgVar);
    }
    ...
    final /* synthetic */ Void zzh(zzeki zzekiVar, SQLiteDatabase sQLiteDatabase) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP, Long.valueOf(zzekiVar.zza));
