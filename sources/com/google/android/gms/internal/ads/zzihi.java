...
interface zzihi {
    ...
    void zzM(int i, zzifh zzifhVar, Map map) throws IOException;
    ...
    void zzn(int i, zzida zzidaVar) throws IOException;
    ...
    void zzr(int i, Object obj, zzigh zzighVar) throws IOException;

    @Deprecated
    void zzs(int i, Object obj, zzigh zzighVar) throws IOException;
