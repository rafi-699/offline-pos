...
public final class zzavv {
    ...
    public final void zza(long j) throws zzavu, zzavt {
    ...
    public final long zzc() throws zzavu {
        try {
            ...
            int i = this.zza;
            this.zza = i + 1;
            return zzaveVar.zza(zzavqVar, i);
        } catch (IndexOutOfBoundsException e) {
            throw new zzavu(e);
        }
    }

    public final int zzd() throws zzavu {
        ...
        try {
            ...
            int i13 = this.zza;
            this.zza = i13 + 1;
            return iZza3 | (zzaveVar4.zza(zzavqVar4, i13) << (i7 ^ i8));
        } catch (IndexOutOfBoundsException e) {
            throw new zzavu(e);
        }
    }

    public final long zze() throws zzavu, zzavs {
        return zzg();
    }
    ...
    public final zzavq zzf(long j) throws zzavu, zzavt {
        ...
        try {
            int i11 = (int) j3;
            zzavq zzavqVarZzb = this.zzc.zzb(zzavqVar, i10, i11);
            this.zza = i11;
            return zzavqVarZzb;
        } catch (IndexOutOfBoundsException e) {
