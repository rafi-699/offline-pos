...
public final class zzaay extends zzabe implements zznb {
    ...
    private static final Pair zzB(int i, zzabd zzabdVar, int[][][] iArr, zzaap zzaapVar, Comparator comparator) {
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            if (i == zzabdVar.zza(i2)) {
                zzzn zzznVarZzb = zzabdVar.zzb(i2);
    ...
    protected static final zzaaz zzp(int i, zzzn zzznVar, int[][] iArr, zzaam zzaamVar) throws zzjk {
    ...
    private static void zzw(zzabd zzabdVar, zzbl zzblVar, zzaaz[] zzaazVarArr) {
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            if (((zzbh) map.get(Integer.valueOf(zzabdVar.zza(i2)))) != null) {
                throw null;
            }
        }
    }
    ...
    private static void zzx(zzzn zzznVar, zzbl zzblVar, Map map) {
        for (int i = 0; i < zzznVar.zzb; i++) {
            if (((zzbh) zzblVar.zzH.get(zzznVar.zza(i))) != null) {
                throw null;
            }
        }
    }
    ...
    private static void zzy(zzabd zzabdVar, zzaam zzaamVar, zzaaz[] zzaazVarArr) {
        for (int i = 0; i < 2; i++) {
            ...
            if (zzaamVar.zzb(i, zzznVarZzb)) {
                if (zzaamVar.zzc(i, zzznVarZzb) != null) {
                    throw null;
                }
                zzaazVarArr[i] = null;
            }
    ...
    protected final Pair zzh(zzabd zzabdVar, int[][][] iArr, final int[] iArr2, zzxk zzxkVar, zzbf zzbfVar) throws zzjk {
        ...
        final String str = pairZzA == null ? null : ((zzaaz) pairZzA.first).zza.zza(((zzaaz) pairZzA.first).zzb[0]).zzd;
                ...
                public final /* synthetic */ List zza(int i6, zzbg zzbgVar, int[] iArr4) {
                    ...
                    while (i24 < zzbgVar2.zza) {
                        ...
                        if (i8 != Integer.MAX_VALUE) {
                            ...
                            zzgwjVar.zzf(new zzaax(i6, zzbgVar2, i24, zzaamVar2, iArr4[i24], str, i14, z3));
                            i24++;
                            zzbgVar2 = zzbgVar;
                            i7 = i9;
                        } else {
        ...
        while (i17 < 2) {
            ...
            if (zzaazVar2 == null || (length = (iArr3 = zzaazVar2.zzb).length) == 0) {
                ...
                if (length == 1) {
                    zzabaVarZza = new zzabb(zzaazVar2.zza, iArr3[i10], 0, 0, null);
                    zzztVar = zzztVar2;
                } else {
                    zzztVar = zzztVar2;
                    zzabaVarZza = zzztVar.zza(zzaazVar2.zza, iArr3, 0, zzabqVarZzu, (zzgwm) zzgwmVarZzd.get(i17));
                }
