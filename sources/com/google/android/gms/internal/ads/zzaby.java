...
final class zzaby extends Handler implements Runnable {
    ...
    public final void handleMessage(Message message) {
        ...
        int i2 = this.zzf + 1;
        this.zzf = i2;
        zzabx zzabxVarZzz = zzabvVar.zzz(this.zzb, jElapsedRealtime, j2, iOException, i2);
    ...
    public final void run() {
        ...
        try {
            ...
            zzeg.zzf("LoadTask", "OutOfMemory error loading stream", e2);
            obtainMessage(3, new zzacc(e2)).sendToTarget();
        } catch (Error e3) {
            if (!this.zzi) {
                zzeg.zzf("LoadTask", "Unexpected error loading stream", e3);
            ...
            zzeg.zzf("LoadTask", "Unexpected exception loading stream", e4);
            obtainMessage(3, new zzacc(e4)).sendToTarget();
        }
    }
