...
public final class zzhyu {
    ...
    static /* synthetic */ zzhnn zzb(zzhwy zzhwyVar) {
        ...
        zzhssVarZze.zzb(((zzhty) zzhtxVarZze.zzbu()).zzaM());
        zzhssVarZze.zzc((zzhtm) zzj.zzb(zzhwyVar.zze()));
        return zzhnn.zza((zzhst) zzhssVarZze.zzbu());
    }

    static /* synthetic */ zzhwy zzc(zzhnn zzhnnVar) throws GeneralSecurityException {
    ...
    static /* synthetic */ zzhxc zze(zzhnm zzhnmVar, zzhel zzhelVar) throws GeneralSecurityException {
    ...
    static /* synthetic */ zzhnm zzf(zzhxa zzhxaVar, zzhel zzhelVar) {
        ...
        return zzhnm.zza("type.googleapis.com/google.crypto.tink.RsaSsaPssPrivateKey", ((zzhuc) zzhubVarZzk.zzbu()).zzaM(), zzhsp.ASYMMETRIC_PRIVATE, (zzhtm) zzj.zzb(zzhxaVar.zzd().zze()), zzhxaVar.zze().zzb());
    }

    static /* synthetic */ zzhxa zzg(zzhnm zzhnmVar, zzhel zzhelVar) throws GeneralSecurityException {
    ...
    private static zzhua zzh(zzhwy zzhwyVar) throws GeneralSecurityException {
        ...
        return (zzhua) zzhtzVarZzd.zzbu();
    }

    private static zzhue zzi(zzhxc zzhxcVar) throws GeneralSecurityException {
