...
final class zzbtc implements Runnable {
    ...
    zzbtc(zzbtu zzbtuVar, zzbtt zzbttVar, zzbsp zzbspVar, ArrayList arrayList, long j) {
        this.zza = zzbttVar;
        this.zzb = zzbspVar;
        this.zzc = arrayList;
        this.zzd = j;
        ...
        synchronized (zzbtuVar.zzg()) {
            ...
            if (zzbttVar.zzi() != -1 && zzbttVar.zzi() != 1) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    StringBuilder sb = new StringBuilder(String.valueOf(strValueOf2).length() + 88);
                ...
                StringBuilder sb2 = new StringBuilder(String.valueOf(strValueOf).length() + 107 + String.valueOf(iZzi).length() + 36 + String.valueOf(iZzk).length() + string.length() + 39 + String.valueOf(jCurrentTimeMillis).length() + 26);
