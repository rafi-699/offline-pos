...
final class zzany {
        ...
        while (i3 < i2) {
            ...
            if (iZzs != 0) {
                ...
                if (iZzs2 != 0) {
                    ...
                    i = iZzs3 + i3;
                    Arrays.fill(iArr, i3, i, (iZzs2 & 128) == 0 ? this.zzb[0] : this.zzb[zzetVar.zzs()]);
                }
            }
            i3 = i;
        }
    ...
    final /* synthetic */ void zzc(zzet zzetVar, int i) {
        if (i % 5 != 2) {
            return;
        }
        zzetVar.zzk(2);
    ...
    final /* synthetic */ void zzd(zzet zzetVar, int i) {
        int iZzx;
        if (i < 4) {
            return;
        }
    ...
    final /* synthetic */ void zze(zzet zzetVar, int i) {
        if (i < 19) {
            return;
        }
