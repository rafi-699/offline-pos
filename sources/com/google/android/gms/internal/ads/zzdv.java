...
public final class zzdv implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdv(Handler handler, zzdu zzduVar) {
        this.zzb = handler;
    }
    ...
    public final void zza(int i) throws zzdw {
        EGLSurface eGLSurfaceEglCreatePbufferSurface;
        EGLDisplay eGLDisplayEglGetDisplay = EGL14.eglGetDisplay(0);
        zzdx.zze(eGLDisplayEglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdx.zze(EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        String str = zzfl.zza;
        zzdx.zze(z, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        ...
        zzdx.zze(eGLContextEglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdx.zze(eGLSurfaceEglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdx.zze(EGL14.eglMakeCurrent(eGLDisplay, eGLSurfaceEglCreatePbufferSurface, eGLSurfaceEglCreatePbufferSurface, eGLContextEglCreateContext), "eglMakeCurrent failed");
        ...
        while (true) {
            ...
            zzgwjVar.zzf(Integer.valueOf(iGlGetError));
            z2 = true;
        }
        if (z2) {
            throw new zzdw(sb.toString(), zzgwjVar.zzi());
        }
