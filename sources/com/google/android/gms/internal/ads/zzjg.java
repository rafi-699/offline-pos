...
public final class zzjg implements zzly {
    public static final zzgwm zza = zzgwm.zzn("file", "content", "data", UriUtil.QUALIFIED_RESOURCE_SCHEME, RawResourceDataSource.RAW_RESOURCE_SCHEME, UriUtil.LOCAL_ASSET_SCHEME);
    ...
    public zzjg() {
        zzabr zzabrVar = new zzabr(true, 65536);
        ...
        this.zzk = zzfl.zzs(ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                    ...
                    if (zzabaVar != null) {
                        switch (zzabaVar.zza().zzc) {
                            ...
                            case 0:
                                ...
                                break;
                            case 2:
                                i3 = !zZzp ? DefaultLoadControl.DEFAULT_VIDEO_BUFFER_SIZE : 19660800;
                                break;
                            case 3:
                            case 5:
                            default:
