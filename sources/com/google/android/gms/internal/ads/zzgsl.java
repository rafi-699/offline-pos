            ...
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                try {
                    ...
                    if (signatureArr == null || (signatureArr.length) == 0) {
                        ...
                        zza.zzb(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", UByte$$ExternalSyntheticBackport0.m((CharSequence) ", ", (Iterable) arrayList)), new Object[0]);
                    }
