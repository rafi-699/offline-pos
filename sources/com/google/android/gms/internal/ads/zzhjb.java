...
public final class zzhjb implements zzhdi {
    ...
    private zzhjb(byte[] bArr, byte[] bArr2, zzhja zzhjaVar) throws GeneralSecurityException {
        this.zzh = bArr2;
    ...
    public static zzhdi zzc(zzhfz zzhfzVar, zzhja zzhjaVar) throws GeneralSecurityException {
