...
public final class zzcff {
    ...
    public final zzcfe zzi(Set set, String str) {
        synchronized (this.zzk) {
            ...
            String strM = UByte$$ExternalSyntheticBackport0.m((CharSequence) ",", (Iterable) new TreeSet(set));
            Map map = this.zzn;
            Integer num = (Integer) map.get(strM);
            int iIntValue = 0;
            int iIntValue2 = num == null ? 0 : num.intValue();
            map.put(strM, Integer.valueOf(iIntValue2 + 1));
            if (str == null) {
                return new zzcfe(i, iIntValue2, -1);
            }
            StringBuilder sb = new StringBuilder(str.length() + 1 + String.valueOf(strM).length());
            sb.append(str);
            sb.append("|");
            sb.append(strM);
