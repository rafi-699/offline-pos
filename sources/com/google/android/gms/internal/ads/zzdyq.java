...
public final class zzdyq implements zzdht, com.google.android.gms.ads.internal.client.zza, zzddl, zzdcv, zzdfm {
    ...
    private final zzdzk zzg(String str) {
        ...
        zzdzkVarZza.zzc(FirebaseAnalytics.Param.AD_FORMAT, this.zzi.toUpperCase(Locale.ROOT));
        List list = zzfkfVar.zzt;
        if (!list.isEmpty()) {
            zzdzkVarZza.zzc("ancn", (String) list.get(0));
        }
        if (zzfkfVar.zzb()) {
            zzdzkVarZza.zzc("device_connectivity", true != com.google.android.gms.ads.internal.zzt.zzh().zzs(this.zzc) ? "offline" : CustomTabsCallback.ONLINE_EXTRAS_KEY);
    ...
    public final void zzd(zzdnn zzdnnVar) {
        if (this.zzl) {
            ...
            if (!TextUtils.isEmpty(zzdnnVar.getMessage())) {
                zzdzkVarZzg.zzc("msg", zzdnnVar.getMessage());
            }
            zzdzkVarZzg.zzd();
        }
    }
    ...
    public final void zzdH() {
        if (zzf()) {
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzpa)).booleanValue() && zzj()) {
                com.google.android.gms.ads.internal.zzt.zzc();
                zzdzkVarZzg.zzc(DownloadService.KEY_FOREGROUND, true != com.google.android.gms.ads.internal.util.zzs.zzJ(this.zzc) ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
                zzdzkVarZzg.zzc("fg_show", true != this.zza.get() ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1");
            }
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzpb)).booleanValue() && zzj()) {
                zzdzkVarZzg.zzc("fg_al", true != com.google.android.gms.ads.internal.zzt.zzg().zzf() ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1");
            }
            zzdzkVarZzg.zzd();
        }
    }
    ...
    public final void zzk() {
        if (zzf()) {
            ...
            if (zBooleanValue && zzj()) {
                ...
                zzdzkVarZzg.zzc(DownloadService.KEY_FOREGROUND, true != atomicBoolean.get() ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1");
            }
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzpb)).booleanValue() && zzj()) {
