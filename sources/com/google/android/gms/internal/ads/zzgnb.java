...
final class zzgnb implements zzgmw {
    ...
    zzgnb(zzget zzgetVar, zzget zzgetVar2, zzimo zzimoVar, zzget zzgetVar3, zzget zzgetVar4, zzimo zzimoVar2, File file, ExecutorService executorService, zzgqh zzgqhVar) {
        this.zza = zzgetVar;
        this.zzc = zzgetVar2;
        this.zze = zzimoVar;
        this.zzb = zzgetVar3;
    ...
    final /* synthetic */ zzfyp zzg(zzgfq zzgfqVar) {
    ...
    final /* synthetic */ ListenableFuture zzh(zzgfq zzgfqVar, Void r2) {
        return zzk(zzgfqVar);
    }

    final /* synthetic */ ListenableFuture zzi(zzgfq zzgfqVar, List list) {
        return zzk(zzgfqVar);
    }
}
