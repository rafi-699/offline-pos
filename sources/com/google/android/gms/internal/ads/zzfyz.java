...
public final class zzfyz {
    ...
    private final synchronized Class zzd(zzfyp zzfypVar) throws zzfyy {
        ...
        try {
            try {
                ...
                if (iZzh != 0) {
                    ...
                    sb.append("ci: ");
                    sb.append(iZzh);
                    throw new zzfyy(PlaybackException.ERROR_CODE_DECODER_INIT_FAILED, sb.toString());
                }
                ...
                throw new zzfyy(PlaybackException.ERROR_CODE_IO_BAD_HTTP_STATUS, e2);
            }
        } catch (zzfyy e3) {
