...
public final class zztx extends zzvt implements zzmb {
    ...
    private static List zzbm(zzvv zzvvVar, zzv zzvVar, boolean z, zzse zzseVar) throws zzvx {
        zzvm zzvmVarZza;
        if (zzvVar.zzp == null) {
            return zzgwm.zzi();
        }
    ...
    protected final zzvg zzah(zzvm zzvmVar, zzv zzvVar, MediaCrypto mediaCrypto, float f) {
        ...
        if (MimeTypes.AUDIO_AC4.equals(str3)) {
            ...
            if (pairZze != null) {
                ...
                zzej.zzb(mediaFormat, FirebaseAnalytics.Param.LEVEL, ((Integer) pairZze.second).intValue());
            }
    ...
    protected final long zzaj(long j, long j2, boolean z) {
        ...
        if (this.zzo && z2 && jZzx != C.TIME_UNSET) {
    ...
    protected final void zzau() throws zzjk {
        try {
            ...
            throw zzP(e, e.zzc, e.zzb, true != zzaH() ? PlaybackException.ERROR_CODE_AUDIO_TRACK_WRITE_FAILED : PlaybackException.ERROR_CODE_AUDIO_TRACK_OFFLOAD_WRITE_FAILED);
        }
    }
    ...
    protected final boolean zzas(long j, long j2, zzvj zzvjVar, ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, zzv zzvVar) throws zzjk {
        ...
        try {
            ...
            throw zzP(e, zzvVar2, false, PlaybackException.ERROR_CODE_AUDIO_TRACK_INIT_FAILED);
        } catch (zzsd e2) {
            if (zzaH()) {
                zzK();
            }
            throw zzP(e2, zzvVar, e2.zzb, PlaybackException.ERROR_CODE_AUDIO_TRACK_WRITE_FAILED);
        }
    }
    ...
    protected final void zzap(zzv zzvVar, MediaFormat mediaFormat) throws zzjk {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 29) {
                ...
                zzgtj.zzi(Build.VERSION.SDK_INT >= 29);
            }
            zzse zzseVar = this.zzd;
            ...
            throw zzP(e, e.zza, false, PlaybackException.ERROR_CODE_AUDIO_TRACK_INIT_FAILED);
        }
    }
}
