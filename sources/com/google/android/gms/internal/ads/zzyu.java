...
public final class zzyu extends zzwj implements zzyi {
    ...
    /* synthetic */ zzyu(zzak zzakVar, zzho zzhoVar, zzyc zzycVar, zzun zzunVar, zzabu zzabuVar, int i, boolean z, int i2, zzv zzvVar, zzgub zzgubVar, byte[] bArr) {
        this.zzk = zzakVar;
        this.zza = zzhoVar;
        this.zzb = zzycVar;
        this.zzc = zzunVar;
    ...
    private final void zzu() {
        ...
        boolean z2 = this.zzh;
        zzak zzakVarZzJ = zzJ();
        zzbf zzzgVar = new zzzg(C.TIME_UNSET, C.TIME_UNSET, C.TIME_UNSET, j, j, 0L, 0L, z, false, false, null, zzakVarZzJ, z2 ? zzakVarZzJ.zzc : null);
        if (this.zze) {
