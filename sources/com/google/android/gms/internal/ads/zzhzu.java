...
public final class zzhzu implements zzhdi {
    ...
    public static zzhdi zzb(zzhey zzheyVar) throws GeneralSecurityException {
        ...
        return new zzhzu(zzhzeVar, new zziap(new zziao("HMAC".concat(strValueOf2), new SecretKeySpec(zzheyVar.zzf().zzc(zzhdo.zza()), "HMAC")), zzheyVar.zzg().zze()), zzheyVar.zzg().zze(), zzheyVar.zzc().zzc());
    }
