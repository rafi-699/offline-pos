...
public final class zzdtu {
    ...
    final /* synthetic */ void zzf(zzcku zzckuVar, zzcfv zzcfvVar, boolean z, int i, String str, String str2) {
        if (z) {
            com.google.android.gms.ads.internal.client.zzfw zzfwVar = this.zza.zza;
            if (zzfwVar != null && zzckuVar.zzh() != null) {
                zzckuVar.zzh().zzc(zzfwVar);
    ...
    final /* synthetic */ void zzg(zzcku zzckuVar, zzcfv zzcfvVar, boolean z, int i, String str, String str2) {
