...
public final class zzzu extends zzzw {
    protected zzzu(zzbg zzbgVar, int[] iArr, int i, zzabq zzabqVar, long j, long j2, long j3, int i2, int i3, float f, float f2, List list, zzdo zzdoVar) {
        ...
        while (i9 < 2) {
            ...
            if (length <= i) {
                ...
                while (true) {
                    ...
                    double dLog = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
                    if (i10 >= length2) {
                        break;
                    }
                    int i11 = i3;
                ...
                while (i13 < i12) {
                    double d2 = dArr[i13];
                    i13++;
                    zzgxhVarZza.zze(Double.valueOf(d == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? 1.0d : (((d2 + dArr[i13]) * 0.5d) - dArr[i2]) / d), Integer.valueOf(i9));
                    i = i;
                }
            }
            i9++;
