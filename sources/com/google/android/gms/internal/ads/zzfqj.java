...
public final class zzfqj implements Runnable {
            ...
            synchronized (obj) {
                ...
                try {
                    synchronized (obj) {
                        ...
                        bArrZzaN = ((zzfqq) zzfqnVar.zzbu()).zzaN();
                        zzfqnVar.zzc();
                    }
                    zzeik zzeikVar = new zzeik((String) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzjY), 60000, new HashMap(), bArrZzaN, "application/x-protobuf", false);
                    new zzeim(this.zze, this.zzf.afmaVersion, this.zzn, Binder.getCallingUid(), null).zza(zzeikVar);
                } catch (Exception e) {
    ...
    public final void zzb(final zzfpz zzfpzVar) {
        zzcfr.zza.submit(new Runnable() { // from class: com.google.android.gms.internal.ads.zzfqi
            @Override // java.lang.Runnable
    ...
    final /* synthetic */ void zzc(zzfpz zzfpzVar) {
        synchronized (zzd) {
            if (!this.zzm) {
                this.zzm = true;
                if (zza()) {
