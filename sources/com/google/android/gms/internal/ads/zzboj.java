...
public final class zzboj implements zzbpq {
    ...
    public final /* bridge */ /* synthetic */ void zza(Object obj, Map map) {
        ...
        if ("tick".equals(str)) {
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzcL)).booleanValue() && !zza.matcher(str2).matches()) {
            ...
            try {
                ...
                if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzcL)).booleanValue() || zza.matcher(str3).matches()) {
