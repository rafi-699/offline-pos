...
public final class zzhuw extends zzhxj {
    private final zzhuy zza;
    private final zziba zzb;

    /* synthetic */ zzhuw(zzhuy zzhuyVar, zziba zzibaVar, byte[] bArr) {
        this.zza = zzhuyVar;
        this.zzb = zzibaVar;
    }

    public static zzhuv zzc() {
        return new zzhuv(null);
    }
    ...
    public final zzhuu zzd() {
        return this.zza.zzf();
    }

    public final zzhuy zze() {
        return this.zza;
    }
