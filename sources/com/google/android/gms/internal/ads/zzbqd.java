...
public final class zzbqd implements zzbpq {
    ...
    public final void zzf(String str, com.google.android.gms.ads.internal.client.zza zzaVar, Map map, String str2) {
        ...
        boolean z2 = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzok)).booleanValue() && map.containsKey("ig_cl") && ((String) map.get("ig_cl")).equals("true");
        ...
        if ("webapp".equalsIgnoreCase(str2)) {
            zzl(false);
            boolean z3 = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzns)).booleanValue() && Objects.equals(map.get("is_allowed_for_lock_screen"), "1");
            if (str != null) {
        ...
        if ("chrome_custom_tab".equalsIgnoreCase(str2)) {
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzfG)).booleanValue()) {
                ...
                if (zZza) {
                    ...
                    zzcmkVar.zzaH(new com.google.android.gms.ads.internal.overlay.zzc(null, string, null, null, null, null, null, null, ObjectWrapper.wrap(zzaaVar).asBinder(), true, bundle), z, z4, str4);
                    return;
                }
                zzg(4);
            }
        ...
        if ("open_app".equalsIgnoreCase(str2)) {
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzjy)).booleanValue()) {
                ...
                if (z6 && this.zze != null && zzi(zzaVar2, zzckuVar.getContext(), str6, str5)) {
                    return;
                }
                ...
                if (packageManager == null) {
                    ...
                    if (launchIntentForPackage != null) {
                        ((zzcmk) zzaVar2).zzaH(new com.google.android.gms.ads.internal.overlay.zzc(launchIntentForPackage, this.zzh), z, z5, str5);
                        return;
                    }
                    return;
                }
        ...
        boolean z7 = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzjU)).booleanValue() && "intent_async".equalsIgnoreCase(str2) && map2.containsKey("event_id");
        ...
        if (z7) {
            boolean z8 = z;
            obj = "event_id";
            zzbqb zzbqbVar = new zzbqb(this, z8, zzaVar2, map3, map2);
            zzaVar2 = zzaVar2;
            map2 = map2;
            this.zzh = zzbqbVar;
        } else {
        ...
        if (uri != null) {
            if (!z6 || this.zze == null || !zzi(zzaVar2, zzckuVar.getContext(), uri.getData().toString(), str5)) {
                ((zzcmk) zzaVar2).zzaH(new com.google.android.gms.ads.internal.overlay.zzc(uri, this.zzh), zZza, z5, str5);
                return;
            } else {
                if (z7) {
        ...
        if (!z6 || this.zze == null || !zzi(zzaVar2, zzckuVar.getContext(), string2, str5)) {
            ((zzcmk) zzaVar2).zzaH(new com.google.android.gms.ads.internal.overlay.zzc((String) map2.get("i"), string2, (String) map2.get("m"), (String) map2.get("p"), (String) map2.get("c"), (String) map2.get("f"), (String) map2.get("e"), this.zzh), zZza, z5, str5);
        } else if (z7) {
            map3.put((String) map2.get(obj), true);
            ((zzbsm) zzaVar2).zze("openIntentAsync", map3);
        }
