...
public final class zzfry {
    ...
    public final List zzb(zzfkq zzfkqVar, zzfkf zzfkfVar, boolean z, String str, String str2, List list, zzdbn zzdbnVar, zzcfe zzcfeVar) {
        ...
        while (it.hasNext()) {
            ...
            boolean z2 = true;
            String strZzd = zzd(zzd(zzd((String) it.next(), "@gw_adlocid@", zzfkqVar.zza.zza.zzg), "@gw_adnetrefresh@", true != z ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1"), "@gw_sdkver@", this.zzb);
            if (zzfkfVar != null) {
