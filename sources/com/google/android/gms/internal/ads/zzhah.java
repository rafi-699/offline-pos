...
public final class zzhah extends zzhai {
    ...
    public static int zzc(int i, int i2, int i3) {
        zzgtj.zzg(true, "min (%s) must be less than or equal to max (%s)", i2, LockFreeTaskQueueCore.MAX_CAPACITY_MASK);
    ...
    public static List zzg(int... iArr) {
        ...
        return length == 0 ? Collections.emptyList() : new zzhag(iArr, 0, length);
    }
            ...
            if (i2 != str.length()) {
                ...
                if (iZza >= 0 && iZza < 10) {
                    ...
                    while (true) {
                        ...
                        if (iZza2 >= 0 && iZza2 < 10 && j >= Buffer.OVERFLOW_ZONE) {
                            long j2 = j * 10;
                            long j3 = iZza2;
