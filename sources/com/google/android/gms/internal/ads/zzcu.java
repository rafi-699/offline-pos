...
public final class zzcu implements zzco {
    ...
    public final long zza(long j) {
        ...
        int i = this.zzh.zzb;
        int i2 = this.zzg.zzb;
        return i == i2 ? zzfl.zzv(j, this.zzn, jZza, RoundingMode.DOWN) : zzfl.zzv(j, this.zzn * ((long) i2), jZza * ((long) i), RoundingMode.DOWN);
    }
    ...
    public final long zzm(long j) {
        ...
        int i = this.zzh.zzb;
        int i2 = this.zzg.zzb;
        return i == i2 ? zzfl.zzv(j, jZza, this.zzn, RoundingMode.DOWN) : zzfl.zzv(j, jZza * ((long) i), this.zzn * ((long) i2), RoundingMode.DOWN);
    }
}
