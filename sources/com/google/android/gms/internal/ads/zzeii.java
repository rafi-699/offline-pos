...
public final class zzeii extends zzcap {
    ...
    public final ListenableFuture zzd(String str) {
        ...
        zzehs zzehsVar = new zzehs(this);
        if (zzr(str) != null) {
            return zzhbw.zza(zzehsVar);
        }
        String.valueOf(str);
        return zzhbw.zzc(new Exception("URL to be removed not found for cache key: ".concat(String.valueOf(str))));
    }
    ...
    public final void zzi(String str) throws RemoteException {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzpA)).booleanValue()) {
            ...
            for (String str3 : iterableZzd) {
                ...
                zzeik zzeikVar = new zzeik(str3, HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT, map, new byte[0], "", false);
                try {
                    zzeil zzeilVarZzb = zzeimVar.zza(zzeikVar);
                    zzeil zzeilVar = zzeilVarZzb;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    final /* synthetic */ InputStream zzl(ListenableFuture listenableFuture, ListenableFuture listenableFuture2, zzcbd zzcbdVar, zzfpw zzfpwVar) {
