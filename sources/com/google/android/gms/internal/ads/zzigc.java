...
interface zzigc {
    ...
    void zzG(List list, zzigh zzighVar, zzido zzidoVar) throws IOException;

    @Deprecated
    void zzH(List list, zzigh zzighVar, zzido zzidoVar) throws IOException;
    ...
    void zzP(Map map, zzifh zzifhVar, zzido zzidoVar) throws IOException;
    ...
    void zzo(Object obj, zzigh zzighVar, zzido zzidoVar) throws IOException;

    void zzp(Object obj, zzigh zzighVar, zzido zzidoVar) throws IOException;

    zzida zzq() throws IOException;
