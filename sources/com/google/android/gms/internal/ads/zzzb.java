        ...
        if (this.zzB) {
            ...
            if ((i & 1) == 0) {
                if (!this.zzC) {
                    ...
                    zzeg.zzc("SampleQueue", "Overriding unexpected non-sync sample for format: ".concat(String.valueOf(strValueOf)));
                    this.zzC = true;
                }
                i |= 1;
            }
        }
        zzH(j, i, (this.zza.zzf() - ((long) i2)) - ((long) i3), i2, zzahjVar);
    }
            ...
            try {
                ...
                if (zzI() && j >= this.zzn[iZzN]) {
                    ...
                    if (this.zzB) {
                        ...
                        zzzbVar = this;
                        j2 = j;
                        iZzL = zzzbVar.zzL(iZzN, this.zzp - i, j2, true);
                    }
                    if (iZzL != -1) {
                        zzzbVar.zzt = j2;
                        zzzbVar.zzs += iZzL;
