...
public final class zzctj {
    ...
    zzctj(Context context, com.google.android.gms.ads.internal.util.zzg zzgVar, zzelo zzeloVar, zzdwn zzdwnVar, zzhcg zzhcgVar, zzhcg zzhcgVar2, ScheduledExecutorService scheduledExecutorService) {
        this.zzc = context;
        this.zzd = zzgVar;
        this.zze = zzeloVar;
        this.zzf = zzdwnVar;
    ...
    final /* synthetic */ ListenableFuture zzd(String str, final Throwable th) {
        this.zzg.submit(new Runnable() { // from class: com.google.android.gms.internal.ads.zzcth
    ...
    final /* synthetic */ ListenableFuture zze(final Uri.Builder builder, String str, InputEvent inputEvent, Integer num) {
        ...
        builderBuildUpon.appendQueryParameter((String) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzlG), "1");
    ...
    final /* synthetic */ ListenableFuture zzf(Uri.Builder builder, final Throwable th) {
        this.zzg.submit(new Runnable() { // from class: com.google.android.gms.internal.ads.zzctg
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
                this.zza.zzg(th);
            }
    ...
    final /* synthetic */ void zzg(Throwable th) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzlK)).booleanValue()) {
            zzcaa zzcaaVarZzc = zzbzy.zzc(this.zzc);
            this.zzb = zzcaaVarZzc;
            zzcaaVarZzc.zzh(th, "AttributionReporting");
        } else {
            zzcaa zzcaaVarZza = zzbzy.zza(this.zzc);
