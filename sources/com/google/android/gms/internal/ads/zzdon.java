...
public final class zzdon implements zzdqb {
    ...
    private final boolean zzK(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z, View view) {
        ...
        try {
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzjS)).booleanValue()) {
                this.zzd.zzd("/clickRecorded", new zzdok(this, null));
            } else {
                this.zzd.zzd("/logScionEvent", new zzdoj(this, null));
            }
            zzdux zzduxVar = this.zzd;
            zzduxVar.zzd("/nativeImpression", new zzdol(this, view, null));
            try {
                zzduxVar.zzd("/nativeImpressionFlowControl", new zzdom(this, this.zzq, this.zzj.zzax, this.zzs, null));
                zzcfu.zza(zzduxVar.zzc("google.afma.nativeAds.handleImpression", jSONObject6), "Error during performing handleImpression", zzcfr.zzh);
                if (this.zzu) {
                    return true;
                }
    ...
    final /* synthetic */ zzddj zzC() {
        return this.zzg;
    }

    final /* synthetic */ zzdcp zzD() {
        return this.zzh;
    }

    final /* synthetic */ zzdkw zzE() {
        return this.zzi;
    }

    final /* synthetic */ zzdfg zzF() {
        return this.zzD;
    }
