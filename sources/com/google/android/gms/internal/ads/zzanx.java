...
public final class zzanx implements zzanl {
    ...
    public zzanx(List list) {
        ...
        this.zzf = new Canvas();
        this.zzg = new zzanq(AdaptiveTrackSelection.DEFAULT_MAX_HEIGHT_TO_DISCARD, 575, 0, AdaptiveTrackSelection.DEFAULT_MAX_HEIGHT_TO_DISCARD, 0, 575);
            ...
            if (iZzj7 != 240) {
                ...
                switch (iZzj7) {
                    ...
                    case 17:
                        ...
                        boolean z = false;
                        while (true) {
                            int iZzj10 = zzesVar.zzj(i10);
                            if (iZzj10 != 0) {
                                i4 = 1;
                                z = z;
                            } else if (zzesVar.zzi()) {
                                if (zzesVar.zzi()) {
                                    int iZzj11 = zzesVar.zzj(i12);
                                    if (iZzj11 == 0) {
                                        i4 = 1;
                                    } else if (iZzj11 == 1) {
                                        i4 = i12;
                                    } else if (iZzj11 == i12) {
                                        iZzj4 = zzesVar.zzj(i10) + 9;
                                        iZzj5 = zzesVar.zzj(i10);
                                    } else if (iZzj11 != 3) {
                                        z = z;
                                        iZzj10 = 0;
                                        i4 = 0;
    ...
    public final void zza(byte[] bArr, int i, int i2, zzank zzankVar, zzdt zzdtVar) {
                    ...
                    switch (iZzj6) {
                                ...
                                if (zzansVar3.zzb == 0 && (zzanuVar = (zzanu) zzanwVar.zzc.get(zzanuVar2.zza)) != null) {
                                    ...
                                    while (true) {
                                        ...
                                        if (i9 < sparseArray3.size()) {
                                            zzanuVar2.zzj.put(sparseArray3.keyAt(i9), (zzanv) sparseArray3.valueAt(i9));
                                            i9++;
                                        }
                                    }
                                }
                        ...
                        case 20:
                            if (iZzj7 == zzanwVar.zza) {
                                ...
                                zzanwVar.zzh = new zzanq(iZzj27, iZzj28, i5, iZzj3, iZzj5, iZzj4);
                            }
                            break;
                    }
        ...
        if (zzansVar4 == null) {
            ...
            while (i10 < sparseArray4.size()) {
                ...
                canvas3.save();
                zzant zzantVar = (zzant) sparseArray4.valueAt(i10);
                zzanu zzanuVar3 = (zzanu) zzanwVar2.zzc.get(sparseArray4.keyAt(i10));
                int i11 = zzantVar.zza + zzanqVar.zzc;
                int i12 = zzantVar.zzb + zzanqVar.zze;
                int i13 = zzanuVar3.zzc;
                int i14 = i11 + i13;
                boolean z2 = z;
                int iMin = Math.min(i14, zzanqVar.zzd);
                int i15 = zzanuVar3.zzd;
                int i16 = i12 + i15;
                canvas3.clipRect(i11, i12, iMin, Math.min(i16, zzanqVar.zzf));
                int i17 = zzanuVar3.zzf;
                zzanp zzanpVar = (zzanp) zzanwVar2.zzd.get(i17);
                if (zzanpVar == null && (zzanpVar = (zzanp) zzanwVar2.zzf.get(i17)) == null) {
                    zzanpVar = this.zzh;
                }
                ...
                while (i19 < sparseArray5.size()) {
                    ...
                    int i20 = i19;
                    zzanv zzanvVar = (zzanv) sparseArray5.valueAt(i19);
                    ...
                    if (zzanrVar != null) {
                        ...
                        int i21 = zzanuVar3.zze;
                        int i22 = zzanvVar.zza + i11;
                        int i23 = i12 + zzanvVar.zzb;
                        canvas2 = canvas3;
                        int[] iArr = i21 == 3 ? zzanpVar.zzd : i21 == 2 ? zzanpVar.zzc : zzanpVar.zzb;
                        i4 = i14;
                        zzh(zzanrVar.zzc, iArr, i21, i22, i23, paint, canvas2);
                        zzh(zzanrVar.zzd, iArr, i21, i22, i23 + 1, paint, canvas2);
                    } else {
                        canvas2 = canvas3;
                        i4 = i14;
                    }
                ...
                float f2 = i24;
                if (zzanuVar3.zzb) {
                    int i27 = zzanuVar3.zze;
                    if (i27 == 3) {
                        i3 = zzanpVar.zzd[zzanuVar3.zzg];
                        c3 = 2;
                    } else {
                        c3 = 2;
                        i3 = i27 == 2 ? zzanpVar.zzc[zzanuVar3.zzh] : zzanpVar.zzb[zzanuVar3.zzi];
                    }
