...
public final class zzsy implements zzqv {
    ...
    public zzsy(AudioTrack audioTrack, zzre zzreVar, zztc zztcVar, float f, zzdo zzdoVar) {
        ...
        if (zztcVar != null) {
            this.zzg = new zzsp(audioTrack, zztcVar, b2 == true ? 1 : 0);
        }
        this.zzk = zzg() ? new zzsx(this, b == true ? 1 : 0) : null;
    }

    static /* synthetic */ void zzp(AudioTrack audioTrack, Handler handler, final zzef zzefVar) {
        try {
            audioTrack.flush();
            audioTrack.release();
