...
public final class zzba {
    ...
    public static zzao zza(String str, zzae zzaeVar, zzg zzgVar, List list) {
        ...
        zzai zzaiVar = null;
        double dZzh2 = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        int i = 0;
        switch (iHashCode) {
            case -1776922004:
            ...
            case -467511597:
                if (str.equals("lastIndexOf")) {
                    ...
                    if (list.size() > 1) {
                        ...
                        if (dZzh < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) {
            ...
            case 109526418:
                if (str.equals("slice")) {
                    ...
                    double dMax = dZzi < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? Math.max(dZzi + dZzh3, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) : Math.min(dZzi, dZzh3);
                    if (list.size() == 2) {
                        double dZzi2 = zzh.zzi(zzgVar.zza((zzao) list.get(1)).zzd().doubleValue());
                        dZzh3 = dZzi2 < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? Math.max(dZzh3 + dZzi2, ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) : Math.min(dZzh3, dZzi2);
                    }
            ...
            case 1943291465:
                if (str.equals("indexOf")) {
                    ...
                    if (list.size() > 1) {
                        ...
                        dZzh2 = dZzi3 < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? ((double) zzaeVar.zzh()) + dZzi3 : dZzi3;
                    }
