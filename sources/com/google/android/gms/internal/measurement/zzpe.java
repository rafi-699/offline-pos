...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzb = zzkgVarZzb.zzc("measurement.app_uninstalled_additional_ad_id_cache_time", DateUtils.MILLIS_PER_HOUR);
        ...
        zzf = zzkgVarZzb.zzc("measurement.config.cache_time", DateUtils.MILLIS_PER_DAY);
        ...
        zzj = zzkgVarZzb.zzc("measurement.session.engagement_interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzr = zzkgVarZzb.zzc("measurement.store.max_stored_events_per_app", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzA = zzkgVarZzb.zzc("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        zzB = zzkgVarZzb.zzc("measurement.rb.attribution.notify_app_delay_millis", C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
        ...
        zzkgVarZzb.zzc("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        ...
        zzV = zzkgVarZzb.zzc("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzag = zzkgVarZzb.zzc("measurement.upload.initial_upload_delay_time", C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
        zzah = zzkgVarZzb.zzc("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzan = zzkgVarZzb.zzc("measurement.upload.max_events_per_day", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzav = zzkgVarZzb.zzc("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
