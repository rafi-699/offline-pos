...
public final class zzax extends zzav {
    ...
    private static boolean zzc(zzao zzaoVar, zzao zzaoVar2) {
        ...
        return (Double.isNaN(dDoubleValue) || Double.isNaN(dDoubleValue2) || (dDoubleValue == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE && dDoubleValue2 == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) || ((dDoubleValue == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE && dDoubleValue2 == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) || Double.compare(dDoubleValue, dDoubleValue2) >= 0)) ? false : true;
    }
