...
public final class zzah implements zzao {
    ...
    public final String zzc() {
        ...
        if (Double.isInfinite(d.doubleValue())) {
            return d.doubleValue() > ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? "Infinity" : "-Infinity";
        }
        ...
        return ((i >= 0 || i <= -7) && (i < 0 || i >= 21)) ? str.replace("E-", "e-").replace(ExifInterface.LONGITUDE_EAST, "e+") : bigDecimalM.toPlainString();
    }
    ...
    public final Boolean zze() {
        Double d = this.zza;
        boolean z = false;
        if (!Double.isNaN(d.doubleValue()) && d.doubleValue() != ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) {
            z = true;
        }
