    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        public static final class Builder {
            ...
            public GoogleIdTokenRequestOptions build() {
                return new GoogleIdTokenRequestOptions(this.zba, this.zbb, this.zbc, this.zbd, this.zbe, this.zbf, this.zbg, null, null);
            }
        ...
        GoogleIdTokenRequestOptions(boolean z, String str, String str2, boolean z2, String str3, List list, boolean z3, List list2, String str4) {
            boolean z4 = true;
            if (z2 && z3) {
                z4 = false;
            }
