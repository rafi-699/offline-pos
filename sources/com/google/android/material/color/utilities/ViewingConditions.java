...
public final class ViewingConditions {
    ...
    public static ViewingConditions make(double[] dArr, double d, double d2, double d3, boolean z) {
        ...
        double d13 = dLerp;
        double dClampDouble = MathUtils.clampDouble(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, 1.0d, z ? 1.0d : (1.0d - (Math.exp(((-d) - 42.0d) / 92.0d) * 0.2777777777777778d)) * d12);
