...
public final class DynamicColor {
    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        double dMin;
        boolean z = true;
        boolean z2 = dynamicScheme.contrastLevel < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        ...
        if (function != null) {
            ...
            if ((dDoubleValue2 - dDoubleValue) * d2 < delta) {
                double d4 = delta * d2;
                dDoubleValue2 = MathUtils.clampDouble(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, 100.0d, dDoubleValue + d4);
                if ((dDoubleValue2 - dDoubleValue) * d2 < delta) {
                    dDoubleValue = MathUtils.clampDouble(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, 100.0d, dDoubleValue2 - d4);
                }
            }
            if (50.0d > dDoubleValue || dDoubleValue >= 60.0d) {
                ...
                } else if (d2 > ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) {
                    d3 = dDoubleValue;
                    dMax = 60.0d;
                } else {
                    d3 = dDoubleValue;
        ...
        if (this.secondBackground != null) {
            ...
            if (Contrast.ratioOfTones(dMax2, d) < contrast3 || Contrast.ratioOfTones(dMin2, d) < contrast3) {
                ...
                return dDarker == -1.0d ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : dDarker;
            }
        }
        return d;
    }
