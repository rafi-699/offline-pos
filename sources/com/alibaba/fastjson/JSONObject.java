...
public class JSONObject extends JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
    ...
    public double getDoubleValue(String str) {
        ...
        return dCastToDouble == null ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : dCastToDouble.doubleValue();
    }
        ...
        if (parameterTypes.length == 0) {
            ...
            if (strName == null) {
                ...
                if (name2.startsWith("get")) {
                    ...
                    if (name2.startsWith(InAppPurchaseConstants.METHOD_TO_STRING)) {
                        return toString();
                    }
                    throw new JSONException("illegal getter");
                }
            }
            return TypeUtils.cast(this.map.get(strName), method.getGenericReturnType(), ParserConfig.global);
        }
    ...
    public <T> T toJavaObject(Class<T> cls) {
        return (cls != Map.class && (cls != Object.class || containsKey(JSON.DEFAULT_TYPE_KEY))) ? (T) TypeUtils.castToJavaBean(this, cls, ParserConfig.getGlobalInstance(), 0) : this;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public <T> T toJavaObject(Class<T> cls, ParserConfig parserConfig, int i) {
        return (cls != Map.class && (cls != Object.class || containsKey(JSON.DEFAULT_TYPE_KEY))) ? (T) TypeUtils.castToJavaBean(this, cls, parserConfig, i) : this;
    }
}
