...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM1504constructorimpl = 0;
        while (it.hasNext()) {
            iM1504constructorimpl = UInt.m1504constructorimpl(iM1504constructorimpl + it.next().getData());
        }
        return iM1504constructorimpl;
    }

    public static final long sumOfULong(Sequence<ULong> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Iterator<ULong> it = sequence.iterator();
        long jM1583constructorimpl = 0;
        while (it.hasNext()) {
            jM1583constructorimpl = ULong.m1583constructorimpl(jM1583constructorimpl + it.next().getData());
        }
        return jM1583constructorimpl;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM1504constructorimpl = 0;
        while (it.hasNext()) {
            iM1504constructorimpl = UInt.m1504constructorimpl(iM1504constructorimpl + UInt.m1504constructorimpl(it.next().getData() & 255));
        }
        return iM1504constructorimpl;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM1504constructorimpl = 0;
        while (it.hasNext()) {
            iM1504constructorimpl = UInt.m1504constructorimpl(iM1504constructorimpl + UInt.m1504constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM1504constructorimpl;
    }
}
