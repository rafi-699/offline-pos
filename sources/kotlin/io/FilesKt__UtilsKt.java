...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final File createTempDir(String prefix, String str, File file) throws IOException {
        ...
        throw new IOException("Unable to create temporary directory " + fileCreateTempFile + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i < size2) {
            ...
            CollectionsKt.joinTo(CollectionsKt.drop(filePathComponentsNormalize$FilesKt__UtilsKt.getSegments(), i), sb, (62 & 2) != 0 ? ", " : separator, (62 & 4) != 0 ? "" : null, (62 & 8) != 0 ? "" : null, (62 & 16) != 0 ? -1 : 0, (62 & 32) != 0 ? "..." : null, (62 & 64) != 0 ? null : null);
        }
        return sb.toString();
    }
