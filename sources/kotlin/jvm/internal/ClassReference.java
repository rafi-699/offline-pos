...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (String str : collectionValues) {
            ...
            Pair pair = TuplesKt.to(sb.append(StringsKt.substringAfterLast$default(str, ClassUtils.PACKAGE_SEPARATOR_CHAR, (String) null, 2, (Object) null)).append("CompanionObject").toString(), str + ".Companion");
        ...
        while (it.hasNext()) {
            ...
            linkedHashMap.put(key, StringsKt.substringAfterLast$default(str2, ClassUtils.PACKAGE_SEPARATOR_CHAR, (String) null, 2, (Object) null));
        }
