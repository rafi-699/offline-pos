...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m1577boximpl(ULong.m1583constructorimpl(getMostSignificantBits())), ULong.m1577boximpl(ULong.m1583constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2893toUByteArrayTcUX1vc() {
        return UByteArray.m1480constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m1583constructorimpl(j) ^ Long.MIN_VALUE, ULong.m1583constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m1583constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m1583constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2895fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2894fromUByteArrayGBYM_sE(byte[] ubyteArray) {
