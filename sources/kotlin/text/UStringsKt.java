...
public final class UStringsKt {
    ...
    public static final String m2741toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2743toStringolVBNx4(short s, int i) {
    ...
    public static final String m2742toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2740toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1504constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m1417boximpl(UByte.m1423constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1504constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1684boximpl(UShort.m1690constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1504constructorimpl = UInt.m1504constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM1504constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM1504constructorimpl2 = UInt.m1504constructorimpl(i3 * iM1504constructorimpl);
            int iM1504constructorimpl3 = UInt.m1504constructorimpl(UInt.m1504constructorimpl(iDigitOf) + iM1504constructorimpl2);
            if (Integer.compare(iM1504constructorimpl3 ^ Integer.MIN_VALUE, iM1504constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM1504constructorimpl3;
        }
        return UInt.m1498boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1583constructorimpl = ULong.m1583constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM1583constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM1583constructorimpl2 = ULong.m1583constructorimpl(j * jM1583constructorimpl);
            long jM1583constructorimpl3 = ULong.m1583constructorimpl(ULong.m1583constructorimpl(((long) UInt.m1504constructorimpl(iDigitOf)) & 4294967295L) + jM1583constructorimpl2);
            if (Long.compare(jM1583constructorimpl3 ^ Long.MIN_VALUE, jM1583constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM1583constructorimpl3;
        }
        return ULong.m1577boximpl(j);
    }
}
