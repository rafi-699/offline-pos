...
public final class LongSaturatedMathKt {
    ...
    public static final long m2859saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM2793toLongimpl = Duration.m2793toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2858checkInfiniteSumDefinedPjuGub4(j, j2, jM2793toLongimpl);
        }
        if (((jM2793toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m2860saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM2793toLongimpl;
        if (((j ^ j3) & (jM2793toLongimpl ^ j3)) < 0) {
    ...
    private static final long m2858checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2779isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2860saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM2757divUwyO8pc = Duration.m2757divUwyO8pc(j2, 2);
        long jM2793toLongimpl = Duration.m2793toLongimpl(jM2757divUwyO8pc, durationUnit);
        return (1 | (jM2793toLongimpl - 1)) == Long.MAX_VALUE ? jM2793toLongimpl : m2859saturatingAddNuflL3o(m2859saturatingAddNuflL3o(j, durationUnit, jM2757divUwyO8pc), durationUnit, Duration.m2782minusLRDsOJo(j2, jM2757divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m2844getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m2843getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2798unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m2783plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m2798unaryMinusUwyO8pc(infinityOfSign(j3));
        }
