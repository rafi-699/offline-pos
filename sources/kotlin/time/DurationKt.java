...
public final class DurationKt {
    ...
    private static final long m2851timesmvk6XK0(int i, long j) {
        return Duration.m2785timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2850timeskIfJnKk(double d, long j) {
        return Duration.m2784timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2845getZEROUwyO8pc = Duration.INSTANCE.m2845getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    int iIndexOf$default = StringsKt.indexOf$default((CharSequence) str2, ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null);
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2783plusLRDsOJo = Duration.m2783plusLRDsOJo(jM2845getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM2845getZEROUwyO8pc = Duration.m2783plusLRDsOJo(jM2783plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2845getZEROUwyO8pc = Duration.m2783plusLRDsOJo(jM2845getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, iMax, true)) {
                jM2845getZEROUwyO8pc = Duration.INSTANCE.m2843getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (length2 < i) {
                    ...
                    int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str4, ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null);
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2783plusLRDsOJo2 = Duration.m2783plusLRDsOJo(jM2845getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2845getZEROUwyO8pc = Duration.m2783plusLRDsOJo(jM2783plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2845getZEROUwyO8pc = Duration.m2783plusLRDsOJo(jM2845getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m2798unaryMinusUwyO8pc(jM2845getZEROUwyO8pc) : jM2845getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2754constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2754constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2754constructorimpl((j << 1) + ((long) i));
    }
