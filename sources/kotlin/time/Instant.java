...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m2852minusLRDsOJo(long duration) {
        return m2854plusLRDsOJo(Duration.m2798unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m2853minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m2783plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2854plusLRDsOJo(long duration) {
        long jM2768getInWholeSecondsimpl = Duration.m2768getInWholeSecondsimpl(duration);
        int iM2770getNanosecondsComponentimpl = Duration.m2770getNanosecondsComponentimpl(duration);
        if (jM2768getInWholeSecondsimpl == 0 && iM2770getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM2768getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM2768getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM2770getNanosecondsComponentimpl);
        }
        return Duration.m2781isPositiveimpl(duration) ? MAX : MIN;
    }
}
