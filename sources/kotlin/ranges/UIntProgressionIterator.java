...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m1498boximpl(m2643nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m1504constructorimpl(i3);
    ...
    public int m2643nextpVg5ArA() {
        ...
        this.next = UInt.m1504constructorimpl(this.step + i);
        return i;
    }
}
