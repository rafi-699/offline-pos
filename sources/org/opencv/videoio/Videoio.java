...
public class Videoio {
    ...
    public static final int CAP_PROP_ANDROID_DEVICE_TORCH = 8001;
    ...
    public static final int CAP_PROP_DTS_DELAY = 72;
    ...
    public static final int CAP_PROP_PTS = 71;
    ...
    public static final int VIDEOWRITER_PROP_DTS_DELAY = 13;
    ...
    public static final int VIDEOWRITER_PROP_PTS = 12;
    ...
    private static native String getStreamBufferedBackendPluginVersion_0(int i, double[] dArr, double[] dArr2);
    ...
    public static String getStreamBufferedBackendPluginVersion(int i, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String streamBufferedBackendPluginVersion_0 = getStreamBufferedBackendPluginVersion_0(i, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
        ...
        return streamBufferedBackendPluginVersion_0;
    }
