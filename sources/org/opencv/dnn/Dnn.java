...
public class Dnn {
    ...
    public static Mat blobFromImageWithParams(Mat mat, Image2BlobParams image2BlobParams) {
        return new Mat(blobFromImageWithParams_0(mat.nativeObj, image2BlobParams.getNativeObjAddr()));
    }
    ...
    public static void blobFromImageWithParams(Mat mat, Mat mat2, Image2BlobParams image2BlobParams) {
        blobFromImageWithParams_2(mat.nativeObj, mat2.nativeObj, image2BlobParams.getNativeObjAddr());
    }
    ...
    public static Mat blobFromImagesWithParams(List<Mat> list, Image2BlobParams image2BlobParams) {
        return new Mat(blobFromImagesWithParams_0(Converters.vector_Mat_to_Mat(list).nativeObj, image2BlobParams.getNativeObjAddr()));
    }
    ...
    public static void blobFromImagesWithParams(List<Mat> list, Mat mat, Image2BlobParams image2BlobParams) {
        blobFromImagesWithParams_2(Converters.vector_Mat_to_Mat(list).nativeObj, mat.nativeObj, image2BlobParams.getNativeObjAddr());
    }
