...
public class Core {
    ...
    public static class MinMaxLocResult {
        public double minVal = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
        public double maxVal = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
