...
public abstract class CharSequenceTranslator {
    ...
    public final CharSequenceTranslator with(CharSequenceTranslator... charSequenceTranslatorArr) {
        ...
        return new AggregateTranslator((CharSequenceTranslator[]) ArrayUtils.arraycopy(charSequenceTranslatorArr, 0, charSequenceTranslatorArr2, 1, charSequenceTranslatorArr.length));
    }
}
