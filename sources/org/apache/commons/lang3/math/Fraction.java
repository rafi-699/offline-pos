...
public final class Fraction extends Number implements Comparable<Fraction> {
    ...
    public static Fraction getFraction(double d) {
        int i;
        int i2;
        int i3 = d < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? -1 : 1;
        ...
        return getReducedFraction((i10 + (i4 * i9)) * i, i9);
    }
        ...
        if (this.toProperString == null) {
            ...
            if (i == 0) {
                ...
                if (i == i2) {
                    ...
                    if (i >= (-i2)) {
                        this.toProperString = getNumerator() + DomExceptionUtils.SEPARATOR + getDenominator();
                    } else {
                        int properNumerator = getProperNumerator();
                        if (properNumerator != 0) {
                            this.toProperString = getProperWhole() + StringUtils.SPACE + properNumerator + DomExceptionUtils.SEPARATOR + getDenominator();
                        } else {
    ...
    public String toString() {
        if (this.toString == null) {
            this.toString = getNumerator() + DomExceptionUtils.SEPARATOR + getDenominator();
        }
