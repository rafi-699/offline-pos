...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    private static final ThreadLocal<Set<IDKey>> REGISTRY = new Utf8Old$$ExternalSyntheticThreadLocal1(new Supplier() { // from class: org.apache.commons.lang3.builder.HashCodeBuilder$$ExternalSyntheticLambda0
        @Override // java.util.function.Supplier
        public final Object get() {
            return HashCodeBuilder.$r8$lambda$9sNe9Z0ULfWboQeEjPzVPZGTMDM();
        }
    });
    ...
    private static void reflectionAppend(Object obj, Class<?> cls, HashCodeBuilder hashCodeBuilder, boolean z, String[] strArr) {
        ...
        try {
            register(obj);
            Field[] fieldArr = (Field[]) ArraySorter.sort(cls.getDeclaredFields(), Comparator.comparing(new Function() { // from class: org.apache.commons.lang3.builder.HashCodeBuilder$$ExternalSyntheticLambda1
