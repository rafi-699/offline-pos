...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1405constructorimpl2;
        ...
        try {
            ...
            objM1405constructorimpl = Result.m1405constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1408exceptionOrNullimpl(objM1405constructorimpl) == null) {
            obj2 = objM1405constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1405constructorimpl2 = Result.m1405constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1405constructorimpl2 = Result.m1405constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1408exceptionOrNullimpl(objM1405constructorimpl2) == null) {
            obj = objM1405constructorimpl2;
        }
