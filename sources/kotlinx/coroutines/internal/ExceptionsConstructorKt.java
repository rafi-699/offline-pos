...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM1405constructorimpl = Result.m1405constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM1405constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM1405constructorimpl = Result.m1405constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m1411isFailureimpl(objM1405constructorimpl) ? null : objM1405constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1411isFailureimpl(objM1405constructorimpl)) {
            objM1405constructorimpl = numValueOf;
        }
        return ((Number) objM1405constructorimpl).intValue();
    }
