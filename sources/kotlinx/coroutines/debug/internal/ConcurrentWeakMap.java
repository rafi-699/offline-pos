        ...
        public final ConcurrentWeakMap<K, V>.Core rehash() {
            ...
            while (true) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(getValues(), i2, obj, ConcurrentWeakMapKt.mark(obj)));
