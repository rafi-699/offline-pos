...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM1405constructorimpl = Result.m1405constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1411isFailureimpl(objM1405constructorimpl) ? null : objM1405constructorimpl);
