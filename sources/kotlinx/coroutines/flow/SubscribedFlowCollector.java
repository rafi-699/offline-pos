...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.SubscribedFlowCollector", f = "Share.kt", i = {0, 0}, l = {Videoio.CAP_PROP_XI_EXPOSURE_BURST_COUNT, Videoio.CAP_PROP_XI_DOWNSAMPLING_TYPE}, m = "onSubscription", n = {"this", "safeCollector"}, s = {"L$0", "L$1"})
