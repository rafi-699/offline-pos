    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$subscriptionCount.collect(new C00561(booleanRef, flowCollector), this) == coroutine_suspended) {
        ...
        static final class C00561<T> implements FlowCollector {
            ...
            C00561(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
