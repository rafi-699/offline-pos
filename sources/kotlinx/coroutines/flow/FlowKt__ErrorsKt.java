...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C02631 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02631(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C02631) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", f = "Errors.kt", i = {}, l = {Imgproc.COLOR_YUV2BGR_NV12}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public static final <T> Flow<T> m2962catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
