...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    static final class C02691<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {179}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C02703<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C02703(Continuation<? super C02703> continuation) {
            super(continuation);
        }
    ...
    static final class C02711<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02761<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02781<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02801<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c02772 = new C02772<>(objectRef2, function3);
            c02761.L$0 = objectRef2;
            c02761.label = 1;
            if (flow.collect(c02772, c02761) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c02761.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    static final class C02772<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C02772(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) {
        ...
        if (i == 0) {
            ...
            c02711.L$0 = objectRef2;
            c02711.label = 1;
            if (flow.collect(anonymousClass2, c02711) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c02711.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c02781.L$0 = objectRef2;
            c02781.label = 1;
            if (flow.collect(flowCollector, c02781) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c02781.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            try {
                c02801.L$0 = objectRef2;
                c02801.L$1 = flowCollector2;
                c02801.label = 1;
                if (flow.collect(flowCollector2, c02801) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
                ...
                JobKt.ensureActive(c02801.get$context());
            }
        } else {
            if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c02801.L$1;
            objectRef = (Ref.ObjectRef) c02801.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            try {
                c02691.L$0 = objectRef2;
                c02691.L$1 = flowCollector2;
                c02691.label = 1;
                if (flow.collect(flowCollector2, c02691) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
                ...
                flowCollector = flowCollector2;
                FlowExceptions_commonKt.checkOwnership(e, flowCollector);
                JobKt.ensureActive(c02691.get$context());
            }
        } else {
            if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c02691.L$1;
            objectRef = (Ref.ObjectRef) c02691.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C02703) {
            c02703 = (C02703) continuation;
            if ((c02703.label & Integer.MIN_VALUE) != 0) {
                c02703.label -= Integer.MIN_VALUE;
            } else {
                c02703 = new C02703(continuation);
            }
        } else {
            c02703 = new C02703(continuation);
        }
        Object obj = c02703.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02703.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c02703.L$0 = objectRef2;
                c02703.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c02703.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c02703) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
                ...
                FlowExceptions_commonKt.checkOwnership(e, flowCollector);
                JobKt.ensureActive(c02703.get$context());
            }
        } else {
            if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c02703.L$1;
            objectRef = (Ref.ObjectRef) c02703.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c02741.label = 1;
            if (flow.collect(flowCollector, c02741) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
