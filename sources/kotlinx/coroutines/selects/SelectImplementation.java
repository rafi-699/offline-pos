...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C02811 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02811(SelectImplementation<R> selectImplementation, Continuation<? super C02811> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C02811) {
            ...
            if ((c02811.label & Integer.MIN_VALUE) != 0) {
                ...
                c02811 = new C02811(this, continuation);
            }
        } else {
            c02811 = new C02811(this, continuation);
        }
        Object obj2 = c02811.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02811.label;
        try {
            if (i != 0) {
            ...
            c02811.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c02811);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c02811 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c02811);
            }
            throw th;
        }
    }
