...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> dispatchedTask, Continuation<? super T> continuation, boolean z) {
        ...
        Object objM1405constructorimpl = Result.m1405constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(objM1405constructorimpl);
        ...
        continuation.resumeWith(objM1405constructorimpl);
    }
