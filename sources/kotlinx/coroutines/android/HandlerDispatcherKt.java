...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM1405constructorimpl = Result.m1405constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1405constructorimpl = Result.m1405constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m1411isFailureimpl(objM1405constructorimpl) ? null : objM1405constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2979dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$2$1
