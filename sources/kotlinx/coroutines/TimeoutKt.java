...
public final class TimeoutKt {
    ...
    public static final <T> Object m2909withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2900toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m2910withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2900toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM2901timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM2901timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m2901timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM2901timeoutMessageLRDsOJo == null) {
                strM2901timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM2901timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM2901timeoutMessageLRDsOJo, job);
    }
}
