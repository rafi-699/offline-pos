...
public final class CompletionStateKt {
    public static final <T> Object toState(Object obj) {
        ...
        return thM1408exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM1408exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(Object obj, CancellableContinuation<?> cancellableContinuation) {
        ...
        if (DebugKt.getRECOVER_STACK_TRACES()) {
            ...
            if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                thM1408exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM1408exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
            }
        }
        return new CompletedExceptionally(thM1408exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m1405constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
        }
