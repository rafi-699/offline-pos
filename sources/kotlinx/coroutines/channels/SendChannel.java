...
public interface SendChannel<E> {
    ...
    Object mo2912trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2937isSuccessimpl(objMo2912trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2931exceptionOrNullimpl = ChannelResult.m2931exceptionOrNullimpl(objMo2912trySendJP2dKIU);
