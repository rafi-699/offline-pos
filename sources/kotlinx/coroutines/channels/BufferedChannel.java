...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo2919receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m2917receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m1405constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public Object mo2912trySendJP2dKIU(E element) {
        ...
        if (shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            return ChannelResult.INSTANCE.m2941failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (channelSegment.id != j2) {
                ...
                if (channelSegmentFindSegmentSend == null) {
                    if (zIsClosedForSend0) {
                        return ChannelResult.INSTANCE.m2940closedJP2dKIU(getSendException());
                    }
                }
            } else {
            ...
            if (iUpdateCellSend == 0) {
                channelSegment.cleanPrev();
                return ChannelResult.INSTANCE.m2942successJP2dKIU(Unit.INSTANCE);
            }
            if (iUpdateCellSend == 1) {
                return ChannelResult.INSTANCE.m2942successJP2dKIU(Unit.INSTANCE);
            }
    ...
    protected final Object m2921trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegmentFindSegmentSend;
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM2927boximpl = ChannelResult.m2927boximpl(ChannelResult.INSTANCE.m2942successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM2927boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m1405constructorimpl(ResultKt.createFailure(getReceiveException())));
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0014  */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: receiveCatching-JP2dKIU$suspendImpl, reason: not valid java name */
    static /* synthetic */ <E> Object m2917receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM2918receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel2.m2918receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$2);
                        return objM2918receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM2918receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m2942successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel2.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m2940closedJP2dKIU(bufferedChannel.getCloseCause());
    }
    ...
    public final Object m2918receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM2927boximpl;
        ChannelSegment channelSegment2;
                    ...
                    try {
                        if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                            ...
                            if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                                ...
                                while (true) {
                                    ...
                                    if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                        if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                            ...
                                            channelSegment2.cleanPrev();
                                            channelResultM2927boximpl = ChannelResult.m2927boximpl(ChannelResult.INSTANCE.m2942successJP2dKIU(objUpdateCellReceive2));
                                            Function1<E, Unit> function1 = this.onUndeliveredElement;
                                            if (function1 != null) {
                                ...
                                channelSegment.cleanPrev();
                                channelResultM2927boximpl = ChannelResult.m2927boximpl(ChannelResult.INSTANCE.m2942successJP2dKIU(objUpdateCellReceive));
                                Function1<E, Unit> function2 = this.onUndeliveredElement;
                                if (function2 != null) {
                                    kFunctionBindCancellationFunResult = bindCancellationFunResult(function2);
                                }
                            }
                            orCreateCancellableContinuation.resume(channelResultM2927boximpl, (Function3<? super Throwable, ? super ChannelResult, ? super CoroutineContext, Unit>) kFunctionBindCancellationFunResult);
                            break;
                        }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m1405constructorimpl(ChannelResult.m2927boximpl(ChannelResult.INSTANCE.m2940closedJP2dKIU(getCloseCause()))));
    }
    ...
    public Object mo2920tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m2940closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m2927boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m2940closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m2942successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX WARN: Code duplicated, block: B:38:0x00b6 A[Catch: all -> 0x00ea, PHI: r10 r11 r12
  0x00b6: PHI (r10v3 java.lang.Object) = (r10v2 java.lang.Object), (r10v11 java.lang.Object) binds: [B:43:0x00d9, B:37:0x00b4] A[DONT_GENERATE, DONT_INLINE]
  0x00b6: PHI (r11v5 java.lang.Boolean) = (r11v3 java.lang.Boolean), (r11v16 java.lang.Boolean) binds: [B:43:0x00d9, B:37:0x00b4] A[DONT_GENERATE, DONT_INLINE]
  0x00b6: PHI (r12v3 kotlin.jvm.functions.Function1<E, kotlin.Unit>) = (r12v2 kotlin.jvm.functions.Function1<E, kotlin.Unit>), (r12v4 kotlin.jvm.functions.Function1<E, kotlin.Unit>) binds: [B:43:0x00d9, B:37:0x00b4] A[DONT_GENERATE, DONT_INLINE], TryCatch #0 {all -> 0x00ea, blocks: (B:3:0x000a, B:5:0x001d, B:6:0x0025, B:8:0x002d, B:10:0x0035, B:11:0x0038, B:12:0x0042, B:14:0x0048, B:15:0x004d, B:17:0x0066, B:21:0x006e, B:23:0x007c, B:25:0x0083, B:27:0x0088, B:28:0x008c, B:30:0x0092, B:32:0x009a, B:34:0x009f, B:36:0x00a5, B:38:0x00b6, B:39:0x00ba, B:40:0x00be, B:41:0x00c9, B:42:0x00ca), top: B:52:0x000a }] */
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m1405constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m1405constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object objM2970constructorimpl$default = InlineList.m2970constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM2970constructorimpl$default = InlineList.m2975plusFjFbRPM(objM2970constructorimpl$default, waiter);
        ...
        if (objM2970constructorimpl$default != null) {
            if (!(objM2970constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) objM2970constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(objM2970constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) objM2970constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2970constructorimpl$default = InlineList.m2975plusFjFbRPM(objM2970constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2970constructorimpl$default = InlineList.m2975plusFjFbRPM(objM2970constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM2970constructorimpl$default != null) {
            if (!(objM2970constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM2970constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM2970constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
            ArrayList arrayList = (ArrayList) objM2970constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m1405constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m1405constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m1405constructorimpl(ChannelResult.m2927boximpl(ChannelResult.INSTANCE.m2940closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m2987isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM2985getSegmentimpl = SegmentOrClosed.m2985getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM2985getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM2985getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM2985getSegmentimpl)) {
                    ...
                    if (segmentM2985getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM2985getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m2985getSegmentimpl(objFindSegmentInternal);
    ...
    /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function3<Throwable, ChannelResult<? extends E>, CoroutineContext, Unit> {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Throwable th, Object obj, CoroutineContext coroutineContext) {
            m2922invoke5_sEAP8(th, ((ChannelResult) obj).getHolder(), coroutineContext);
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m2922invoke5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
            ((BufferedChannel) this.receiver).m2916onCancellationChannelResultImplDoNotCall5_sEAP8(th, obj, coroutineContext);
        }
    }
    ...
    public final void m2916onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable cause, Object element, CoroutineContext context) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object objM2932getOrNullimpl = ChannelResult.m2932getOrNullimpl(element);
        Intrinsics.checkNotNull(objM2932getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, objM2932getOrNullimpl, context);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m1405constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m1405constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    /* JADX WARN: Code duplicated, block: B:69:0x011d A[RETURN] */
    ...
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) throws Throwable {
        ...
        try {
            try {
                ...
                cancellableContinuationImpl.resumeWith(Result.m1405constructorimpl(unit));
                result = orCreateCancellableContinuation.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(continuation);
                }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m1405constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
            } else {
                channelSegment = channelSegment2;
            ...
            Result.Companion companion3 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m1405constructorimpl(Boxing.boxBoolean(true)));
            break;
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
