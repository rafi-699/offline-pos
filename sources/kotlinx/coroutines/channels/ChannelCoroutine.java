...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2919receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2919receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2920tryReceivePtdJZtk() {
        return this._channel.mo2920tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2912trySendJP2dKIU(E element) {
        return this._channel.mo2912trySendJP2dKIU(element);
    }
