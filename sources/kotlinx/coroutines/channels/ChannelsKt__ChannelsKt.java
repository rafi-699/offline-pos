...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m2927boximpl(Result.m1412isSuccessimpl(objM1405constructorimpl) ? ChannelResult.INSTANCE.m2942successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2940closedJP2dKIU(Result.m1408exceptionOrNullimpl(objM1405constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2912trySendJP2dKIU = sendChannel.mo2912trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2937isSuccessimpl(sendChannel.mo2912trySendJP2dKIU(obj))) {
            return;
        }
