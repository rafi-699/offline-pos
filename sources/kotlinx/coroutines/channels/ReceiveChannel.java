...
public interface ReceiveChannel<E> {
    ...
    Object mo2919receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2920tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2920tryReceivePtdJZtk = receiveChannel.mo2920tryReceivePtdJZtk();
            if (ChannelResult.m2937isSuccessimpl(objMo2920tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2933getOrThrowimpl(objMo2920tryReceivePtdJZtk);
            }
            Throwable thM2931exceptionOrNullimpl = ChannelResult.m2931exceptionOrNullimpl(objMo2920tryReceivePtdJZtk);
            if (thM2931exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2931exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object objMo2919receiveCatchingJP2dKIU;
            ...
            if (i == 0) {
                ...
                objMo2919receiveCatchingJP2dKIU = receiveChannel.mo2919receiveCatchingJP2dKIU(anonymousClass1);
                if (objMo2919receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo2919receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m2932getOrNullimpl(objMo2919receiveCatchingJP2dKIU);
        }
