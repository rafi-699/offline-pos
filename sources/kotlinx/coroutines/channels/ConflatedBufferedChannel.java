...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2946trySendImplMj0NB7M = conflatedBufferedChannel.m2946trySendImplMj0NB7M(e, true);
        if (objM2946trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2931exceptionOrNullimpl(objM2946trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2946trySendImplMj0NB7M = conflatedBufferedChannel.m2946trySendImplMj0NB7M(e, true);
        if (!(objM2946trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2912trySendJP2dKIU(E element) {
        return m2946trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2946trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2945trySendDropLatestMj0NB7M(element, isSendOp) : m2921trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2945trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2912trySendJP2dKIU = super.mo2912trySendJP2dKIU(element);
        if (ChannelResult.m2937isSuccessimpl(objMo2912trySendJP2dKIU) || ChannelResult.m2935isClosedimpl(objMo2912trySendJP2dKIU)) {
            return objMo2912trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2912trySendJP2dKIU = mo2912trySendJP2dKIU(element);
        if (!(objMo2912trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2912trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2931exceptionOrNullimpl(objMo2912trySendJP2dKIU);
