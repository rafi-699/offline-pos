...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2980scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2899delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2900toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2900toDelayMillisLRDsOJo(long j) {
        boolean zM2781isPositiveimpl = Duration.m2781isPositiveimpl(j);
        if (zM2781isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2765getInWholeMillisecondsimpl(Duration.m2783plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM2781isPositiveimpl) {
