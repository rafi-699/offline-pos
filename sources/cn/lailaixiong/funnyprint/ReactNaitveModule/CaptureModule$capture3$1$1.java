...
@Metadata(d1 = {"\u0000+\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J&\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u00072\b\u0010\b\u001a\u0004\u0018\u00010\tH\u0016J\u0018\u0010\n\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u000b\u001a\u00020\fH\u0016¨\u0006\r"}, d2 = {"cn/lailaixiong/funnyprint/ReactNaitveModule/CaptureModule$capture3$1$1", "Landroid/webkit/WebViewClient;", "onReceivedError", "", ViewHierarchyConstants.VIEW_KEY, "Landroid/webkit/WebView;", "request", "Landroid/webkit/WebResourceRequest;", "error", "Landroid/webkit/WebResourceError;", "onPageFinished", "url", "", "app_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class CaptureModule$capture3$1$1 extends WebViewClient {
    final /* synthetic */ Promise $promise;
    final /* synthetic */ WebView $webView;

    CaptureModule$capture3$1$1(Promise promise, WebView webView) {
    ...
    public void onPageFinished(final WebView view, String url) {
        ...
        handler.postDelayed(new Runnable() { // from class: cn.lailaixiong.funnyprint.ReactNaitveModule.CaptureModule$capture3$1$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                CaptureModule$capture3$1$1.onPageFinished$lambda$0(view, webView, promise);
            }
        }, 1000L);
    }
    ...
    public static final void onPageFinished$lambda$0(WebView webView, WebView webView2, Promise promise) {
        ...
        promise.resolve(ImageUtil.INSTANCE.bitmapToBase64String(Bitmap.createScaledBitmap(bitmapCreateBitmap, 1500, (bitmapCreateBitmap.getHeight() * 1500) / bitmapCreateBitmap.getWidth(), true)) + "|temp");
    }
}
