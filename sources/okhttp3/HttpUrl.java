...
public final class HttpUrl {
    ...
    public final String m3051deprecated_encodedUsername() {
    ...
    public final String m3047deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        public final Builder encodedPath(String encodedPath) {
            ...
            if (!StringsKt.startsWith$default(encodedPath, DomExceptionUtils.SEPARATOR, false, 2, (Object) null)) {
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            if (iSlashCount >= 2 || base == null || !Intrinsics.areEqual(base.scheme(), this.scheme)) {
                ...
                while (true) {
                    ...
                    if (iCharAt == 64) {
                        if (z3) {
                            ...
                            input2 = input;
                            i3 = iDelimiterOffset;
                            this.encodedPassword += "%40" + Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input2, i9, iDelimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
                        } else {
                            int iDelimiterOffset2 = Util.delimiterOffset(input2, ':', i9, iDelimiterOffset);
                            i2 = i6;
                            z = z2;
                            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input2, i9, iDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
                            if (z4) {
                            ...
                            if (iDelimiterOffset2 != iDelimiterOffset) {
                                i4 = iDelimiterOffset;
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset2 + 1, i4, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, PsExtractor.VIDEO_STREAM_MASK, null);
                                z3 = z;
                            } else {
                                i4 = iDelimiterOffset;
                            }
                ...
                int iPortColonOffset = companion2.portColonOffset(input2, i9, iDelimiterOffset);
                ...
                if (i11 < iDelimiterOffset) {
                    ...
                    int port = companion2.parsePort(input2, i11, iDelimiterOffset);
                    this.port = port;
                    if (port == i10) {
                        StringBuilder sb2 = new StringBuilder("Invalid URL port: \"");
                        String strSubstring2 = input2.substring(i11, iDelimiterOffset);
            ...
            int i12 = i;
            int iDelimiterOffset3 = Util.delimiterOffset(input2, "?#", iIndexOfFirstNonAsciiWhitespace$default, i12);
            resolvePath(input2, iIndexOfFirstNonAsciiWhitespace$default, iDelimiterOffset3);
            if (iDelimiterOffset3 >= i12 || input2.charAt(iDelimiterOffset3) != '?') {
                c = '#';
                i5 = iDelimiterOffset3;
            } else {
                c = '#';
                int iDelimiterOffset4 = Util.delimiterOffset(input2, '#', iDelimiterOffset3, i12);
                this.encodedQueryNamesAndValues = HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input2, iDelimiterOffset3 + 1, iDelimiterOffset4, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, JfifUtil.MARKER_RST0, null));
                i5 = iDelimiterOffset4;
            }
            if (i5 < i12 && input2.charAt(i5) == c) {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input2, i5 + 1, i12, "", true, false, false, true, null, 176, null);
            }
            return this;
        }
        ...
        private final void resolvePath(String input, int startPos, int limit) {
            ...
            while (i < limit) {
                ...
                input = input;
                push(input, i, iDelimiterOffset, z, true);
                i = z ? iDelimiterOffset + 1 : iDelimiterOffset;
            }
        }
        ...
        public static final class Companion {
            ...
            public final int parsePort(String input, int pos, int limit) {
                try {
                    int i = Integer.parseInt(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, "", false, false, false, false, null, Imgcodecs.IMWRITE_PNG_ALL_FILTERS, null));
                    if (1 > i || i >= 65536) {
                        return -1;
                    }
                    return i;
    ...
    public static final class Companion {
        ...
        public final HttpUrl m3065deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m3068deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m3067deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m3066deprecated_get(URI uri) {
