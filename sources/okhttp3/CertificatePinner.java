    ...
    public static final class Pin {
        ...
        public final boolean matchesHostname(String hostname) {
            ...
            if (StringsKt.startsWith$default(this.pattern, "*.", false, 2, (Object) null)) {
                ...
                return StringsKt.regionMatches$default(hostname, hostname.length() - length3, this.pattern, 1, length3, false, 16, (Object) null) && StringsKt.lastIndexOf$default((CharSequence) hostname, ClassUtils.PACKAGE_SEPARATOR_CHAR, (hostname.length() - length3) + (-1), false, 4, (Object) null) == -1;
            }
