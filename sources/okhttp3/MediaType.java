...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType get(String str) {
            ...
            while (iEnd < str.length()) {
                ...
                if (!matcher2.lookingAt()) {
                    ...
                    throw new IllegalArgumentException(sb.append(strSubstring).append("\" for: \"").append(str).append(Typography.quote).toString().toString());
                }
        ...
        public final MediaType m3071deprecated_get(String mediaType) {
        ...
        public final MediaType m3072deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
