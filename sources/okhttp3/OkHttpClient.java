...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public final List<Interceptor> m3093deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* JADX INFO: renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m3094deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public static final class Builder {
        ...
        public final Builder m3105addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m3106addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            this.callTimeout = Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, timeout, unit);
            return this;
        }
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            this.connectTimeout = Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, timeout, unit);
            return this;
        }
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            this.readTimeout = Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, timeout, unit);
            return this;
        }
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            this.writeTimeout = Util.checkDuration(ClientComponent.NamedSchedulers.TIMEOUT, timeout, unit);
            return this;
        }
