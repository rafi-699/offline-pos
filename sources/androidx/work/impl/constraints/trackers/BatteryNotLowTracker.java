...
public class BatteryNotLowTracker extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    public Boolean getInitialState() {
        ...
        return Boolean.valueOf(intentRegisterReceiver.getIntExtra("status", -1) == 1 || ((float) intentRegisterReceiver.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1)) / ((float) intentRegisterReceiver.getIntExtra("scale", -1)) > BATTERY_LOW_THRESHOLD);
    }
