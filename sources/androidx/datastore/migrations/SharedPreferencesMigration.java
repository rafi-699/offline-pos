...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C00871 extends ContinuationImpl {
        ...
        C00871(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C00871> continuation) {
            super(continuation);
    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof C00871) {
            ...
            if ((c00871.label & Integer.MIN_VALUE) != 0) {
                ...
                c00871 = new C00871(this, continuation);
            }
        } else {
            c00871 = new C00871(this, continuation);
        }
        Object objInvoke = c00871.result;
        ...
        if (i == 0) {
            ...
            c00871.L$0 = this;
            c00871.label = 1;
            objInvoke = function2.invoke(t, c00871);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c00871.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
