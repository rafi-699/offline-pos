...
@DebugMetadata(c = "androidx.datastore.core.DataStoreImpl$data$1", f = "DataStoreImpl.kt", i = {0, 1, 1}, l = {72, Imgproc.COLOR_LBGR2Lab, 100}, m = "invokeSuspend", n = {"$this$flow", "$this$flow", "startState"}, s = {"L$0", "L$0", "L$1"})
final class DataStoreImpl$data$1<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00ce, code lost:
        ...
        if (kotlinx.coroutines.flow.FlowKt.emitAll((kotlinx.coroutines.flow.FlowCollector) r1, kotlinx.coroutines.flow.FlowKt.onCompletion(new androidx.datastore.core.DataStoreImpl$data$1$invokeSuspend$$inlined$map$1<>(r9), new androidx.datastore.core.DataStoreImpl$data$1.AnonymousClass5(r8.this$0, null)), r8) == r0) goto L33;
     */
