...
public final class FileStorageConnection<T> implements StorageConnection<T> {
    ...
    static final class C00821 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00821(FileStorageConnection<T> fileStorageConnection, Continuation<? super C00821> continuation) {
            super(continuation);
            this.this$0 = fileStorageConnection;
        }
    ...
    public Object writeScope(Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws IOException {
        ...
        if (continuation instanceof C00821) {
            ...
            if ((c00821.label & Integer.MIN_VALUE) != 0) {
                ...
                c00821 = new C00821(this, continuation);
            }
        } else {
            c00821 = new C00821(this, continuation);
        }
                ...
                try {
                    try {
                        if (i == 0) {
                            ...
                            c00821.L$0 = this;
                            c00821.L$1 = function2;
                            c00821.L$2 = mutex2;
                            c00821.label = 1;
                            if (mutex2.lock(null, c00821) != coroutine_suspended) {
                        ...
                        if (i != 1) {
                            ...
                            closeable = (Closeable) c00821.L$3;
                            File file3 = (File) c00821.L$2;
                            mutex = (Mutex) c00821.L$1;
                            fileStorageConnection2 = (FileStorageConnection) c00821.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                file2 = file3;
                        ...
                        Mutex mutex3 = (Mutex) c00821.L$2;
                        Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function3 = (Function2) c00821.L$1;
                        fileStorageConnection = (FileStorageConnection) c00821.L$0;
                        ResultKt.throwOnFailure(obj);
                        mutex = mutex3;
                        function2 = function3;
                        c00821.L$0 = fileStorageConnection;
                        c00821.L$1 = mutex;
                        c00821.L$2 = file;
                        c00821.L$3 = fileWriteScope;
                        c00821.label = 2;
                        if (function2.invoke(fileWriteScope, c00821) != coroutine_suspended) {
                            file2 = file;
