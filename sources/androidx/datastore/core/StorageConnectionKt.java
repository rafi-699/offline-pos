...
public final class StorageConnectionKt {
    ...
    static final class C00852<T> extends SuspendLambda implements Function2<WriteScope<T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00852(T t, Continuation<? super C00852> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00852 c00852 = new C00852(this.$value, continuation);
            c00852.L$0 = obj;
            return c00852;
        }
        ...
        public final Object invoke(WriteScope<T> writeScope, Continuation<? super Unit> continuation) {
            return ((C00852) create(writeScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object writeData(StorageConnection<T> storageConnection, T t, Continuation<? super Unit> continuation) {
        Object objWriteScope = storageConnection.writeScope(new C00852(t, null), continuation);
