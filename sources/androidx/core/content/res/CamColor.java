...
public class CamColor {
    ...
    private static CamColor fromJchInFrame(float f, float f2, float f3, ViewingConditions viewingConditions) {
        ...
        return new CamColor(f3, f2, f, c, flRoot, fSqrt, f4, ((float) Math.cos(d2)) * fLog, fLog * ((float) Math.sin(d2)));
    }
    ...
    int viewed(ViewingConditions viewingConditions) {
        float fPow = (float) Math.pow(((double) ((((double) getChroma()) == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE || ((double) getJ()) == ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) ? 0.0f : getChroma() / ((float) Math.sqrt(((double) getJ()) / 100.0d)))) / Math.pow(1.64d - Math.pow(0.29d, viewingConditions.getN()), 0.73d), 1.1111111111111112d);
        ...
        float fSignum = Math.signum(f5) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((float) Math.max(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, (((double) Math.abs(f5)) * 27.13d) / (400.0d - ((double) Math.abs(f5)))), 2.380952380952381d));
        float fSignum2 = Math.signum(f6) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((float) Math.max(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, (((double) Math.abs(f6)) * 27.13d) / (400.0d - ((double) Math.abs(f6)))), 2.380952380952381d));
        float fSignum3 = Math.signum(f7) * (100.0f / viewingConditions.getFl()) * ((float) Math.pow((float) Math.max(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, (((double) Math.abs(f7)) * 27.13d) / (400.0d - ((double) Math.abs(f7)))), 2.380952380952381d));
    ...
    static int toColor(float f, float f2, float f3, ViewingConditions viewingConditions) {
        if (f2 < 1.0d || Math.round(f3) <= ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE || Math.round(f3) >= 100.0d) {
