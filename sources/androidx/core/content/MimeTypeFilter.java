...
public final class MimeTypeFilter {
    ...
    public static boolean matches(String str, String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(DomExceptionUtils.SEPARATOR), str2.split(DomExceptionUtils.SEPARATOR));
    }
    ...
    public static String matches(String str, String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(DomExceptionUtils.SEPARATOR))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] strArrSplit = str.split(DomExceptionUtils.SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(DomExceptionUtils.SEPARATOR), strArrSplit)) {
                return str2;
            }
        }
        return null;
