                    ...
                    try {
                        ...
                        if (cursorQuery != null && cursorQuery.getCount() > 0) {
                            ...
                            while (cursorQuery.moveToNext()) {
                                ...
                                arrayList2.add(new FontsContractCompat.FontInfo(uri, i3, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : 400, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, fontRequest.getVariationSettings(), i2));
