...
public final class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (z2 != (dAtan3 >= ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE)) {
                dAtan3 = dAtan3 > ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE ? dAtan3 - 6.283185307179586d : dAtan3 + 6.283185307179586d;
            }
            double d20 = d * d5;
            double d21 = d2 * d7;
