...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        /* JADX WARN: Code duplicated, block: B:48:0x0196  */
        /* JADX WARN: Code duplicated, block: B:49:0x01a9  */
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; i++) {
                ...
                remoteInputArr2[i] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, remoteInput.getExtras(), null);
            }
