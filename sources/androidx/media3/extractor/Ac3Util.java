...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384, Videoio.CAP_PROP_XI_WB_KR, 512, 576, Imgcodecs.IMWRITE_JPEGXL_QUALITY};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, Imgproc.COLOR_YUV2RGBA_YVYU, 139, 174, JfifUtil.MARKER_RST0, 243, Imgcodecs.IMWRITE_TIFF_ROWSPERSTRIP, 348, Videoio.CAP_PROP_XI_AE_MAX_LIMIT, Videoio.CAP_PROP_XI_CC_MATRIX_20, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            String str3 = bits7 == 3 ? null : MimeTypes.AUDIO_AC3;
