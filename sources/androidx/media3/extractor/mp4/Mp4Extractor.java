...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        long j = C.TIME_UNSET;
        int size = -1;
        for (List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C.TIME_UNSET, null, (this.flags & 1) != 0, z, new Function() { // from class: androidx.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return Mp4Extractor.lambda$processMoovAtom$2((Track) obj);
            }
        }); i4 < traks.size(); traks = traks) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                long j2 = j;
                long j3 = track.durationUs != C.TIME_UNSET ? track.durationUs : trackSampleTable.durationUs;
                int i6 = i3;
                ...
                MetadataUtil.setFormatMetadata(i8, mdtaFromMeta, builderBuildUpon, metadataArr);
        ...
        this.durationUs = j;
        Mp4Track[] mp4TrackArr = (Mp4Track[]) arrayList.toArray(new Mp4Track[i3]);
