    ...
    private CuesWithTiming parse(ParsableBitArray parsableBitArray) {
        ...
        while (i2 < sparseArray.size()) {
            ...
            while (i5 < sparseArray2.size()) {
                ...
                if (objectData != null) {
                    paintPixelDataSubBlocks(objectData, clutDefinition2, regionComposition.depth, regionObjectValueAt.horizontalPosition + i3, regionObjectValueAt.verticalPosition + i4, objectData.nonModifyingColorFlag ? null : this.defaultPaint, this.canvas);
                }
                i5++;
