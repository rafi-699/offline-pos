...
public final class DtsUtil {
    ...
    private static final int[] TWICE_BITRATE_KBPS_BY_RATE = {64, 112, 128, 192, 224, 256, 384, Videoio.CAP_PROP_XI_WB_KR, 512, Imgcodecs.IMWRITE_JPEGXL_QUALITY, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    public static DtsHeader parseDtsHdHeader(byte[] bArr) throws ParserException {
        ...
        return new DtsHeader(MimeTypes.AUDIO_DTS_EXPRESS, bits4, i8, bits3, jScaleLargeTimestamp, 0);
    }
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        return new DtsHeader(MimeTypes.AUDIO_DTS_X, 2, i4, unsignedVarInt + unsignedVarInt2 + (atomicInteger2.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0), j, 0);
    }
