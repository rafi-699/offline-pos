...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected static final class State {
        ...
        public int hashCode() {
            int iHashCode = (((((((((JfifUtil.MARKER_EOI + this.availableCommands.hashCode()) * 31) + (this.playWhenReady ? 1 : 0)) * 31) + this.playWhenReadyChangeReason) * 31) + this.playbackState) * 31) + this.playbackSuppressionReason) * 31;
    ...
    protected static final class MediaItemData {
        ...
        public int hashCode() {
            int iHashCode = (((((JfifUtil.MARKER_EOI + this.uid.hashCode()) * 31) + this.tracks.hashCode()) * 31) + this.mediaItem.hashCode()) * 31;
            MediaMetadata mediaMetadata = this.mediaMetadata;
    ...
    protected static final class PeriodData {
        ...
        public int hashCode() {
            int iHashCode = (JfifUtil.MARKER_EOI + this.uid.hashCode()) * 31;
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda38
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m177lambda$new$0$androidxmedia3commonSimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m177lambda$new$0$androidxmedia3commonSimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda28
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m180x396b5ff4(list, state, i, j);
                }
            });
        }
    }
    ...
    /* synthetic */ State m180x396b5ff4(List list, State state, int i, long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda34
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m175lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(state, list, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$addMediaItems$3$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m175lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(State state, List list, int i) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i < size) {
            ...
            if (i != iMin && iMin2 != i) {
                updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda48
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
                        return this.f$0.m176lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(state, i, iMin, iMin2);
                    }
                });
            }
        }
    ...
    /* synthetic */ State m176lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void seekTo(final int i, final long j, int i2, boolean z) {
        ...
        if (shouldHandleCommand(i2)) {
            final boolean z2 = i == -1 || isPlayingAd() || (!state.playlist.isEmpty() && i >= state.playlist.size());
            updateStateForPendingOperation(handleSeek(i, j, i2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda51
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return SimpleBasePlayer.lambda$seekTo$10(z2, state, i, j);
                }
            }, !z2, z);
        }
    }
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda30
            ...
            public final void run() {
                this.f$0.m181x9bf3217a(listenableFuture);
            }
    ...
    /* synthetic */ void m181x9bf3217a(ListenableFuture listenableFuture) {
    ...
    private static Player.PositionInfo getPositionInfo(State state, boolean z, Timeline.Window window, Timeline.Period period) {
        ...
        if (z) {
            ...
            contentPositionMsInternal = state.currentAdGroupIndex == i ? j : getContentPositionMsInternal(state);
        } else {
            long contentPositionMsInternal2 = getContentPositionMsInternal(state);
            contentPositionMsInternal = contentPositionMsInternal2;
            j = state.currentAdGroupIndex != i ? state.adPositionMsSupplier.get() : contentPositionMsInternal2;
        }
        return new Player.PositionInfo(obj2, currentMediaItemIndexInternal, mediaItem, obj, i2, j, contentPositionMsInternal, state.currentAdGroupIndex, state.currentAdIndexInAdGroup);
    }
