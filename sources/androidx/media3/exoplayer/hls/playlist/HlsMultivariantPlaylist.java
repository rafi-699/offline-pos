...
public final class HlsMultivariantPlaylist extends HlsPlaylist {
    ...
    public static final class Variant {
        ...
        public static Variant createMediaPlaylistVariantUrl(Uri uri) {
            return new Variant(uri, new Format.Builder().setId(AppEventsConstants.EVENT_PARAM_VALUE_NO).setContainerMimeType(MimeTypes.APPLICATION_M3U8).build(), null, null, null, null);
        }
