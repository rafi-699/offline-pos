...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    static String encodeStreamKeys(List<StreamKey> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            sb.append(streamKey.periodIndex).append(ClassUtils.PACKAGE_SEPARATOR_CHAR).append(streamKey.groupIndex).append(ClassUtils.PACKAGE_SEPARATOR_CHAR).append(streamKey.streamIndex).append(',');
        }
        if (sb.length() > 0) {
