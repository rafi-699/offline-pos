...
public final class DashMediaSource extends BaseMediaSource {
    ...
    private DashMediaSource(MediaItem mediaItem, DashManifest dashManifest, DataSource.Factory factory, ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, CmcdConfiguration cmcdConfiguration, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j, long j2) {
        ...
        this.simulateManifestRefreshRunnable = new Runnable() { // from class: androidx.media3.exoplayer.dash.DashMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m223lambda$new$0$androidxmedia3exoplayerdashDashMediaSource();
            }
        };
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-media3-exoplayer-dash-DashMediaSource, reason: not valid java name */
    /* synthetic */ void m223lambda$new$0$androidxmedia3exoplayerdashDashMediaSource() {
    ...
    private void updateLiveConfiguration(long j, long j2) {
        ...
        if (liveConfiguration.maxOffsetMs != C.TIME_UNSET) {
            ...
            if (this.manifest.serviceDescription == null || this.manifest.serviceDescription.maxOffsetMs == C.TIME_UNSET) {
                j3 = jUsToMs2;
            } else {
            ...
            if (jConstrainValue2 < j4) {
                jConstrainValue2 = j4;
            }
            if (jConstrainValue2 > j5) {
                jConstrainValue2 = Util.constrainValue(Util.usToMs(j - Math.min(this.minLiveStartPositionUs, j2 / 2)), j4, j5);
            }
            long j6 = j5;
            ...
            this.liveConfiguration = new MediaItem.LiveConfiguration.Builder().setTargetOffsetMs(jConstrainValue2).setMinOffsetMs(j4).setMaxOffsetMs(j6).setMinPlaybackSpeed(f).setMaxPlaybackSpeed(f2).build();
        }
        j3 = jMin;
        jUsToMs = Util.usToMs(j - j2);
        if (jUsToMs < 0) {
        ...
        this.liveConfiguration = new MediaItem.LiveConfiguration.Builder().setTargetOffsetMs(jConstrainValue2).setMinOffsetMs(j4).setMaxOffsetMs(j7).setMinPlaybackSpeed(f).setMaxPlaybackSpeed(f2).build();
    }
