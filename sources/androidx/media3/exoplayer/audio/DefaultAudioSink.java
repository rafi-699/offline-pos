    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            try {
                ...
                int i7 = audioFormatConfigure.encoding;
                ...
                int pcmFrameSize2 = Util.getPcmFrameSize(i7, audioFormatConfigure.channelCount);
                i3 = 0;
                iIntValue = i7;
        ...
        if (MimeTypes.AUDIO_DTS_EXPRESS.equals(format.sampleMimeType) && i8 == -1) {
            i8 = 768000;
        }
        int i9 = i8;
        if (i != 0) {
            ...
            i5 = i2;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i2, iIntValue2, iIntValue), iIntValue, i3, i4 != -1 ? i4 : 1, i5, i9, z2 ? 8.0d : 1.0d);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        boolean z3 = z;
        int i10 = i3;
        Configuration configuration = new Configuration(format, pcmFrameSize, i10, i4, i5, iIntValue2, iIntValue, bufferSizeInBytes, audioProcessingPipeline, z2, z3, this.tunneling);
