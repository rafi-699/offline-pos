...
class ConnectionState {
    ...
    public Bundle toBundleForRemoteProcess(int i) {
        ...
        if (!this.customLayout.isEmpty()) {
            bundle.putParcelableArrayList(FIELD_CUSTOM_LAYOUT, BundleCollectionUtil.toBundleArrayList(this.customLayout, new ConnectionState$$ExternalSyntheticLambda1()));
        }
    ...
    public static ConnectionState fromBundle(Bundle bundle) {
        ...
        return new ConnectionState(i, i2, iMediaSessionAsInterface, pendingIntent, immutableList, sessionCommands, commands2, commands, bundle9, bundle8, playerInfo);
    }
