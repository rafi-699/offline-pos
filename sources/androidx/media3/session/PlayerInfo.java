...
class PlayerInfo {
    ...
    public static PlayerInfo fromBundle(Bundle bundle, int i) {
        ...
        long j3 = bundle.getLong(FIELD_MAX_SEEK_TO_PREVIOUS_POSITION_MS, i >= 4 ? C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS : 0L);
        ...
        return new PlayerInfo(playbackExceptionFromBundle, i2, sessionPositionInfo, positionInfo, positionInfo2, i3, playbackParameters, i4, z, videoSizeFromBundle, timelineFromBundle, i5, mediaMetadata, f, audioAttributes, cueGroupFromBundle, deviceInfoFromBundle, i6, z2, z3, i7, i8, i9, z4, z5, mediaMetadata2, j, j2, j3, tracksFromBundle, trackSelectionParametersFromBundle);
    }
