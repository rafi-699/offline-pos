...
public class MediaSession {
    ...
    public static final class ControllerInfo {
        ...
        @Deprecated
        public static ControllerInfo createTestOnlyControllerInfo(androidx.media.MediaSessionManager.RemoteUserInfo remoteUserInfo, int i, int i2, boolean z, Bundle bundle) {
    ...
    MediaSession(Context context, String str, Player player, PendingIntent pendingIntent, ImmutableList<CommandButton> immutableList, Callback callback, Bundle bundle, Bundle bundle2, androidx.media3.common.util.BitmapLoader bitmapLoader, boolean z, boolean z2, int i) {
    ...
    MediaSessionImpl createImpl(Context context, String str, Player player, PendingIntent pendingIntent, ImmutableList<CommandButton> immutableList, Callback callback, Bundle bundle, Bundle bundle2, androidx.media3.common.util.BitmapLoader bitmapLoader, boolean z, boolean z2, int i) {
    ...
    public final android.support.v4.media.session.MediaSessionCompat.Token getSessionCompatToken() {
        return (android.support.v4.media.session.MediaSessionCompat.Token) LegacyParcelableUtil.convert(this.impl.getSessionCompat().getSessionToken(), android.support.v4.media.session.MediaSessionCompat.Token.CREATOR);
    }
    ...
    public static final class ConnectionResult {
        ...
        private ConnectionResult(boolean z, SessionCommands sessionCommands, Player.Commands commands, ImmutableList<CommandButton> immutableList, Bundle bundle, PendingIntent pendingIntent) {
            this.isAccepted = z;
            this.availableSessionCommands = sessionCommands;
