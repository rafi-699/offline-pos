...
final class SessionPositionInfo {
    ...
    public SessionPositionInfo filterByAvailableCommands(boolean z, boolean z2) {
        ...
        Player.PositionInfo positionInfoFilterByAvailableCommands = this.positionInfo.filterByAvailableCommands(z, z2);
        boolean z3 = z && this.isPlayingAd;
        long j4 = this.eventTimeMs;
        long j5 = z ? this.durationMs : C.TIME_UNSET;
        long j6 = z ? this.bufferedPositionMs : 0L;
        int i = z ? this.bufferedPercentage : 0;
        long j7 = z ? this.totalBufferedDurationMs : 0L;
        long j8 = z ? this.currentLiveOffsetMs : C.TIME_UNSET;
        long j9 = z ? this.contentDurationMs : C.TIME_UNSET;
        if (z) {
            j = j5;
            j3 = this.contentBufferedPositionMs;
            j2 = j9;
        } else {
            j = j5;
            j2 = j9;
        ...
        new SessionPositionInfo(positionInfoFilterByAvailableCommands, z3, j4, j, j6, i, j7, j8, j2, j3);
        return r3;
    }
