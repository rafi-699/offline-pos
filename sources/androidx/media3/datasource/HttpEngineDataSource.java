...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    private UrlRequest.Builder buildRequestBuilder(DataSpec dataSpec, UrlRequest.Callback callback) throws IOException {
        ...
        if (dataSpec.httpBody != null && !map.containsKey(HttpHeaders.CONTENT_TYPE)) {
        ...
        if (strBuildRangeRequestHeader != null) {
            directExecutorAllowed.addHeader(HttpHeaders.RANGE, strBuildRangeRequestHeader);
        }
    ...
    private static boolean isCompressed(UrlResponseInfo urlResponseInfo) {
        for (Map.Entry<String, String> entry : urlResponseInfo.getHeaders().getAsList()) {
        ...
        public synchronized void onRedirectReceived(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, String str) {
            ...
            if (dataSpec.httpMethod != 2 || (httpStatusCode != 307 && httpStatusCode != 308)) {
                ...
                if (z || HttpEngineDataSource.this.handleSetCookieRequests) {
                    String cookies = HttpEngineDataSource.parseCookies(urlResponseInfo.getHeaders().getAsMap().get(HttpHeaders.SET_COOKIE));
