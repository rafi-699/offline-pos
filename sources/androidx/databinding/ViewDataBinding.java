...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    protected static double getFromArray(double[] dArr, int i) {
        return (dArr == null || i < 0 || i >= dArr.length) ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : dArr[i];
    }
    ...
    protected static double safeUnbox(Double d) {
        return d == null ? ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE : d.doubleValue();
    }
    ...
    private static void mapBindings(DataBindingComponent dataBindingComponent, View view, Object[] objArr, IncludedLayouts includedLayouts, SparseIntArray sparseIntArray, boolean z) {
        ...
        if (!z2 && (id = view.getId()) > 0 && sparseIntArray2 != null && (i4 = sparseIntArray2.get(id, -1)) >= 0 && objArr[i4] == null) {
            objArr[i4] = view;
        }
        if (view instanceof ViewGroup) {
            ...
            while (i6 < childCount) {
                ...
                if (i < 0 || !(childAt.getTag() instanceof String)) {
                    ...
                    if (!str2.endsWith("_0") || !str2.startsWith(TtmlNode.TAG_LAYOUT) || str2.indexOf(47) <= 0 || (iFindIncludeIndex = findIncludeIndex(str2, i7, includedLayouts2, i)) < 0) {
                        z3 = z6;
                        i2 = i6;
                        i3 = i7;
                        z4 = false;
                        ...
                        int i9 = includedLayouts2.indexes[i][iFindIncludeIndex];
                        int i10 = includedLayouts2.layoutIds[i][iFindIncludeIndex];
                        ...
                        if (iFindLastMatching == i6) {
                            ...
                            while (i13 < i12) {
                                int i14 = i6;
                                viewArr[i13] = viewGroup.getChildAt(i14 + i13);
                                i13++;
                                i6 = i14;
                            }
