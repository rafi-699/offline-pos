...
public final class ArraySet<E> implements Collection<E>, Set<E>, KMutableCollection, KMutableSet {
    ...
    public final E removeAt(int i) {
        ...
        if (getHashes().length > 8 && get_size$collection() < getHashes().length / 3) {
            ...
            if (i2 < i4) {
                int i6 = i2 + 1;
                ArraysKt.copyInto(hashes, getHashes(), i2, i6, i3);
                ArraysKt.copyInto(objArr, getArray(), i2, i6, i3);
            }
        } else {
            if (i < i4) {
                int i7 = i + 1;
                ArraysKt.copyInto(getHashes(), getHashes(), i, i7, i3);
                ArraysKt.copyInto(getArray(), getArray(), i, i7, i3);
            }
            getArray()[i4] = null;
        }
