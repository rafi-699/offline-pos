    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        for (int i8 = 0; i8 < this.mWidgetsCount; i8++) {
            ...
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                ...
                if (i10 == 0 || i10 == 2) {
                    linearSystem.addLowerBarrier(constraintAnchor.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin - i9, z);
                } else {
                    linearSystem.addGreaterBarrier(constraintAnchor.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin + i9, z);
                }
