...
public class LinearSystem {
    ...
    void displaySystemInformations() {
        ...
        printStream.println(sbAppend.append(getDisplaySize(i3 * i3)).append(") -- row sizes: ").append(getDisplaySize(iSizeInBytes)).append(", actual size: ").append(getDisplaySize(iSizeInBytes2)).append(" rows: ").append(this.mNumRows).append(DomExceptionUtils.SEPARATOR).append(this.mMaxRows).append(" cols: ").append(this.mNumColumns).append(DomExceptionUtils.SEPARATOR).append(this.mMaxColumns).append(" 0 occupied cells, ").append(getDisplaySize(0)).toString());
    }
