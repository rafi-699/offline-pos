...
public abstract class KeyCycleOscillator {
    ...
    static class CycleOscillator {
        ...
        public void setup(float f) {
            ...
            if (this.mPosition[0] > ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE) {
                this.mOscillator.addPoint(ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE, this.mPeriod[0]);
            }
