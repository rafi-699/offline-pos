...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setupMotionViews() {
        ...
        if (staggered != 0.0f) {
            boolean z = ((double) staggered) < ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + StringUtils.SPACE + constraintWidget + StringUtils.SPACE + str4);
            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            String string = sbAppend.append(i == -1 ? AdError.UNDEFINED_DOMAIN : Debug.getState(this, i)).toString();
