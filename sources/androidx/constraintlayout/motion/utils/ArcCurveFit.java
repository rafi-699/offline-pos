...
class ArcCurveFit extends CurveFit {
    ...
    private static class Arc {
        ...
        private void buildTable(double d, double d2, double d3, double d4) {
            ...
            double d6 = d2 - d4;
            int i = 0;
            double dHypot = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
            double d7 = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
            double d8 = ReactExoplayerView.DEFAULT_MIN_BUFFER_MEMORY_RESERVE;
            while (true) {
            ...
            while (true) {
                ...
                if (iBinarySearch >= 0) {
                    ...
                    double d9 = dArr4[i6];
                    this.mLut[i4] = (((double) i6) + ((length - d9) / (dArr4[i5 - 1] - d9))) / ((double) (dArr4.length - 1));
                }
                i4++;
            }
        }
