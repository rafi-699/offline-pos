...
public final class FileSystem {
    ...
    static final class C02871 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C02871(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C02871> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02871 c02871 = new C02871(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c02871.L$0 = obj;
            return c02871;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C02871) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C02871(dir, fileSystem, z, null));
    }

    /* JADX WARN: Code duplicated, block: B:50:0x00fa A[Catch: all -> 0x0140, TRY_LEAVE, TryCatch #0 {all -> 0x0140, blocks: (B:48:0x00f4, B:50:0x00fa, B:47:0x00ec), top: B:73:0x00ec }] */
