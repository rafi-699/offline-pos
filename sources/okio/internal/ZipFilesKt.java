...
public final class ZipFilesKt {
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        Path path = Path.Companion.get$default(Path.INSTANCE, DomExceptionUtils.SEPARATOR, false, 1, (Object) null);
        Map<Path, ZipEntry> mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.to(path, new ZipEntry(path, true, null, 0L, 0L, 0L, 0, null, 0L, Videoio.CAP_PROP_XI_DEBOUNCE_T0, null)));
        for (ZipEntry zipEntry : CollectionsKt.sortedWith(list, new Comparator() { // from class: okio.internal.ZipFilesKt$buildIndex$$inlined$sortedBy$1
            ...
            if (mapMutableMapOf.put(zipEntry.getCanonicalPath(), zipEntry) == null) {
                while (true) {
                    ...
                    ZipEntry zipEntry3 = new ZipEntry(pathParent, true, null, 0L, 0L, 0L, 0, null, 0L, Videoio.CAP_PROP_XI_DEBOUNCE_T0, null);
    ...
    public static final ZipEntry readEntry(final BufferedSource bufferedSource) throws IOException {
        ...
        return new ZipEntry(Path.Companion.get$default(Path.INSTANCE, DomExceptionUtils.SEPARATOR, false, 1, (Object) null).resolve(utf8), StringsKt.endsWith$default(utf8, DomExceptionUtils.SEPARATOR, false, 2, (Object) null), bufferedSource.readUtf8(shortLe5), intLe2, longRef.element, longRef2.element, shortLe2, lDosDateTimeToEpochMillis, longRef3.element);
    }
